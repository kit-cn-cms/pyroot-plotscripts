...
plots=[
    ...
    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (packedPatJetsAK8PFCHSSoftDrop_Pt[0]>150 && packedPatJetsAK8PFCHSSoftDrop_Pt[1]>150)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ))" , ""),
    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " packedPatJetsAK8PFCHSSoftDrop_Pt[0]>150 && packedPatJetsAK8PFCHSSoftDrop_Pt[1]>150 " + " && " + "Triggered_HLT_PFHT800_vX==1", ""),

    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " packedPatJetsAK8PFCHSSoftDrop_Pt[0]>400 && packedPatJetsAK8PFCHSSoftDrop_Pt[1]>200 " + " && " + "(Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " packedPatJetsAK8PFCHSSoftDrop_Pt[0]>400 && packedPatJetsAK8PFCHSSoftDrop_Pt[1]>200 " + " && " + "Triggered_HLT_PFHT800_vX==1", ""),

    #Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Triggered_HLT_PFHT800_vX==1", ""),

    #Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "  Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + "(Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "  Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + "Triggered_HLT_PFHT800_vX==1", ""),
    
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + "(Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + "Triggered_HLT_PFHT800_vX==1", ""),
    
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + "(Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + "Triggered_HLT_PFHT800_vX==1", ""),  
   
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + " && " + "(Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 )" + " && " + "Triggered_HLT_PFHT800_vX==1", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + " && " + "Triggered_HLT_PFHT800_vX==1", ""),
    ...
    #Plot(ROOT.TH1F( ABCDversion + "_CatA_withtobbtag_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " Zprimes_ABCD"+radi+"_M>1000 " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + "Triggered_HLT_PFHT800_vX==1", ""),


    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (packedPatJetsAK8PF" + radi + "_Pt[0]>150 && packedPatJetsAK8PF" + radi + "_Pt[1]>150)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ))" , ""),
    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (packedPatJetsAK8PF" + radi + "_Pt[0]>150 && packedPatJetsAK8PF" + radi + "_Pt[1]>150)*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),

    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (packedPatJetsAK8PF" + radi + "_Pt[0]>400 && packedPatJetsAK8PF" + radi + "_Pt[1]>200)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ))", ""),
    #Plot(ROOT.TH1F( ABCDversion + "_2AK8_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (packedPatJetsAK8PF" + radi + "_Pt[0]>400 && packedPatJetsAK8PF" + radi + "_Pt[1]>200)*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),

    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),

    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),  
   
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),
  
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_EvtHT_withtobbtag_Triggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Evt_HT_Jets>(0.8*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<(1.2*Zprimes_ABCD" +  radi + "_M) " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_EvtHT_withtobbtag_Nontriggered" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(Evt_HT_Jets>(0.8*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<(1.2*Zprimes_ABCD" +  radi + "_M) " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*(Triggered_HLT_PFHT800_vX==1)*Prescale_HLT_PFHT800_vX", ""),
    
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),

    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),  
   
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
  
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_EvtHT_withtobbtag_Triggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Evt_HT_Jets>(0.75*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<(1.25*Zprimes_ABCD" +  radi + "_M) " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_EvtHT_withtobbtag_Nontriggered_2" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(Evt_HT_Jets>(0.75*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<(1.25*Zprimes_ABCD" +  radi + "_M) " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    
    
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX", ""),

    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*(Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX", ""),  
   
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_withtobbtag_Nontriggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*(Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX", ""),
  
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_EvtHT_withtobbtag_Triggered_3" ,"HT_{Evt} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Evt_HT_Jets>(0.8*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<(1.2*Zprimes_ABCD" +  radi + "_M) " + " && " + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100" + " && " + plotselection_topsubjetCSVv2 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_PFHT650_vX==1)*Prescale_HLT_PFHT650_vX*Prescale_HLT_PFHT900_vX", ""),
    ...
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", " (Evt_HT_Jets>1000)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", " (Evt_HT_Jets>1000)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),

    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Triggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", " (Evt_HT_Jets>1000)*( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", " (Evt_HT_Jets>1000)*( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Triggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", "(Evt_HT_Jets>1000)*(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", "(Evt_HT_Jets>1000)*(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Triggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", "(Evt_HT_Jets>1000)*(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered_2_mZp" ,"m(Z') in GeV" ,40,0,4000),"Zprimes_ABCD"+radi+"_M", "(Evt_HT_Jets>1000)*(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),  
