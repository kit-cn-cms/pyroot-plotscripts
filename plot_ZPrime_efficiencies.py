...
plots=[
    ...
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Triggered_2" ,"H_{T} in GeV" ,40,0,2000),"Evt_HT_Jets", " ((Triggered_HLT_PFHT900_vX==1 || Triggered_HLT_PFHT800_vX==1 || Triggered_HLT_PFJet450_vX==1 ) && Triggered_HLT_Mu50_vX==1)*Prescale_HLT_PFHT800_vX*Prescale_HLT_Mu50_vX", ""),
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_nopt_Nontriggered_2" ,"H_{T} in GeV" ,40,0,2000),"Evt_HT_Jets", " (Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    ...
    Plot(ROOT.TH1F( ABCDversion + "_tWbcandidates_Nontriggered_2" ,"H_{T} in GeV" ,40,0,2000),"Evt_HT_Jets", " ( Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    ...
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_nopt_Nontriggered_2" ,"H_{T} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + ")*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),
    ...
    Plot(ROOT.TH1F( ABCDversion + "_tWbtagged_Nontriggered_2" ,"H_{T} in GeV" ,40,0,2000),"Evt_HT_Jets", "(" + plotselection_W_MSD + " && " +plotselection_W_tau21 + " && " + plotselection_t_MSD + " && " + plotselection_tau32 + " && " + " Tops_ABCD"+radi+"_Pt>400" + " && " + " Ws_ABCD"+radi+"_Pt>200" + " && " + " Bottoms_ABCD"+radi+"_Pt>100)*(Triggered_HLT_Mu50_vX==1)*Triggered_HLT_Mu50_vX*Prescale_HLT_Mu50_vX", ""),  
