...
scats=["ljets_jge6_tge3","ljets_jge6_tge3","ljets_j4_tge3"]
...
systs=['CMS_ttHbb_PU','CMS_ttHbb_scaleMuF', 'CMS_ttHbb_scaleMuR']
asysts=['CMS_ttHbb_ttbar_FSR', 'CMS_ttHbb_ttbar_ISR', 'CMS_ttHbb_HDAMP', 'CMS_ttHbb_UE', 'CMS_ttHbb_PDF_ttbar', 'CMS_ttHbb_PDF', 'CMS_ttHbb_scaleMuF', 'CMS_ttHbb_scaleMuR', 'CMS_ttHbb_scaleMuF_ttbar', 'CMS_ttHbb_scaleMuR_ttbar', 'CMS_ttHbb_FSR', 'CMS_ttHbb_ISR', 'CMS_ttHbb_FSR_ttbar', 'CMS_ttHbb_ISR_ttbar', 'CMS_ttHbb_FSR_ttbarOther', 'CMS_ttHbb_FSR_ttbarPlusB', 'CMS_ttHbb_FSR_ttbarPlus2B', 'CMS_ttHbb_FSR_ttbarPlusBBbar', 'CMS_ttHbb_FSR_ttbarPlusCCbar', 'CMS_ttHbb_ISR_ttbarOther', 'CMS_ttHbb_ISR_ttbarPlusB', 'CMS_ttHbb_ISR_ttbarPlus2B', 'CMS_ttHbb_ISR_ttbarPlusBBbar', 'CMS_ttHbb_ISR_ttbarPlusCCbar', 'CMS_ttHbb_PDF_ttbarOther', 'CMS_ttHbb_PDF_ttbarPlusB', 'CMS_ttHbb_PDF_ttbarPlus2B', 'CMS_ttHbb_PDF_ttbarPlusBBbar', 'CMS_ttHbb_PDF_ttbarPlusCCbar', 'CMS_ttHbb_scaleMuF_ttbarOther', 'CMS_ttHbb_scaleMuF_ttbarPlusB', 'CMS_ttHbb_scaleMuF_ttbarPlus2B', 'CMS_ttHbb_scaleMuF_ttbarPlusBBbar', 'CMS_ttHbb_scaleMuF_ttbarPlusCCbar', 'CMS_ttHbb_scaleMuR_ttbarOther', 'CMS_ttHbb_scaleMuR_ttbarPlusB', 'CMS_ttHbb_scaleMuR_ttbarPlus2B', 'CMS_ttHbb_scaleMuR_ttbarPlusBBbar', 'CMS_ttHbb_scaleMuR_ttbarPlusCCbar']
# filter non existent systs
systs=[]
#for asyst in asysts:
    #if ("ISR" in asyst or "FSR" in asyst or "NNPDF" in asyst or "CMS_ttHbb_scale" in asyst):
      #continue
    #systs.append(asyst)  

for p in procs:
    for s in ["CMS_ttHbb_HDAMP","CMS_ttHbb_UE"]:
        systs.append(s+"_"+p)
