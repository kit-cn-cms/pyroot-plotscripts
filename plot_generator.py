...
plots=[
    Plot(ROOT.TH1F( "Gen_ZPrime_M" ,"m_{Z'} in GeV" ,300,0,3000),"Gen_ZPrime_M", "Gen_ZPrime_M>0", ""),
    Plot(ROOT.TH1F( "Gen_TPrimeandTPrimebar_M" ,"m_{T} in GeV" ,35,0,1400),"Gen_TPrimeandTPrimebar_M", "Gen_TPrimeandTPrimebar_M>0", ""),
    Plot(ROOT.TH1F( "Gen_TPrimeandTPrimebar_Pt" ,"p_{T}(T) in GeV" ,35,0,1400),"Gen_TPrimeandTPrimebar_Pt", "Gen_TPrimeandTPrimebar_Pt>0", ""),
    Plot(ROOT.TH1F( "Gen_TopandTopbar_Pt" ,"p_{T}(t from Z') in GeV" ,35,0,1400),"Gen_TopandTopbar_Pt", "Gen_TopandTopbar_Pt>0", ""),
    ...
    Plot(ROOT.TH1F( "Gen_Top_TPrime_DeltaR" ,"#Delta R(t from Z',T)" ,35,0,7),"Gen_Top_TPrime_DeltaR", "Gen_Top_TPrime_DeltaR>0", ""),
    Plot(ROOT.TH1F( "Gen_Top_WfromTPrime_DeltaR" ,"#Delta R(t from Z',W from T)" ,35,0,7),"Gen_Top_WfromTPrime_DeltaR", "Gen_Top_WfromTPrime_DeltaR>0", ""),
    Plot(ROOT.TH1F( "Gen_Top_BottomfromTPrime_DeltaR" ,"#Delta R(t from Z',b from T)" ,35,0,7),"Gen_Top_BottomfromTPrime_DeltaR", "Gen_Top_BottomfromTPrime_DeltaR>0", ""),
    Plot(ROOT.TH1F( "Gen_WfromTPrime_BottomfromTPrime_DeltaR" ,"#Delta R(W from T,b from T)" ,35,0,7),"Gen_WfromTPrime_BottomfromTPrime_DeltaR", "Gen_WfromTPrime_BottomfromTPrime_DeltaR>0", ""),
]
...
#writeListOfHistoLists(SignalLOL,SignalSamples, "",name,True,False,False,'histo',False, False,False,False,False)
writeListOfHistoLists(SignalLOL,SignalSamples, "",name,True,False,False,'histo',False, False,False,False,True)
