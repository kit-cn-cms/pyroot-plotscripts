...
weigthsystnamesMCSFs=[
                    ...
                    "_" + ABCDversion + "_MCSF_Wtag_tag_t21Up",
                    "_" + ABCDversion + "_MCSF_Wtag_tag_t21Down",
...
systweightnamesMCSFs=[
                    ...
                    "" + ABCDversion + "_MCSF_Wtag_tag_t21_Up:=(MCSF_Weight_" + ABCDversion + "/" + ABCDversion + "_Wtag_tag_t21_weightnominal*" + ABCDversion + "_Wtag_tag_t21_weightUp)*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_Wtag_tag_t21_Down:=(MCSF_Weight_" + ABCDversion + "/" + ABCDversion + "_Wtag_tag_t21_weightnominal*" + ABCDversion + "_Wtag_tag_t21_weightDown)*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",     
