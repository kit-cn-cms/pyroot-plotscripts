...
#########medium working points                    
                    ...
                    #"ABCD_inclusive_ZprimeM_systup:= pow(1+0.02,1.0/3.0)",
                    #"ABCD_inclusive_ZprimeM_systdown:= pow(1-0.02,1.0/3.0)",
                    #"ABCD_notopbtag_ZprimeM_systup:= pow(1+0.02,1.0/3.0)",
                    #"ABCD_notopbtag_ZprimeM_systdown:= pow(1-0.02,1.0/3.0)",
                    #"ABCD_withtopbtag_ZprimeM_systup:= pow(1+0.10,1.0/3.0)",
                    #"ABCD_withtopbtag_ZprimeM_systdown:= pow(1-0.10,1.0/3.0)",
                    #"ABCD_inclusive_TprimeM_systup:= pow(1+0.02,1.0/3.0)",
                    #"ABCD_inclusive_TprimeM_systdown:= pow(1-0.02,1.0/3.0)",
                    #"ABCD_notopbtag_TprimeM_systup:= pow(1+0.02,1.0/3.0)",
                    #"ABCD_notopbtag_TprimeM_systdown:= pow(1-0.02,1.0/3.0)",
                    #"ABCD_withtopbtag_TprimeM_systup:= pow(1+0.4,1.0/3.0)",
                    #"ABCD_withtopbtag_TprimeM_systdown:= pow(1-0.4,1.0/3.0)",

                    #"ABCDcorrE_inclusive_ZprimeM_systup:= pow(1+0.015,1.0/7.0)",
                    #"ABCDcorrE_inclusive_ZprimeM_systdown:= pow(1-0.015,1.0/7.0)",
                    #"ABCDcorrE_notopbtag_ZprimeM_systup:= pow(1+0.02,1.0/7.0)",
                    #"ABCDcorrE_notopbtag_ZprimeM_systdown:= pow(1-0.02,1.0/7.0)",
                    #"ABCDcorrE_withtopbtag_ZprimeM_systup:= pow(1+0.3,1.0/7.0)",
                    #"ABCDcorrE_withtopbtag_ZprimeM_systdown:= pow(1-0.3,1.0/7.0)",
                    ...
                    #"ABCDcorrE_withtopbtag_TprimeM_systup:= pow(1+0.6,1.0/7.0)",
                    #"ABCDcorrE_withtopbtag_TprimeM_systdown:= pow(1-0.6,1.0/7.0)",
                    ...
                    #"ABCD2corrE_inclusive_ZprimeM_systup:= pow(1+0.015,1.0/7.0)",
                    #"ABCD2corrE_inclusive_ZprimeM_systdown:= pow(1-0.015,1.0/7.0)",
                    #"ABCD2corrE_notopbtag_ZprimeM_systup:= pow(1+0.025,1.0/7.0)",
                    #"ABCD2corrE_notopbtag_ZprimeM_systdown:= pow(1-0.025,1.0/7.0)",
                    #"ABCD2corrE_withtopbtag_ZprimeM_systup:= pow(1+0.02,1.0/7.0)",
                    #"ABCD2corrE_withtopbtag_ZprimeM_systdown:= pow(1-0.02,1.0/7.0)",
                    #"ABCD2corrE_inclusive_TprimeM_systup:= pow(1+0.01,1.0/7.0)",
                    #"ABCD2corrE_inclusive_TprimeM_systdown:= pow(1-0.01,1.0/7.0)",
                    #"ABCD2corrE_notopbtag_TprimeM_systup:= pow(1+0.025,1.0/7.0)",
                    #"ABCD2corrE_notopbtag_TprimeM_systdown:= pow(1-0.025,1.0/7.0)",
                    #"ABCD2corrE_withtopbtag_TprimeM_systup:= pow(1+0.005,1.0/7.0)",
                    #"ABCD2corrE_withtopbtag_TprimeM_systdown:= pow(1-0.005,1.0/7.0)",      

###########loose working points
                    "ABCD_inclusive_ZprimeM_systup:= pow(1+0.025,1.0/1.0)",
                    "ABCD_inclusive_ZprimeM_systdown:= pow(1-0.025,1.0/1.0)",
                    "ABCD_notopbtag_ZprimeM_systup:= pow(1+0.02,1.0/1.0)",
                    "ABCD_notopbtag_ZprimeM_systdown:= pow(1-0.02,1.0/1.0)",
                    "ABCD_withtopbtag_ZprimeM_systup:= pow(1+0.15,1.0/1.0)",
                    "ABCD_withtopbtag_ZprimeM_systdown:= pow(1-0.15,1.0/1.0)",
                    "ABCD_inclusive_TprimeM_systup:= pow(1+0.02,1.0/1.0)",
                    "ABCD_inclusive_TprimeM_systdown:= pow(1-0.02,1.0/1.0)",
                    "ABCD_notopbtag_TprimeM_systup:= pow(1+0.02,1.0/1.0)",
                    "ABCD_notopbtag_TprimeM_systdown:= pow(1-0.02,1.0/1.0)",
                    "ABCD_withtopbtag_TprimeM_systup:= pow(1+0.4,1.0/1.0)",
                    "ABCD_withtopbtag_TprimeM_systdown:= pow(1-0.4,1.0/1.0)",
                    ...
                    "ABCD2_inclusive_ZprimeM_systup:= pow(1+0.02,1.0/1.0)",
                    "ABCD2_inclusive_ZprimeM_systdown:= pow(1-0.02,1.0/1.0)",
                    "ABCD2_notopbtag_ZprimeM_systup:= pow(1+0.011,1.0/1.0)",
                    "ABCD2_notopbtag_ZprimeM_systdown:= pow(1-0.011,1.0/1.0)",
                    "ABCD2_withtopbtag_ZprimeM_systup:= pow(1+0.07,1.0/1.0)",
                    "ABCD2_withtopbtag_ZprimeM_systdown:= pow(1-0.07,1.0/1.0)",
                    "ABCD2_inclusive_TprimeM_systup:= pow(1+0.06,1.0/1.0)",
                    "ABCD2_inclusive_TprimeM_systdown:= pow(1-0.06,1.0/1.0)",
                    "ABCD2_notopbtag_TprimeM_systup:= pow(1+0.12,1.0/1.0)",
                    "ABCD2_notopbtag_TprimeM_systdown:= pow(1-0.12,1.0/1.0)",
                    "ABCD2_withtopbtag_TprimeM_systup:= pow(1+0.01,1.0/1.0)",
                    "ABCD2_withtopbtag_TprimeM_systdown:= pow(1-0.01,1.0/1.0)",
