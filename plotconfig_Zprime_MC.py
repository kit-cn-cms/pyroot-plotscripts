...
weigthsystnamesMCSFs=[
                    ...
                    "_" + ABCDversion + "_MCSF_Wtag_tagUp",
                    "_" + ABCDversion + "_MCSF_Wtag_tagDown",
...
systweightnamesMCSFs=[
                    ...
                    "" + ABCDversion + "_MCSF_Wtag_tag:=(MCSF_Weight_" + ABCDversion + "/" + ABCDversion + "_Wtag_tag_weightnominal*" + ABCDversion + "_Wtag_tag_weightUp)*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_Wtag_tag:=(MCSF_Weight_" + ABCDversion + "/" + ABCDversion + "_Wtag_tag_weightnominal*" + ABCDversion + "_Wtag_tag_weightDown)*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",     
