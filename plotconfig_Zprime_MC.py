...
samples=[ 
                    ...
                    Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_200_300*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_300_500*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_500_700*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_700_1000*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_1000_1500*nominal*.root',mcweight,'QCD',) ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_1500_2000*nominal*.root',mcweight,'QCD') ,     
                    #Sample('QCD',ROOT.kYellow,path_80x+'QCD/MC_QCD_2000_Inf*nominal*.root',mcweight,'QCD') ,     
