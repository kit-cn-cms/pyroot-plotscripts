...
bins=     [s4j3t,s5j3t,s6j2t,s6j3t]
# corresponding labels
binlabels=["j4_t3","j5_t3","jge6_t2","jge6_t3"]
# number of bins in each category
nhistobins=    [1000,1000,1000,1000]
...
#minxvals= [-1,-1,-1,-1]
#maxxvals= [1,1,1,1]
minxvals= [-0.88,-0.94,-0.84,-0.87]
maxxvals= [0.89,0.9,0.87,0.86]
