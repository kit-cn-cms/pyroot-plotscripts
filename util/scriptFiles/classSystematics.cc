...
class Systematics {
   public:
    ...
    // https://cmssdt.cern.ch/SDT/doxygen/CMSSW_8_0_23/doc/html/dc/d33/classJetCorrectorParametersCollection.html#afb3d4c6fd711ca23d89e0625a22dc483 for a list
    // of in principle valid labels. Whether the uncertainty
...
bool Systematics::isInit() { return typeStringMap_.size() > 1; }
...
bool Systematics::isJECUncertainty(const Type type) { return isJECUncertaintyUp(type) || isJECUncertaintyDown(type); }
