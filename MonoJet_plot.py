...
THEoutputpath=plotParallel(jobname,5000000,plots,samples_background+samples_signal+samples_data+systsamples,[''],['1.'],weightSystNames+BosonSystNames+ZvvBosonSystNames+ZllBosonSystNames+WBosonSystNames+PowhegSystNames+MadGraphSystNames+SignalSystNames,systWeights+BosonWeights+ZvvBosonWeights+ZllBosonWeights+WBosonWeights+PowhegSystWeights+MadGraphSystWeights+SignalSystWeights,additionalvariables,[],"/nfs/dust/cms/user/kelmorab/treeJsons/treejson_Spring17_FAST.json",otherSystNames,addCodeInterfacePaths=[],cirun=False,StopAfterCompileStep=False,haddParallel=True)
print "---------------------------------------------"
