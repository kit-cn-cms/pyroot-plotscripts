...
from plotconfig_v35_noPS_2Dtest_philip_all_syst import *


def main(argv):

    #Create analysis object with output name
    name='limits_v35_2Dtest_philip_all_syst'
    analysis=Analysis(name,argv,'/nfs/dust/cms/user/pkeicher/ttH_2018/pyroot-plotscripts/workdir/limits_v35_2Dtest_philip_all_syst/output_limitInput.root ', signalProcess='ttH')
