...
def main(argv):
    ...
    name='limits_v39_top_DNN_inputs'
    ...
    Plot(ROOT.TH1D(plotprefix+"N_BTagsT","N_BTagsT",30,3,9),"Evt_CSV_Min_Tagged",plotselection,plotlabel),
