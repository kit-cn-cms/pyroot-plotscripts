...
categories_=[
              ...
              ("(N_Jets==4&&N_BTagsM==2)","ljets_j4_t2_count",""),
              ("(N_Jets==5&&N_BTagsM==2)","ljets_j5_t2_count",""),
              ("(N_Jets==4&&N_BTagsM==3)","ljets_j4_t3_count",""),
              ("(N_Jets==4&&N_BTagsM>=4)","ljets_j4_t4_count",""),
              ("(N_Jets==5&&N_BTagsM==3)","ljets_j5_t3_count",""),
              ("(N_Jets==5&&N_BTagsM>=4)","ljets_j5_tge4_count",""),             
              ("(N_Jets>=6&&N_BTagsM==2)","ljets_jge6_t2_count",""),
              ("(N_Jets>=6&&N_BTagsM==3)","ljets_jge6_t3_count",""),
              ("(N_Jets>=6&&N_BTagsM>=4)","ljets_jge6_tge4_count",""),
]
...
bdtset="Spring17v1"
additionalvariables=[   'FirstJetPt:=Jet_Pt[0]',
