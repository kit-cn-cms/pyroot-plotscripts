...
BosonSystNames=[
       ...
       "_Weight_amc_scale_variation_muRUp","_Weight_amc_scale_variation_muRDown","_Weight_amc_scale_variation_muFUp","_Weight_amc_scale_variation_muFDown",
       "_Weight_PDFUp","_Weight_PDFDown"
...
BosonWeights=[
       ...
       "dummyWeight_amc_scale_variation_muRup:="+common_weight+"*internalBosonWeight_muRUp/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_2p0_muF_1p0)*(DoWeights==1)+(DoWeights==0)*1.0",
       "dummyWeight_amc_scale_variation_muRdown:="+common_weight+"*internalBosonWeight_muRDown/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_0p5_muF_1p0)*(DoWeights==1)+(DoWeights==0)*1.0",
       "dummyWeight_amc_scale_variation_muFup:="+common_weight+"*internalBosonWeight_muFUp/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_1p0_muF_2p0)*(DoWeights==1)+(DoWeights==0)*1.0",
       "dummyWeight_amc_scale_variation_muFdown:="+common_weight+"*internalBosonWeight_muFDown/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_1p0_muF_0p5)*(DoWeights==1)+(DoWeights==0)*1.0",
...
PowhegSystNames=[
    ...
    "_Weight_powheg_scale_variation_muRUp","_Weight_powheg_scale_variation_muRDown","_Weight_powheg_scale_variation_muFUp","_Weight_powheg_scale_variation_muFDown"
...
MadGraphSystNames=[
    ...
    "_Weight_madgraph_scale_variation_muRUp","_Weight_madgraph_scale_variation_muRDown","_Weight_madgraph_scale_variation_muFUp","_Weight_madgraph_scale_variation_muFDown"
...
SignalSystNames=[
    ...
    "_Weight_signal_scale_variation_muRUp","_Weight_signal_scale_variation_muRDown","_Weight_signal_scale_variation_muFUp","_Weight_signal_scale_variation_muFDown"
    
    ]

SignalSystWeights=[
    
    "dummyWeight_signal_scale_variation_muRup:="+common_weight+"*internalBosonWeight_muRUp/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_2p0_muF_1p0)*(DoWeights==1)+(DoWeights==0)*1.0",
    "dummyWeight_signal_scale_variation_muRdown:="+common_weight+"*internalBosonWeight_muRDown/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_0p5_muF_1p0)*(DoWeights==1)+(DoWeights==0)*1.0",
    "dummyWeight_signal_scale_variation_muFup:="+common_weight+"*internalBosonWeight_muFUp/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_1p0_muF_2p0)*(DoWeights==1)+(DoWeights==0)*1.0",
    "dummyWeight_signal_scale_variation_muFdown:="+common_weight+"*internalBosonWeight_muFDown/internalBosonWeight_nominal*fabs(Weight_scale_variation_muR_1p0_muF_0p5)*(DoWeights==1)+(DoWeights==0)*1.0"
...
sel_MET="*(((Triggered_HLT_PFMET170_X==1)||(Triggered_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_X==1))&&((N_LooseMuons==0)&&(N_LooseElectrons==0)&&(N_LooseTaus==0))&&(CaloMET_PFMET_ratio<0.5)&&(DeltaPhi_Jet_MET[0]>1.)&&(((N_Jets>1)&&(DeltaPhi_Jet_MET[1]>0.5))||(N_Jets<2))&&(((N_Jets>2)&&(DeltaPhi_Jet_MET[2]>0.5))||(N_Jets<3))&&(((N_Jets>3)&&(DeltaPhi_Jet_MET[3]>0.5))||(N_Jets<4)))"
...
samples_background = [
                        ...
                        Sample('Diboson',ROOT.kOrange,path_ntuples+'/??_TuneCUETP8M1_13TeV-pythia8/*nominal*.root',"1."+"*"+MCWeight+sel_MET,'diboson',weightSystNames+otherSystNames,samDict=sampleDict),
