...
plotselection_ABCD_general_beta_alt =  plotselection2 + "&& Zprimes_ABCD_M>0   &&    70 < Ws_ABCD_MSD  &&   Ws_ABCD_MSD < 100     &&    100 < Tops_ABCD_MSD     &&    Tops_ABCD_MSD  < 210   "
...
plots=[
    ...
    # with topsubbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag") ,



    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtagalt_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,25,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD_CatA_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_CatB_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatC_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatD_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_CatE_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatF_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatG_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatH_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag") ,


    #only first element
    #W_msd as third variable

    Plot(ROOT.TH1F("ABCD_CatA_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_CatB_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatC_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  + "&&" +plotselection_sideband,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatD_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_CatE_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatF_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatG_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_CatH_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),


    #doing only first element
    #beta (tau21)

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first_nobottom" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag") ,


    #only first element
    #W_msd as third variable

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  + "&&" +plotselection_sideband,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +plotselection_sideband ,"1 btag"),


    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_first_nobottom" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + "&&" + "N_AK4_bottom_tag_candidates < 1" + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +plotselection_sideband ,"1 btag"),




#MSD manual sepaTest
    Plot(ROOT.TH1F("Notopbtag_Top_MSD" ,"m_{SD}(t-notoptag) in GeV" ,60,0,300),"Tops_ABCD_MSD",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("Withtopbtag_Top_MSD" ,"m_{SD}(t-withtoptag) in GeV",60,0,300),"Tops_ABCD_MSD",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("Notopbtag_W_MSD" ,"m_{SD}(W-notoptag) in GeV" ,60,0,300),"Ws_ABCD_MSD",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("Withtopbtag_W_MSD" ,"m_{SD}(W-withtoptag) in GeV" ,60,0,300),"Ws_ABCD_MSD",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
...
OnlyFirstList[plotnames.index("ABCD_CatA_Zprime_M_beta_first"):plotnames.index('Withtopbtag_W_MSD') +1 ] = len(OnlyFirstList[plotnames.index("ABCD_CatA_Zprime_M_beta_first"):plotnames.index('Withtopbtag_W_MSD') + 1 ] ) * [True]
...
outputpath=plotParallel(name,3000000,plots,SignalSamples+BackgroundSamples, [''], ['1'] , [''], ['1'], [],  OnlyFirstList)
...
writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('Notopbtag_Top_MSD'):plotnames.index('Withtopbtag_W_MSD')+1],BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], 'label','MSDs_QCD')
#writeListOfHistoLists([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_CatA_Zprime_M_beta_first')]],BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], 'label','MSDs_QCD ')
...
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatA_Zprime_M_beta_first"), plotnames.index("ABCD_CatB_Zprime_M_beta_first"), normalizefirst=False,rebin=1,option='')
...
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first"), plotnames.index("ABCD_withtopbtagalt_CatB_Zprime_M_beta_first"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtagalt_CatC_Zprime_M_beta_first"), plotnames.index("ABCD_withtopbtagalt_CatD_Zprime_M_beta_first"), normalizefirst=False,rebin=1,option='')
...
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtagalt_CatE_Zprime_M_beta_first"), plotnames.index("ABCD_withtopbtagalt_CatF_Zprime_M_beta_first"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtagalt_CatG_Zprime_M_beta_first"), plotnames.index("ABCD_withtopbtagalt_CatH_Zprime_M_beta_first"), normalizefirst=False,rebin=1,option='')
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtagalt_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtagalt_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
...
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatA_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatB_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatC_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatD_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatA_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatC_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')

divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatE_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatF_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatG_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatH_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_CatE_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_CatG_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')


GetIntegralLOL( transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index("ABCD_CatA_Zprime_M_beta_first_nobottom"):plotnames.index("ABCD_CatH_Zprime_M_beta_first_nobottom")+1]) 
#GetIntegralLOL( listOfHistoListsABCD )


#print listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')], '   integral ', listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')].Integral()
#writeListOfHistoLists([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]],BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], 'label','fuck',normalize=False,stack=False,logscale=False,options='histo',statTest=False, sepaTest=False,ratio=False,DoProfile=False)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_CatA_Zprime_M_beta_first_nobottom')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_nobottom_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_CatE_Zprime_M_beta_first_nobottom')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_nobottom_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtagalt_shaperatioAB_over_shaperatioCD", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforEFGH_shaperatioEG_over_shaperatioFH", rebin=1, fitoption='pol1', labels=None, autoXrange=True)



divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatA_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatB_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatC_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatD_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatA_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatC_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')

divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatE_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatF_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatG_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatH_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')
divideHistos(transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1]), plotnames.index("ABCD_withtopbtag_CatE_Zprime_M_beta_first_nobottom"), plotnames.index("ABCD_withtopbtag_CatG_Zprime_M_beta_first_nobottom"), normalizefirst=False,rebin=1,option='')


GetIntegralLOL( transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index("ABCD_withtopbtag_CatA_Zprime_M_beta_first_nobottom"):plotnames.index("ABCD_withtopbtag_CatH_Zprime_M_beta_first_nobottom")+1]) 
#GetIntegralLOL( listOfHistoListsABCD )


#print listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')], '   integral ', listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')].Integral()
#writeListOfHistoLists([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]],BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], 'label','fuck',normalize=False,stack=False,logscale=False,options='histo',statTest=False, sepaTest=False,ratio=False,DoProfile=False)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first_nobottom')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtag_nobottom_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatE_Zprime_M_beta_first_nobottom')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtag_nobottom_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_withtopbtagalt_shaperatioAB_over_shaperatioCD", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforEFGH_shaperatioEG_over_shaperatioFH", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
