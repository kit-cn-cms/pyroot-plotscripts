...
plots=[
    ...
    #beta (tau21)
    # no topsubbtag
    Plot(ROOT.TH1F("ABCD_notopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M", plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    ...
    Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatE_notopbtag" + " && " +    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatF_notopbtag" + " && " +    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatG_notopbtag" + " && " +    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatH_notopbtag" + " && " +    plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag") ,
    
    # with topsubbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M", plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD_CatID==ABCD_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    
    #inclusive
    Plot(ROOT.TH1F("ABCD_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatB_withtopbtag) || ABCD_CatID==ABCD_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatC_withtopbtag) || ABCD_CatID==ABCD_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatD_withtopbtag) || ABCD_CatID==ABCD_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatE_withtopbtag) || ABCD_CatID==ABCD_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatF_withtopbtag) || ABCD_CatID==ABCD_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatG_withtopbtag) || ABCD_CatID==ABCD_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD_CatID==ABCD_CatH_withtopbtag) || ABCD_CatID==ABCD_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
    ...
    #ABCD2
    #no topbtag
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag2_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag") ,

    # withtopsubbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD2_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatB_withtopbtag) || ABCD2_CatID==ABCD2_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatC_withtopbtag) || ABCD2_CatID==ABCD2_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatD_withtopbtag) || ABCD2_CatID==ABCD2_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatE_withtopbtag) || ABCD2_CatID==ABCD2_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatF_withtopbtag) || ABCD2_CatID==ABCD2_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatG_withtopbtag) || ABCD2_CatID==ABCD2_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatH_withtopbtag) || ABCD2_CatID==ABCD2_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
...
#Tprime
    ...
    Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag") ,
    
    # with topsubbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Tprime_M_beta_first" ,"m(Z') in GeV, CatA " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD_CatID==ABCD_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD_inclusive_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatB_withtopbtag) || ABCD_CatID==ABCD_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatC_withtopbtag) || ABCD_CatID==ABCD_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatD_withtopbtag) || ABCD_CatID==ABCD_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_inclusive_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatE_withtopbtag) || ABCD_CatID==ABCD_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatF_withtopbtag) || ABCD_CatID==ABCD_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatG_withtopbtag) || ABCD_CatID==ABCD_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_inclusive_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD_CatID==ABCD_CatH_withtopbtag) || ABCD_CatID==ABCD_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
...
#ABCD2
    ...
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag2_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag") ,

    #no topbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatA_Tprime_M_beta_first" ,"m(Z') in GeV, CatA " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD2_CatID==ABCD2_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatB_withtopbtag) || ABCD2_CatID==ABCD2_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatC_withtopbtag) || ABCD2_CatID==ABCD2_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatD_withtopbtag) || ABCD2_CatID==ABCD2_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatE_withtopbtag) || ABCD2_CatID==ABCD2_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatF_withtopbtag) || ABCD2_CatID==ABCD2_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatG_withtopbtag) || ABCD2_CatID==ABCD2_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD2_CatID==ABCD2_CatH_withtopbtag) || ABCD2_CatID==ABCD2_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_first_bottomcontribdown" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    ...
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first_bottomcontribdown" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportiondown*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first_bottomcontribnorm" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionnorm*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first_bottomcontribup" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionup*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2_anti+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" +")", "1 btag") ,
    ...
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),


    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag"),
    #Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first_bottomcontribno" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",    "bportionno*("+ plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2+ " && "  + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" +")", "1 btag") ,
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_inclusive_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_inclusive_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_notopbtag2_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag2_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag2_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD2_inclusive_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD2_"+WPs+"WP_inclusive_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_bottomcontribno_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatE_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_bottomcontribno_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
##writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtagalt_shaperatioAB_over_shaperatioCD", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
...
##writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag_CatA_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_bottomcontribno_ratioABoverCD_pol0_Ecorr", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
...
##print listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')], '   integral ', listOfHistoListsABCD[plotnames.index("ABCD_withtopbtagalt_CatA_Zprime_M_beta_first")][BackgroundSampleNames.index('QCD_HT')].Integral()
##writeListOfHistoLists([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]],BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], 'label','fuck',normalize=False,stack=False,logscale=False,options='histo',statTest=False, sepaTest=False,ratio=False,DoProfile=False)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_bottomcontribno_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
#writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatE_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_bottomcontribno_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
##writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtagalt_shaperatioAB_over_shaperatioCD", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
##writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtagalt_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforEFGH_shaperatioEG_over_shaperatioFH", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
...
##writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag_CatA_Zprime_M_beta_first_bottomcontribno')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+WPs+"WP_withtopbtag_bottomcontribno_ratioEFoverGH_pol0_Ecorr", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
