...
'DNN_Out_6j3t_ttbarlf',
    ...
    #for discr,b,bl,nb,minx,maxx in zip(discrs,plotPreselections,binlabels,nhistobins,minxvals,maxxvals):
        #DNNplots.append(Plot(ROOT.TH1F(discrname+"_"+bl,"final discriminator ("+bl+")",nb,minx,maxx),discr,b,bl))
    auxplots.append(Plot(ROOT.TH1F(discrname+"_"+"N_Jets","N_Jets",11,3.5,14.5),"N_Jets","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    auxplots.append(Plot(ROOT.TH1F(discrname+"_"+"N_BTagsM","N_BTagsM",4,1.5,5.5),"N_BTagsM","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    auxplots.append(Plot(ROOT.TH1F(discrname+"_"+"total","Evt_HT_Jets",1,0,3000),"N_BTagsM","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    
    discriminatorPlots+=auxplots
