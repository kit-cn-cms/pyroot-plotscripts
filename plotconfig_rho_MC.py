...
PDFs=[
[0.972675578181,0.921032569784,0.875886105338], #1500
[0.948759964799,0.883672351076,0.830015010818], #2000
[0.932585587385,0.845869285082,0.779920861235], #2500
]
...
systweightnamesMCSFs=[
                    ...
                    "" + ABCDversion + "_MCSF_powheg_renfacUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR2p0_muF1p0"+"*((murmuf1500==1)/"+str(murmufs[0][0])+"+(murmuf2000==1)/"+str(murmufs[1][0])+"+(murmuf2500==1)/"+str(murmufs[2][0])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_powheg_renfacDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR0p5_muF2p0"+"*((murmuf1500==1)/"+str(murmufs[0][1])+"+(murmuf2000==1)/"+str(murmufs[1][1])+"+(murmuf2500==1)/"+str(murmufs[2][1])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_powheg_renUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF0p5"+"*((murmuf1500==1)/"+str(murmufs[0][2])+"+(murmuf2000==1)/"+str(murmufs[1][2])+"+(murmuf2500==1)/"+str(murmufs[2][2])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_powheg_renDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR2p0_muF0p5"+"*((murmuf1500==1)/"+str(murmufs[0][3])+"+(murmuf2000==1)/"+str(murmufs[1][3])+"+(murmuf2500==1)/"+str(murmufs[2][3])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_powheg_facUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF1p0"+"*((murmuf1500==1)/"+str(murmufs[0][4])+"+(murmuf2000==1)/"+str(murmufs[1][4])+"+(murmuf2500==1)/"+str(murmufs[2][4])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_powheg_facDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF2p0"+"*((murmuf1500==1)/"+str(murmufs[0][5])+"+(murmuf2000==1)/"+str(murmufs[1][5])+"+(murmuf2500==1)/"+str(murmufs[2][5])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0", 
                    ...
                    "" + ABCDversion + "_MCSF_amc_renfacUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR2p0_muF1p0"+"*((murmuf1500==1)/"+str(murmufs[0][0])+"+(murmuf2000==1)/"+str(murmufs[1][0])+"+(murmuf2500==1)/"+str(murmufs[2][0])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_amc_renfacDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR0p5_muF2p0"+"*((murmuf1500==1)/"+str(murmufs[0][1])+"+(murmuf2000==1)/"+str(murmufs[1][1])+"+(murmuf2500==1)/"+str(murmufs[2][1])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_amc_renUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF0p5"+"*((murmuf1500==1)/"+str(murmufs[0][2])+"+(murmuf2000==1)/"+str(murmufs[1][2])+"+(murmuf2500==1)/"+str(murmufs[2][2])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_amc_renDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR2p0_muF0p5"+"*((murmuf1500==1)/"+str(murmufs[0][3])+"+(murmuf2000==1)/"+str(murmufs[1][3])+"+(murmuf2500==1)/"+str(murmufs[2][3])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_amc_facUp:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF1p0"+"*((murmuf1500==1)/"+str(murmufs[0][4])+"+(murmuf2000==1)/"+str(murmufs[1][4])+"+(murmuf2500==1)/"+str(murmufs[2][4])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0",
                    "" + ABCDversion + "_MCSF_amc_facDown:=(MCSF_Weight_" + ABCDversion + "*Weight_scale_variation_muR1p0_muF2p0"+"*((murmuf1500==1)/"+str(murmufs[0][5])+"+(murmuf2000==1)/"+str(murmufs[1][5])+"+(murmuf2500==1)/"+str(murmufs[2][5])+")*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*1.0", 
...
SignalSamples=[
                    ...
                    Sample('Z->tWb, m(Z\'_{Nar})=1500, m(T\'_{Nar,LH})=700, T\'->Wb',ROOT.kMagenta-7,path+'Zprime*ToWB*Mzp-1500Nar*700Nar*nominal*Tree*.root',mcweight+'/95.06*232956.0/232893.0','SigRho1500700_tWb',allweightsystnames),
                    ...
                    Sample('Z->tWb, m(Z\'_{Nar})=1500, m(T\'_{Nar,LH})=900, T\'->Wb',ROOT.kMagenta,path+'Zprime*ToWB*Mzp-1500Nar*900Nar*nominal*Tree*.root',mcweight+'/138.07*233247.0/233185.0','SigRho1500900_tWb',allweightsystnames),
                    Sample('Z->tWb, m(Z\'_{Nar})=1500, m(T\'_{Nar,LH})=1200, T\'->Wb',ROOT.kMagenta+2,path+'Zprime*ToWB*Mzp-1500Nar*1200Nar*nominal*Tree*.root',mcweight+'/99.03*232087.0/197288.0','SigRho15001200_tWb',allweightsystnames),
                    Sample('Z->tWb, m(Z\'_{Nar})=2000, m(T\'_{Nar,LH})=900, T\'->Wb',ROOT.kCyan+3,path+'Zprime*ToWB*Mzp-2000Nar*900Nar*nominal*Tree*.root',mcweight+'/55.83*229339.0/230269.0','SigRho2000900_tWb',allweightsystnames),
                    Sample('Z->tWb, m(Z\'_{Nar})=2000, m(T\'_{Nar,LH})=1200, T\'->Wb',ROOT.kCyan,path+'Zprime*ToWB*Mzp-2000Nar*1200Nar*LH*nominal*Tree*.root',mcweight+'/86.28*197385.0/197288.0','SigRho20001200_tWb',allweightsystnames),
                    Sample('Z->tWb, m(Z\'_{Nar})=2000, m(T\'_{Nar,LH})=1500, T\'->Wb',ROOT.kCyan-6,path+'Zprime*ToWB*Mzp-2000Nar*1500Nar*nominal*Tree*.root',mcweight+'/83.47*229497.0/229372.0','SigRho20001500_tWb',allweightsystnames),
                    Sample('Z->tWb, m(Z\'_{Nar})=2500, m(T\'_{Nar,LH})=1200, T\'->Wb',ROOT.kRed,path+'Zprime*ToWB*Mzp-2500Nar*1200Nar*nominal*Tree*.root',mcweight+'/37.6*226697.0/223936.0','SigRho25001200_tWb',allweightsystnames), 
