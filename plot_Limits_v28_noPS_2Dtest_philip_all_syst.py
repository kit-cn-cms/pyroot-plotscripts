...
def main(argv):
    ...
    name='limits_v28_2Dtest_philip_all_syst'
    analysis=Analysis(name,argv,'/nfs/dust/cms/user/kelmorab/plotscripts18/July18/pyroot-plotscripts/workdir/limits_v28_2Dtest_philip_all_syst/output_limitInput.root ', signalProcess='ttH')
