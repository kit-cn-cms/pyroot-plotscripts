...
weightSystNames=[
                    "",
                   "_CMS_ttHbb_L1ECALPrefire","_CMS_ttHbb_L1ECALPrefireUp","_CMS_ttHbb_L1ECALPrefireDown"
]
...
systWeights=[
                   ...
                   "dummyWeight_L1ECALPrefire:=("+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_L1ECALPrefire)*(DoWeights==1)+(DoWeights==0)*1.0",
                   "dummyWeight_L1ECALPrefireup:=("+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_L1ECALPrefireUp)*(DoWeights==1)+(DoWeights==0)*1.0",
                   "dummyWeight_L1ECALPrefiredown:=("+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_L1ECALPrefireDown)*(DoWeights==1)+(DoWeights==0)*1.0",
...
# samples
# input path 
path_karim_new="/nfs/dust/cms/user/kelmorab/ttH_2018/ntuples_v5_L1"
path_mwassmer="/nfs/dust/cms/user/kelmorab/ttH_2018/ntuples_v5_L1"
