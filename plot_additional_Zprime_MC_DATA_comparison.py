...
"""
float Evt_HT_Jets_tWbcalc(float const* Zprimes_ABCD""" +  radi + """_M, float const* Tprimes_ABCD""" +  radi + """_M, float const* Tops_ABCD""" +  radi + """_maxsubjetCSVv2, float const* Ws_ABCD""" +  radi + """_MSD, float const* Ws_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_MSD, float const* Tops_ABCD""" +  radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_t32, float const* Bottoms_ABCD""" +  radi + """_CSV, float const* Ws_ABCD""" +  radi + """_t21, float const* Ws_ABCD""" + radi + """_Pt, float const* Tops_ABCD""" + radi + """_Pt, float const* Bottoms_ABCD""" + radi + """_Pt, float Evt_HT_Jets, int N_Zprime_ABCD""" + radi + """, float N_Jets, float N_packedPatJetsAK8PFCHSSoftDrop){
    float res=0.0;
    for (int i=0; i<N_Zprime_ABCD""" +  radi + """; i++){
        if ("""+ generalselection_i +"""){
            if("""+ plotselection_topsubjetCSVv2_i +"""){
...
additionalvariables=[
			...
			#'IsnoSignalwithtopbtag:=IsnoSignal_withtopbtag(Zprimes_ABCD_M, Tprimes_ABCD_M, Tops_ABCD_maxsubjetCSVv2, Ws_ABCD_MSD, Tops_ABCD_MSD, Tops_ABCD_t32, Bottoms_ABCD_CSV, Ws_ABCD_t21, N_Zprime_ABCD)',
                        ...
                        'ABCD_CatID:=1.0 * ABCD_Category(Zprimes_ABCD' + radi + '_M,   Tprimes_ABCD' + radi + '_M,   Tops_ABCD' + radi + '_maxsubjetCSVv2,   Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3,   Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,   Tops_ABCD' + radi + '_t32,   Bottoms_ABCD' + radi + '_CSV,   Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop)',
                        ...
                        'ABCD_rate_systUp:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[0]',
                        'ABCD_rate_systDown:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[1]',
                        
                        'ABCD_shape_systUp:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[2]',
                        'ABCD_shape_systDown:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[3]',                         
                        ...
                        '' + ABCDversion + '_WeightCSVnominal:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[0]',
                        '' + ABCDversion + '_WeightCSVLFUp:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[1]',
                        '' + ABCDversion + '_WeightCSVLFDown:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[2]',
                        '' + ABCDversion + '_WeightCSVHFUp:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[3]',
                        '' + ABCDversion + '_WeightCSVHFDown:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[4]',
                        '' + ABCDversion + '_WeightCSVHFStats1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[5]',
                        '' + ABCDversion + '_WeightCSVHFStats1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[6]',
                        '' + ABCDversion + '_WeightCSVLFStats1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[7]',
                        '' + ABCDversion + '_WeightCSVLFStats1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[8]',
                        '' + ABCDversion + '_WeightCSVHFStats2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[9]',
                        '' + ABCDversion + '_WeightCSVHFStats2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[10]',
                        '' + ABCDversion + '_WeightCSVLFStats2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[11]',
                        '' + ABCDversion + '_WeightCSVLFStats2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[12]',
                        '' + ABCDversion + '_WeightCSVCErr1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[13]',
                        '' + ABCDversion + '_WeightCSVCErr1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[14]',
                        '' + ABCDversion + '_WeightCSVCErr2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[15]',
                        '' + ABCDversion + '_WeightCSVCErr2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[16]',
                        ...
                        ABCDversion + '_Wtagweightnominal:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[0]',
                        ABCDversion + '_WtagweightUp:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[1]',
                        ABCDversion + '_WtagweightDown:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[2]',
                        ABCDversion + '_toptagweightnominal:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[0]',
                        ABCDversion + '_toptagweightUp:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[1]',
                        ABCDversion + '_toptagweightDown:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[2]',
                        ...
                        #'All_WeightCSVnominal:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[0]',
                        #'All_WeightCSVLFUp:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[1]',
                        #'All_WeightCSVLFDown:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[2]',
                        #'All_WeightCSVHFUp:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[3]',
                        #'All_WeightCSVHFDown:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[4]',
                        #'All_WeightCSVHFStats1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[5]',
                        #'All_WeightCSVHFStats1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[6]',
                        #'All_WeightCSVLFStats1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[7]',
                        #'All_WeightCSVLFStats1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[8]',
                        #'All_WeightCSVHFStats2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[9]',
                        #'All_WeightCSVHFStats2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[10]',
                        #'All_WeightCSVLFStats2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[11]',
                        #'All_WeightCSVLFStats2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[12]',
                        #'All_WeightCSVCErr1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[13]',
                        #'All_WeightCSVCErr1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[14]',
                        #'All_WeightCSVCErr2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[15]',
                        #'All_WeightCSVCErr2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[16]',
                        
                        'MCSF_Weight_All:=Weight_CSV*Weight_pu69p2*PDF_RMSMean',
                        'MCSF_Weight_Nobtagging:=Weight_pu69p2*PDF_RMSMean',
                        
                        'EvtHT_tWb:=Evt_HT_Jets_tWbcalc(Zprimes_ABCD' +  radi + '_M, Tprimes_ABCD' +  radi + '_M, Tops_ABCD' +  radi + '_maxsubjetCSVv2, Ws_ABCD' +  radi + '_MSD,  Ws_ABCD' +  radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' +  radi + '_t32, Bottoms_ABCD' +  radi + '_CSV, Ws_ABCD' +  radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt, Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop)',
