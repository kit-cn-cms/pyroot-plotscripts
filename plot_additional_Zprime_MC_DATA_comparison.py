...
if ABCDversion is 'ABCD5':
    ...
    if (not WZwindow) and fullWMSD:
        Zprime_withtopbtag_systrate="0.178"
        Zprime_withtopbtag_systshape_m="0.000122047"
        Zprime_withtopbtag_systshape_c="0.773021"
        Zprime_notopbtag_systrate="0.03894"
        Zprime_notopbtag_systshape_m="0.00000687"
        Zprime_notopbtag_systshape_c="1.05675"
        
    if WZwindow and fullWMSD:
        Zprime_withtopbtag_systrate="0.20"
        Zprime_withtopbtag_systshape_m="0.000197"
        Zprime_withtopbtag_systshape_c="0.6103"
        Zprime_notopbtag_systrate="0.084"
        Zprime_notopbtag_systshape_m="-0.0000617661"
        Zprime_notopbtag_systshape_c="1.08495"
...
"""
std::vector<float> toptag_weights_""" + ABCDversion + """(float const* Zprimes_ABCD""" + radi + """_M, float const* Tprimes_ABCD""" + radi + """_M, float const* Tops_ABCD""" + radi + """_maxsubjetCSVv2, float const* Ws_ABCD""" + radi + """_MSD_smeared, float const* Ws_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" + radi + """_MSD, float const* Tops_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" + radi + """_t32, float const* Bottoms_ABCD""" + radi + """_CSV, float const* Ws_ABCD""" + radi + """_t21, float const* Ws_ABCD""" + radi + """_Pt, float const* Tops_ABCD""" + radi + """_Pt, float const* Bottoms_ABCD""" + radi + """_Pt, float Evt_HT_Jets, int N_Zprime_ABCD""" + radi + """, float N_Jets, float N_packedPatJetsAK8PFCHSSoftDrop, float const* Tops_ABCD""" + radi + """_real, float const* Tops_ABCD""" + radi + """_matcheddecays){
    std::vector<float> weights;
    ...
    for (int i=0; i<N_Zprime_ABCD""" + radi + """; i++){
        if (""" + generalselection_i + """){
            if(Tops_ABCD""" + radi + """_real[i]==1 && Tops_ABCD""" + radi + """_matcheddecays[i]>2){
                ...
                if(""" + plotselection_tau32_i + """ && """ + plotselection_t_MSD_i + """){
                    toptagnominal *= SF_topmiss_tau32_MSD_;
                    toptagup *= (SF_topmiss_tau32_MSD_ + SF_topmiss_tau32_MSD_up);
                    toptagdown *= (SF_topmiss_tau32_MSD_ - SF_topmiss_tau32_MSD_down);
                }
                if(""" + plotselection_tau32_anti_i + """ && """ + plotselection_t_MSD_i + """){
                    toptagnominal *= SF_topmiss_tau32anti_MSD_;
                    toptagup *= (SF_topmiss_tau32anti_MSD_ + SF_topmiss_tau32anti_MSD_up);
                    toptagdown *= (SF_topmiss_tau32anti_MSD_ - SF_topmiss_tau32anti_MSD_down);
                }
                if(""" + plotselection_tau32_i + """ && """ + plotselection_t_MSD_anti_i + """){
                    toptagnominal *= SF_topmiss_tau32_MSDanti_;
                    toptagup *= (SF_topmiss_tau32_MSDanti_ + SF_topmiss_tau32_MSDanti_up);
                    toptagdown *= (SF_topmiss_tau32_MSDanti_ - SF_topmiss_tau32_MSDanti_down);
                }
                if(""" + plotselection_tau32_anti_i + """ && """ + plotselection_t_MSD_anti_i + """){
                    toptagnominal *= SF_topmiss_tau32anti_MSDanti_;
                    toptagup *= (SF_topmiss_tau32anti_MSDanti_ + SF_topmiss_tau32anti_MSDanti_up);
                    toptagdown *= (SF_topmiss_tau32anti_MSDanti_ - SF_topmiss_tau32anti_MSDanti_down);
                }
            }
            break;
        }
...
,
"""
std::vector<float> Wtag_weights_""" + ABCDversion + """(float const* Zprimes_ABCD""" + radi + """_M, float const* Tprimes_ABCD""" + radi + """_M, float const* Tops_ABCD""" + radi + """_maxsubjetCSVv2, float const* Ws_ABCD""" + radi + """_MSD_smeared, float const* Ws_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" + radi + """_MSD, float const* Tops_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" + radi + """_t32, float const* Bottoms_ABCD""" + radi + """_CSV, float const* Ws_ABCD""" + radi + """_t21, float const* Ws_ABCD""" + radi + """_Pt, float const* Tops_ABCD""" + radi + """_Pt, float const* Bottoms_ABCD""" + radi + """_Pt, float Evt_HT_Jets, int N_Zprime_ABCD""" + radi + """, float N_Jets, float N_packedPatJetsAK8PFCHSSoftDrop, float const* Ws_ABCD""" + radi + """_real, float const* Ws_ABCD""" + radi + """_matcheddecays){
   std::vector<float> weights;
...
std::vector<float> ABCD_syts(float const* Zprimes_ABCD""" +  radi + """_M, float const* Tprimes_ABCD""" +  radi + """_M, float const* Tops_ABCD""" +  radi + """_maxsubjetCSVv2, float const* Ws_ABCD""" +  radi + """_MSD_smeared, float const* Ws_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_MSD, float const* Tops_ABCD""" +  radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_t32, float const* Bottoms_ABCD""" +  radi + """_CSV, float const* Ws_ABCD""" +  radi + """_t21, float const* Ws_ABCD""" + radi + """_Pt, float const* Tops_ABCD""" + radi + """_Pt, float const* Bottoms_ABCD""" + radi + """_Pt, float Evt_HT_Jets, int N_Zprime_ABCD""" + radi + """, float N_Jets, float N_packedPatJetsAK8PFCHSSoftDrop){
    ...
    for (int i=0; i<N_Zprime_ABCD""" + radi + """; i++){
        if ("""+ generalselection_i +"""){
            if("""+ plotselection_topsubjetCSVv2_i +"""){
                ABCD_rateUp=(1.0 + (""" + Zprime_withtopbtag_systrate + """));
                ABCD_rateDown=(1.0 - (""" + Zprime_withtopbtag_systrate + """));
                ABCD_shapeUp=(1.0 + 1.0-(N_Zprime_ABCD""" + radi + """ * """ + Zprime_withtopbtag_systshape_m + """ + """ + Zprime_withtopbtag_systshape_c + """));
                ABCD_shapeDown=(1.0 - 1.0-(N_Zprime_ABCD""" + radi + """ * """ + Zprime_withtopbtag_systshape_m + """ + """ + Zprime_withtopbtag_systshape_c + """));
            } else {
                ABCD_rateUp=(1.0 + (""" + Zprime_notopbtag_systrate + """));
                ABCD_rateDown=(1.0 - (""" + Zprime_notopbtag_systrate + """));
                ABCD_shapeUp=(1.0 + 1.0-(N_Zprime_ABCD""" + radi + """ * """ + Zprime_notopbtag_systshape_m + """ + """ + Zprime_notopbtag_systshape_c + """));
                ABCD_shapeDown=(1.0 - 1.0-(N_Zprime_ABCD""" + radi + """ * """ + Zprime_notopbtag_systshape_m + """ + """ + Zprime_notopbtag_systshape_c + """));
            };
        break;
        };
    }
...
"""
float Evt_HT_Jets_tWbcalc(float const* Zprimes_ABCD""" +  radi + """_M, float const* Tprimes_ABCD""" +  radi + """_M, float const* Tops_ABCD""" +  radi + """_maxsubjetCSVv2, float const* Ws_ABCD""" +  radi + """_MSD_smeared, float const* Ws_ABCD""" + radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_MSD, float const* Tops_ABCD""" +  radi + """_corrL2L3, float const* Tops_ABCD""" +  radi + """_t32, float const* Bottoms_ABCD""" +  radi + """_CSV, float const* Ws_ABCD""" +  radi + """_t21, float const* Ws_ABCD""" + radi + """_Pt, float const* Tops_ABCD""" + radi + """_Pt, float const* Bottoms_ABCD""" + radi + """_Pt, float Evt_HT_Jets, int N_Zprime_ABCD""" + radi + """, float N_Jets, float N_packedPatJetsAK8PFCHSSoftDrop){
    float res=0.0;
    for (int i=0; i<N_Zprime_ABCD""" +  radi + """; i++){
        if ("""+ generalselection_i +"""){
            if("""+ plotselection_topsubjetCSVv2_i +"""){
                if("""+ cut1_i +"""){
                    if("""+ cut2_i + """){
                        if(""" + cut3_i + """){
                            res=Tops_ABCD""" + radi + """_Pt[i] + Ws_ABCD""" + radi + """_Pt[i] + Bottoms_ABCD""" + radi + """_Pt[i];
                            break;
                       }
                        if(""" + cut3_anti_i + """){
                            res=0;
...
additionalvariables=[
			...
			#'IsnoSignalwithtopbtag:=IsnoSignal_withtopbtag(Zprimes_ABCD_M, Tprimes_ABCD_M, Tops_ABCD_maxsubjetCSVv2, Ws_ABCD_MSD, Tops_ABCD_MSD, Tops_ABCD_t32, Bottoms_ABCD_CSV, Ws_ABCD_t21, N_Zprime_ABCD)',
                        ...
                        'ABCD_CatID:=1.0 * ABCD_Category(Zprimes_ABCD' + radi + '_M,   Tprimes_ABCD' + radi + '_M,   Tops_ABCD' + radi + '_maxsubjetCSVv2,  Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3,   Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,   Tops_ABCD' + radi + '_t32,   Bottoms_ABCD' + radi + '_CSV,   Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop)',
                        ...
                        'ABCD_rate_systUp:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD_smeared,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[0]',
                        'ABCD_rate_systDown:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD_smeared,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[1]',
                        
                        'ABCD_shape_systUp:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD_smeared,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[2]',
                        'ABCD_shape_systDown:=ABCD_syts( Zprimes_ABCD' +  radi + '_M,  Tprimes_ABCD' +  radi + '_M,  Tops_ABCD' +  radi + '_maxsubjetCSVv2,  Ws_ABCD' +  radi + '_MSD_smeared,  Ws_ABCD' +  radi + '_corrL2L3,  Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3,  Tops_ABCD' +  radi + '_t32,  Bottoms_ABCD' +  radi + '_CSV,  Ws_ABCD' +  radi + '_t21,  Ws_ABCD' + radi + '_Pt,  Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt,  Evt_HT_Jets,  N_Zprime_ABCD' + radi + ',  N_Jets,  N_packedPatJetsAK8PFCHSSoftDrop)[3]',                         
                        ...
                        #'' + ABCDversion + '_WeightCSVnominal:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[0]',
                        #'' + ABCDversion + '_WeightCSVLFUp:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[1]',
                        #'' + ABCDversion + '_WeightCSVLFDown:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[2]',
                        #'' + ABCDversion + '_WeightCSVHFUp:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[3]',
                        #'' + ABCDversion + '_WeightCSVHFDown:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[4]',
                        #'' + ABCDversion + '_WeightCSVHFStats1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[5]',
                        #'' + ABCDversion + '_WeightCSVHFStats1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[6]',
                        #'' + ABCDversion + '_WeightCSVLFStats1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[7]',
                        #'' + ABCDversion + '_WeightCSVLFStats1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[8]',
                        #'' + ABCDversion + '_WeightCSVHFStats2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[9]',
                        #'' + ABCDversion + '_WeightCSVHFStats2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[10]',
                        #'' + ABCDversion + '_WeightCSVLFStats2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[11]',
                        #'' + ABCDversion + '_WeightCSVLFStats2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[12]',
                        #'' + ABCDversion + '_WeightCSVCErr1Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[13]',
                        #'' + ABCDversion + '_WeightCSVCErr1Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[14]',
                        #'' + ABCDversion + '_WeightCSVCErr2Up:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[15]',
                        #'' + ABCDversion + '_WeightCSVCErr2Down:=(CSV_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[16]',
                        
                        ##'ABCD1_Wtagweightnominal:=(Wtag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[0]',
                        ##'ABCD1_WtagweightUp:=(Wtag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[1]',
                        ##'ABCD1_WtagweightDown:=(Wtag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[2]',
                        ##'ABCD1_toptagweightnominal:=(toptag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[0]',
                        ##'ABCD1_toptagweightUp:=(toptag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[1]',
                        ##'ABCD1_toptagweightDown:=(toptag_weights_ABCD' + radi + '1(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[2]',
 
                        ##'ABCD2_Wtagweightnominal:=(Wtag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[0]',
                        ##'ABCD2_WtagweightUp:=(Wtag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[1]',
                        ##'ABCD2_WtagweightDown:=(Wtag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[2]',
                        ##'ABCD2_toptagweightnominal:=(toptag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[0]',
                        ##'ABCD2_toptagweightUp:=(toptag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[1]',
                        ##'ABCD2_toptagweightDown:=(toptag_weights_ABCD' + radi + '2(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + '))[2]',
                        
                        #ABCDversion + '_Wtagweightnominal:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[0]',
                        #ABCDversion + '_WtagweightUp:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[1]',
                        #ABCDversion + '_WtagweightDown:=(Wtag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Ws_ABCD' + radi + '_real, Ws_ABCD' + radi + '_matcheddecays))[2]',
                        #ABCDversion + '_toptagweightnominal:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[0]',
                        #ABCDversion + '_toptagweightUp:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[1]',
                        #ABCDversion + '_toptagweightDown:=(toptag_weights_' + ABCDversion + '(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop, Tops_ABCD' + radi + '_real, Tops_ABCD' + radi + '_matcheddecays))[2]',
                        ...
                        ##'All_WeightCSVnominal:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[0]',
                        ##'All_WeightCSVLFUp:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[1]',
                        ##'All_WeightCSVLFDown:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[2]',
                        ##'All_WeightCSVHFUp:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[3]',
                        ##'All_WeightCSVHFDown:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[4]',
                        ##'All_WeightCSVHFStats1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[5]',
                        ##'All_WeightCSVHFStats1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[6]',
                        ##'All_WeightCSVLFStats1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[7]',
                        ##'All_WeightCSVLFStats1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[8]',
                        ##'All_WeightCSVHFStats2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[9]',
                        ##'All_WeightCSVHFStats2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[10]',
                        ##'All_WeightCSVLFStats2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[11]',
                        ##'All_WeightCSVLFStats2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[12]',
                        ##'All_WeightCSVCErr1Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[13]',
                        ##'All_WeightCSVCErr1Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[14]',
                        ##'All_WeightCSVCErr2Up:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[15]',
                        ##'All_WeightCSVCErr2Down:=(CSV_weights_all(Zprimes_ABCD' + radi + '_M, Tprimes_ABCD' + radi + '_M, Tops_ABCD' + radi + '_maxsubjetCSVv2, Ws_ABCD' + radi + '_MSD_smeared, Ws_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' + radi + '_t32, Bottoms_ABCD' + radi + '_CSV, Ws_ABCD' + radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt,  Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop,Bottoms_ABCD' + radi + '_WeightCSVnominal, Bottoms_ABCD' + radi + '_WeightCSVLFup, Bottoms_ABCD' + radi + '_WeightCSVLFdown, Bottoms_ABCD' + radi + '_WeightCSVHFup, Bottoms_ABCD' + radi + '_WeightCSVHFdown, Bottoms_ABCD' + radi + '_WeightCSVHFStats1up, Bottoms_ABCD' + radi + '_WeightCSVHFStats1down, Bottoms_ABCD' + radi + '_WeightCSVLFStats1up, Bottoms_ABCD' + radi + '_WeightCSVLFStats1down, Bottoms_ABCD' + radi + '_WeightCSVHFStats2up, Bottoms_ABCD' + radi + '_WeightCSVHFStats2down, Bottoms_ABCD' + radi + '_WeightCSVLFStats2up, Bottoms_ABCD' + radi + '_WeightCSVLFStats2down, Bottoms_ABCD' + radi + '_WeightCSVCErr1up, Bottoms_ABCD' + radi + '_WeightCSVCErr1down, Bottoms_ABCD' + radi + '_WeightCSVCErr2up, Bottoms_ABCD' + radi + '_WeightCSVCErr2down, Topsubjets_ABCD' + radi + '_WeightCSVnominal, Topsubjets_ABCD' + radi + '_WeightCSVLFup, Topsubjets_ABCD' + radi + '_WeightCSVLFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFup, Topsubjets_ABCD' + radi + '_WeightCSVHFdown, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats1down, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVHFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2up, Topsubjets_ABCD' + radi + '_WeightCSVLFStats2down, Topsubjets_ABCD' + radi + '_WeightCSVCErr1up, Topsubjets_ABCD' + radi + '_WeightCSVCErr1down, Topsubjets_ABCD' + radi + '_WeightCSVCErr2up, Topsubjets_ABCD' + radi + '_WeightCSVCErr2down  ))[16]',
                        
                        #'MCSF_Weight_All:=Weight_CSV*Weight_pu69p2*PDF_RMSMean',
                        #'MCSF_Weight_Nobtagging:=Weight_pu69p2*PDF_RMSMean',
                        
                        #'EvtHT_tWb:=Evt_HT_Jets_tWbcalc(Zprimes_ABCD' +  radi + '_M, Tprimes_ABCD' +  radi + '_M, Tops_ABCD' +  radi + '_maxsubjetCSVv2, Ws_ABCD' +  radi + '_MSD_smeared,  Ws_ABCD' +  radi + '_corrL2L3, Tops_ABCD' + radi + '_MSD, Tops_ABCD' + radi + '_corrL2L3, Tops_ABCD' +  radi + '_t32, Bottoms_ABCD' +  radi + '_CSV, Ws_ABCD' +  radi + '_t21, Ws_ABCD' + radi + '_Pt, Tops_ABCD' + radi + '_Pt, Bottoms_ABCD' + radi + '_Pt, Evt_HT_Jets, N_Zprime_ABCD' + radi + ', N_Jets, N_packedPatJetsAK8PFCHSSoftDrop)',
