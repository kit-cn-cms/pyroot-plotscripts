...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategy_binning_4node_combinedtthf_newmodel_binning1_ttH_only'
    ...
    plot_cfg        = "ttH_legacy_study_tthf_var_binning_4node_binning1_ttH_only"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/tthlegacystrategystudy/DNNs/binning_tthf/4node"}
