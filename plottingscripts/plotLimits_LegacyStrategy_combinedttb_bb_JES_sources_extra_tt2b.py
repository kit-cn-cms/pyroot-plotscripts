...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategy_combinedttb_bb_JES_sources_extra_tt2b'
    ...
    # configs
    config          = "pltcfg_ttH17_combinedtt_hf_extra_tt2b"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH/tthlegacystrategystudy/DNNs/combinedtt_hf/"}
