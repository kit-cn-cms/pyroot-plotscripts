...
def main(pyrootdir, opts):
    ...
    name = 'sfCorrections/test_2017_noSel'
    ...
    memexp = ''
    # configs
    config          = "SFSFderivation/samples_testSFs_2017_noSel"
    ...
    sfCorrection = {}
    sfCorrection["sfFile"] =  pyrootdir+"/data/btagSFCorrection/sf_2017_deepJet_noSel.root"
