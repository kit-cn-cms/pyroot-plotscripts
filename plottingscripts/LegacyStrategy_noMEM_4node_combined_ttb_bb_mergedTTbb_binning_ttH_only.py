...
def main(pyrootdir, opts):
    ...
    name = 'toytests_noMEM_4node_combined_ttb_bb_mergedTTbb_binning_ttH_only'
    ...
    memexp = ""
    # configs
    config          = "ttH17_legacyStrategy/pltcfg_2017_old_samples_combined_ttb_bb_mergedTTbb"
    variable_cfg    = "ttH17_legacyStrategy/additionalVariables"
    plot_cfg        = "ttH17_legacyStrategy/plots_toytests_noMEM_4node_ttH_only"
    syst_cfg        = "ttH17_legacyStrategy/systs_combinedttb_bb"
    ...
    plotJson = "/nfs/dust/cms/user/swieland/ttH_legacy/theRealPlotscript/pyroot-plotscripts/configs/ttH17_legacyStrategy/treejson_ttb_bb_mergedTTbb.json"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                   "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/tthlegacystrategystudy/DNNs/4node_mergedSample/"}
    # dnnInterface = None
