...
def main(pyrootdir, opts):
    ...
    name = 'inputFeatures_final_2D/Classifier_top10_ge4j_ge4t/2018'
    ...
    plot_cfg        = "legacyAnalysis/inputFeature_validation/ttH_legacy_inputfeatures_top10_Classifier_opt_binning_ge4j_ge4t_2D"
