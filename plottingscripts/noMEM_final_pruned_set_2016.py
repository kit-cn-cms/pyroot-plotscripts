...
def main(pyrootdir, opts):
    ...
    name = 'noMEM_final_pruned_sets/2016'
    ...
    plot_cfg        = "legacyAnalysis/noMEM_sets/final_pruned_sets/noMEM_final_pruned_varsets"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                  "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis/noMEM_sets/final_pruned_sets/DNNInputData/"}
    # dnnInterface = None
