...
def main(pyrootdir, opts):
    ...
    name = '2020_06_08_ttHH_final/high_NJet_2017'
    ...
    plot_cfg        = "legacyAnalysis_ttHH/finalDNN/high_NJet_DNN_config_optimized_binning"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                   "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis_ttHH/finalDNN/DNNInputData/high_NJet"}
    #dnnInterface = None
