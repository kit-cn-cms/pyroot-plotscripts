...
def main(pyrootdir, opts):
    ...
    name = 'toytests_noMEM_5node_split_ttbjets_mergedTTbb_binning_ttH_only'
    ...
    memexp = ""
    # configs
    config          = "ttH17_legacyStrategy/pltcfg_2017_old_samples_split_ttbjets_mergedTTbb"
    ...
    syst_cfg        = "ttH17_legacyStrategy/systs_mergedTTbb_split_ttbjets"
