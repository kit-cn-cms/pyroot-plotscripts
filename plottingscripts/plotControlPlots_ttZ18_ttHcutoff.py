...
def main(pyrootdir, opts):
    ...
    name = 'ttZControlPlots_ttHcutoff'
    ...
    # configs
    config          = "ttZ18/pltcfg_controlPlots_internalCSV_ttHCutoff"
    variable_cfg    = "ttZ18/additionalVariables"
    plot_cfg        = "ttZ18/controlPlots_ttHCutoff"
    syst_cfg        = "ttZ18/no_systematics"
