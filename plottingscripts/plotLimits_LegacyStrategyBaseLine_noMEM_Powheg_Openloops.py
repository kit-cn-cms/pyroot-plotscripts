...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategyBaseline_noMEM_Powheg_Openloops'
    ...
    # configs
    config          = "pltcfg_ttH17_Powheg_Openloops"
    variable_cfg    = "ttH17_addVariables"
    plot_cfg        = "LegacyStrategyStudyBaseline_noMEM_Plots_Powheg_Openloops"
    ...
    # plotJson = "/nfs/dust/cms/user/swieland/ttH_legacy/pyroot-plotscripts/LegacyStudy_treejson.json"
    plotJson = ""
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/tthlegacystrategystudy/DNNs/BaseLine_noMEM_Powheg_Openloops/"}
