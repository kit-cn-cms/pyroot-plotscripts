...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategy_binning_4node_combinedtthf_InklusiveBTagInformation'
    ...
    plot_cfg        = "4node_ge4j_ge3t_BTagInformation"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/tthlegacystrategystudy/DNNs/combinedtthf_BTagInformation"}
