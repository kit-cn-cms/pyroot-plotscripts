...
def main(pyrootdir, opts):
    ...
    name = 'inputFeatures_final_2D/STXS_ge4j_ge4t/2018'
    ...
    plot_cfg        = "legacyAnalysis/inputFeature_validation/ttH_legacy_inputfeatures_top10_STXS_opt_binning_ge4j_ge4t_2D"
