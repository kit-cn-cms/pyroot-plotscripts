...
def main(pyrootdir, opts):
    ...
    name = 'ttZ18_5NodettHDNN_binning3_v4prelim'
    ...
    plot_cfg        = "ttZ18/discrPlots_5NodeH_binning3"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/vdlinden/legacyTTH/DNNSets/ttZ_5NodeH_top30_v1"}
