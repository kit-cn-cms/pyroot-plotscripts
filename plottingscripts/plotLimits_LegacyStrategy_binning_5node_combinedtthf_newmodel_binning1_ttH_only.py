...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategy_binning_5node_combinedtthf_newmodel_binning1_ttH_only'
    ...
    # configs
    config          = "pltcfg_ttH17_combined_tthf_JES_sources"
    variable_cfg    = "ttH17_addVariables"
    plot_cfg        = "ttH_legacy_study_tthf_var_binning_5node_binning1_ttH_only"
    syst_cfg        = "LegacyStrategyStudy_Systematics_JES_sources_major_bkg_ttH_combined_tthf"
    ...
    plotJson = "/nfs/dust/cms/user/swieland/ttH_legacy/pyroot-plotscripts/LegacyStudy_JES_sources_treejson.json"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/tthlegacystrategystudy/DNNs/binning_tthf/5node"}
