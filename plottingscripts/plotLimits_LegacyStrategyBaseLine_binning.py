...
def main(pyrootdir, argv):
    ...
    name = 'ttHAnalysis_2017_LegacyStrategy_combined_tthf_JES_sources_other_JetTags'
    ...
    # configs
    config          = "LegacyStrategyStudy_Systematics_JES_sources_major_bkg_ttH"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/pkeicher/ttH_legacy/tthlegacystrategystudy/DNNs/combinedtthf_other_jettag_cats/"}
