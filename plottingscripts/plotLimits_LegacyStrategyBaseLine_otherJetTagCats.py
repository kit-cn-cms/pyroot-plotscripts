...
def main(pyrootdir, argv):
    ...
    plotJson = "/nfs/dust/cms/user/pkeicher/ttH_legacy/pyroot-plotscripts/Baseline_JES_sources_treejson.json"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/pkeicher/ttH_legacy/tthlegacystrategystudy/DNNs/baseline_other_jettag_cats/"}
