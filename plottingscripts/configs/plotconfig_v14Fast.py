...
#DISCLAIMER the following lines were not in the other file --->
...
#DISCLAIMER samplesControlPlots was different in other file
samplesControlPlots=[
...
#DISCLAIMER other version of samplesControlPlots
'''
samplesControlPlots=[
...
#print "limit samples"
#DISCLAIMER samplesLimits was different in other file
samplesLimits=[
...
#DISCLAIMER other version of samplesLimits
'''
samplesLimits=[
