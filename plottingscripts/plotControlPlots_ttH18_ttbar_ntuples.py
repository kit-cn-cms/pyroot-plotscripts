...
def main(pyrootdir, opts):
    ...
    name = 'ttHControlPlots_ttbar_ntuple_18_1p0'
    ...
    # configs
    config          = "ttH1X_Nikita/pltcfg_controlPlots_18_ttbar_ntuple"
    variable_cfg    = "ttH1X_Nikita/additionalVariables"
    plot_cfg        = "ttH1X_Nikita/controlPlots_v2"
    syst_cfg        = "ttH1X_Nikita/systs_18"

    # file for rate factors
    rateFactorsFile = "/nfs/dust/cms/user/nshadski/plotscripts/data/rateFactors/rateFactors_2018.csv"
    ...
    plotJson = "/nfs/dust/cms/user/nshadski/plotscripts/configs/ttH1X_Nikita/treejson_18_ttbar.json"
    #plotJson = ""
