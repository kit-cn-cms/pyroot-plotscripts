...
def main(pyrootdir, opts):
    ...
    name = 'finalDNN_fullSampleRFs_correctSeeSaw/2016_KAPPAscan'
    ...
    # configs
    config          = "legacyAnalysis/samples_2016_KappaScan"
    variable_cfg    = "legacyAnalysis/additionalVariables"
    plot_cfg        = "legacyAnalysis/finalDNN/finalDNN_optimized_classifier_kappaScan"
