...
def main(pyrootdir, opts):
    ...
    name = 'ttHControlPlots_ttbar_ntuple_16_1p0'
    ...
    # configs
    config          = "ttH1X_Nikita/pltcfg_controlPlots_16_ttbar_ntuple"
    variable_cfg    = "ttH1X_Nikita/additionalVariables"
    plot_cfg        = "ttH1X_Nikita/controlPlots_v2"
    syst_cfg        = "ttH1X_Nikita/systs_16"
    ...
    plotJson = "/nfs/dust/cms/user/nshadski/plotscripts/configs/ttH1X_Nikita/treejson_16_ttbar.json"
    #plotJson = ""
