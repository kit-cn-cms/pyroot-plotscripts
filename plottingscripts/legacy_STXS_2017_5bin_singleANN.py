...
def main(pyrootdir, opts):
    ...
    name = '2017_STXS_5FS/Buchstabe_05_singleANN_rebinned'
    ...
    plot_cfg        = "STXS17_legacy/2017_STXS_5FS_05_singleANN"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                   "checkpointFiles":  "/nfs/dust/cms/user/pkraemer/DNNCheckpoints/2017_STXS_5FS/04_newSingleANN"}
    # dnnInterface = None
