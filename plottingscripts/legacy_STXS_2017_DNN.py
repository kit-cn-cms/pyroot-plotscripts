...
def main(pyrootdir, opts):
    ...
    name = '5FS_2017_STXS_final/07_newTraining_2DNN_split4T'
    ...
    plot_cfg        = "STXS17_legacy/2017_STXS_5FS_02_5bin_DNN_split4T"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                   "checkpointFiles":  "/nfs/dust/cms/user/pkraemer/DNNCheckpoints/2017_STXS_5FS/05_new2ANN"}
    # dnnInterface = None
