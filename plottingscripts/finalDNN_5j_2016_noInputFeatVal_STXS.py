...
def main(pyrootdir, opts):
    ...
    name = 'finalDNN_5j_noInputFeatVal/2016_STXS_ratio'
    ...
    rateFactorsFile = pyrootdir + "/data/rateFactors/ratefactors_stxs_2016.csv"
    ...
    plotJson = pyrootdir+"/configs/legacyAnalysis/treeJson_STXS_2016.json"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                  "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis/newCats_noInputFeatVal/DNNInputData/"}
    # dnnInterface = None
