...
def main(pyrootdir, opts):
    ...
    name = 'ttH_discr_plots_THstudy_2017_binning_left'
    ...
    plot_cfg        = "ttH17_legacy_THstudy_v2/discr_plots_2017_THstudy_binning_left"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                   "checkpointFiles":  "/nfs/dust/cms/user/swieland/ttH_legacy/DNNs/DNNs_THstudy_0711/Checkpoints"}
    # dnnInterface = None
