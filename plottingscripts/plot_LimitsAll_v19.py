...
def main(argv):
    ...
    additionalvariables=["Jet_Pt", "Muon_Pt", "Electron_Pt",
                         ...
                         'hardestJetPt:=Jet_Pt[0]', #DISCLAIMER this line was not in other version
                         ]
...
# BDT only but with the ttbb optimized BDTs
    ...
    #DISCLAIMER this was disabled in other version --->
    ...
    if analysis.doDrawParallel==False or analysis.plotNumber == None :
            ...
            #DISCLAIMER totalNumberOfHistosNeedsToRemainTheSame not specified in other version
            ...
            if os.path.exists(renamedPath):
              ...
              if type(THEoutputpath)==str:
                #DISCLAIMER Epsilon not specified in other version
            ...
            #DISCLAIMER other version had PseudoData activated and RealData deactivated
