...
def main(pyrootdir, opts):
    ...
    name = 'crosscheck_variables_finalRFs/2017'
    ...
    plotJson = "/nfs/dust/cms/user/pkeicher/ttH_legacy/pyroot-plotscripts/crosscheck_variables_treejson_2017.json"
    ...
    #               "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis/DNN_16-03-2020/DNNInputData/"}
    dnnInterface = None
