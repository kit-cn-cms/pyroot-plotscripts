...
def main(pyrootdir, opts):
    ...
    name = 'finalDNN_5j_noInputFeatVal/2017_STXS_ratio'
    ...
    syst_cfg        = "legacyAnalysis/systs_2017_glu50"
    ...
    rateFactorsFile = pyrootdir + "/data/rateFactors/ratefactors_stxs_2017.csv"
    ...
    plotJson = pyrootdir+"/configs/legacyAnalysis/treeJson_STXS_2017.json"
