...
def main(pyrootdir, opts):
    ...
    name = 'ttZ18_binning3_v5_ttHVeto'
    ...
    # configs
    config          = "ttZ18/pltcfg_discrPlots_internalCSV_all_ttHVeto"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/vdlinden/legacyTTH/DNNSets/ttZ_top30_comb"}
