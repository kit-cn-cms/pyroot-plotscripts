...
def main(pyrootdir, opts):
    ...
    name = 'finalDNN_unblinded/2017_CPscan_ttH'
    ...
    plot_cfg        = "legacyAnalysis/finalDNN/finalDNN_optimized_classifier_CPScan_newModel_ttH"
    syst_cfg        = "legacyAnalysis/systs_2017_ttH"
