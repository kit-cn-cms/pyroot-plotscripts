...
def main(pyrootdir, opts):
    ...
    name = 'noMEM_pruned_set_input_features_2D/2016_onlyMEM'
    ...
    # configs
    config          = "legacyAnalysis/samples_2016_no_hdecay"
    variable_cfg    = "legacyAnalysis/additionalVariables"
    plot_cfg        = "legacyAnalysis/noMEM_sets/pruned_sets/pruned_variable_set_input_features_optBinning_2D_onlyMEM"
    # plot_cfg        = "legacyAnalysis/DNN_14-05-2020/combined161718_DNNs"
    syst_cfg        = "legacyAnalysis/systs_2016_noPDF"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                  "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis/noMEM_sets/pruned_sets/DNNInputData/"}
    # dnnInterface = None
