...
def main(pyrootdir, opts):
    ...
    # configs
    config          = "ttZ18/pltcfg_controlPlots_internalCSV_scaled"
    variable_cfg    = "ttZ18/additionalVariables"
    plot_cfg        = "ttZ18/controlPlots_inclusive"
    syst_cfg        = "ttZ18/systematics_internalCSV_inclusive"
