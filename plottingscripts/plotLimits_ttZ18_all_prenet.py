...
def main(pyrootdir, opts):
    ...
    # configs
    config          = "ttZ18/pltcfg_discrPlots_internalCSV_all_prenet"
    variable_cfg    = "ttZ18/additionalVariables"
    plot_cfg        = "ttZ18/discrPlots_binning3_all"
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                    "checkpointFiles":  "/nfs/dust/cms/user/vdlinden/legacyTTH/DNNSets/ttZ_top30_comb_prenet"}
