...
def main(pyrootdir, opts):
    ...
    name = 'withMEM_final_newJECrun/2018_ttbb_predictions_acceptance'
    ...
    # configs
    config          = "legacyAnalysis/samples_2018_ttbb_predictions"
    ...
    syst_cfg        = "legacyAnalysis/systs_2018_old_model"
