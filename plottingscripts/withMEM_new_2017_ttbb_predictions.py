...
def main(pyrootdir, opts):
    ...
    name = 'withMEM_final_newJECrun/2017_ttbb_predictions_acceptance'
    ...
    # configs
    config          = "legacyAnalysis/samples_2017_ttbb_predictions"
    ...
    syst_cfg        = "legacyAnalysis/systs_2017_old_model"
