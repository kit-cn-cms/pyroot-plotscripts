...
def main(pyrootdir, opts):
    ...
    dnnInterface = {"interfacePath":    pyrootdir+"/util/dNNInterfaces/MLfoyInterface.py",
                  "checkpointFiles":  pyrootdir+"/configs/legacyAnalysis/noMEM_sets/kNN_set/DNNInputData/"}
    # dnnInterface = None
    ...
    with monitor.Timer("plotParallel"):
        ...
        pP.setMaxEvts_systs(300000)        # pP.request_runtime = 60*60*5
