...
def main(pyrootdir, opts):
    ...
    name = 'finalDNN_5j_noInputFeatVal/2016_CPScan_tH'
    ...
    # configs
    config          = "legacyAnalysis/samples_2016_CPScan_tH"
    variable_cfg    = "legacyAnalysis/additionalVariables"
    plot_cfg        = "legacyAnalysis/newCats_noInputFeatVal/withMEM_final_config_5j_CPscan_tH"
