...
systweightnamesMCSFs=[
                    ...
                    "" + ABCDversion + "_ttbarXSUp:=(MCSF_Weight_" + ABCDversion + "*(1.0+0.05)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ttbaronly==1)+(DoWeights*DoMCDataWeights_ttbaronly==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_ttbarXSDown:=(MCSF_Weight_" + ABCDversion + "*(1.0-0.05)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ttbaronly==1)+(DoWeights*DoMCDataWeights_ttbaronly==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_ST_tWXSUp:=(MCSF_Weight_" + ABCDversion + "*(1.0+0.053)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_tW==1)+(DoWeights*DoMCDataWeights_ST_tW==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_ST_tWXSDown:=(MCSF_Weight_" + ABCDversion + "*(1.0-0.053)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_tW==1)+(DoWeights*DoMCDataWeights_ST_tW==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",   
                    "" + ABCDversion + "_ST_tchanXSUp:=(MCSF_Weight_" + ABCDversion + "*(1.0+0.042)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_t==1)+(DoWeights*DoMCDataWeights_ST_t==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_ST_tchanXSDown:=(MCSF_Weight_" + ABCDversion + "*(1.0-0.036)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_t==1)+(DoWeights*DoMCDataWeights_ST_t==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",                    
                    "" + ABCDversion + "_ST_schanXSUp:=(MCSF_Weight_" + ABCDversion + "*(1.0+0.037)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_s==1)+(DoWeights*DoMCDataWeights_ST_s==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_ST_schanXSDown:=(MCSF_Weight_" + ABCDversion + "*(1.0-0.047)*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights_ST_s==1)+(DoWeights*DoMCDataWeights_ST_s==0)*MCSF_Weight_" + ABCDversion + "+(DoWeights*DoMCDataWeights==0)*triggered",     
                    ...
                    #"" + ABCDversion + "_MCSF_powheg_renfacUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR2p0_muF2p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][0])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][0])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_powheg_renfacDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR0p5_muF0p5"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][1])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_powheg_renUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR2p0_muF1p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][2])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][2])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_powheg_renDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR0p5_muF1p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][3])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][3])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_powheg_facUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR1p0_muF2p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][4])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][4])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_powheg_facDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR1p0_muF0p5"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][5])+"+(DoMCDataWeights_ST_tW==1)/"+str(murmufs_top[1][5])")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",    
                    ...
                    #"" + ABCDversion + "_MCSF_amc_renfacUp:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR2p0_muF2p0*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][0])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][0])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_amc_renfacDown:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR0p5_muF0p5*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][1])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_amc_renUp:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR2p0_muF1p0*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][2])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][2])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_amc_renDown:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR0p5_muF1p0*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][3])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][3])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_amc_facUp:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR1p0_muF2p0*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][4])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][4])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    #"" + ABCDversion + "_MCSF_amc_facDown:=(MCSF_Weight_" + ABCDversion + "*(1.0"+"*((DoMCDataWeights_ttbaronly==1)+(DoMCDataWeights_ST_tW==1))+Weight_scale_variation_muR1p0_muF0p5*("+"(DoMCDataWeights_ST_t==1)/"+str(murmufs_top[2][5])+"+(DoMCDataWeights_ST_s==1)/"+str(murmufs_top[3][5])+"))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",    
                                        
                    "" + ABCDversion + "_MCSF_powheg_renfac_envUp:=(MCSF_Weight_" + ABCDversion + "*MCSF_RenFac_envelopeUp*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_renfac_envDown:=(MCSF_Weight_" + ABCDversion + "*MCSF_RenFac_envelopeDown*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                                                            
                                        
                    "" + ABCDversion + "_MCSF_powheg_renfacUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR2p0_muF2p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][0])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)"+"+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_renfacDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR0p5_muF0p5"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][1])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_renUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR2p0_muF1p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][2])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_renDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR0p5_muF1p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][3])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_facUp:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR1p0_muF2p0"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][4])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",
                    "" + ABCDversion + "_MCSF_powheg_facDown:=(MCSF_Weight_" + ABCDversion + "*(Weight_scale_variation_muR1p0_muF0p5"+"*((DoMCDataWeights_ttbaronly==1)/"+str(murmufs_top[0][5])+")+1.0*("+"(DoMCDataWeights_ST_t==1)+(DoMCDataWeights_ST_s==1)+(DoMCDataWeights_ST_tW==1)))*((DoMCDataWeights_ttbaronly==1)/"+str(PDFs[0][1])+"+(DoMCDataWeights_ST_tW==1)/"+str(PDFs[1][1])+"+(DoMCDataWeights_ST_t==1)/"+str(PDFs[2][1])+"+(DoMCDataWeights_ST_s==1)/"+str(PDFs[3][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered",    
                    ...
                    "" + ABCDversion + "_MCSF_JetMassScaleUp:=(MCSF_Weight_" + ABCDversion + "_JetMassScaleUp"+"*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered", 
                    "" + ABCDversion + "_MCSF_JetMassScaleDown:=(MCSF_Weight_" + ABCDversion + "_JetMassScaleDown"+"*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered", 
                    "" + ABCDversion + "_MCSF_JetMassResUp:=(MCSF_Weight_" + ABCDversion + "_JetMassResUp"+"*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered", 
                    "" + ABCDversion + "_MCSF_JetMassResDown:=(MCSF_Weight_" + ABCDversion + "_JetMassResDown"+"*((murmuf1500==1)/"+str(PDFs[0][1])+"+(murmuf2000==1)/"+str(PDFs[1][1])+"+(murmuf2500==1)/"+str(PDFs[2][1])+"))*(DoWeights*DoMCDataWeights==1)+(DoWeights*DoMCDataWeights==0)*triggered", 
