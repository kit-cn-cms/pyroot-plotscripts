...
samples=[Sample('t#bar{t}H full',ROOT.kBlue,'/nfs/dust/cms/user/hmildner/fastsim/trees/tthbb_full.root','') , Sample('t#bar{t}H fast',ROOT.kGreen+1,'/nfs/dust/cms/user/hmildner/fastsim/trees/tthbb_fast.root',''),Sample('t#bar{t} full',ROOT.kRed+1,'/nfs/dust/cms/user/hmildner/fastsim/trees/ttbar.root','')]
...
plots=[
    ...
    Plot(ROOT.TH1F("BDToutput_6j2t_1","BDT output (6j2t)",20,-1,1),"BDTOhio_v1_output",s6j2t),
    Plot(ROOT.TH1F("BDToutput_4j3t_1","BDT output (4j3t)",20,-1,1),"BDTOhio_v1_output",s4j3t),
    Plot(ROOT.TH1F("BDToutput_5j3t_1","BDT output (5j3t)",20,-1,1),"BDTOhio_v1_output",s5j3t),
    Plot(ROOT.TH1F("BDToutput_6j3t_1","BDT output (6j3t)",20,-1,1),"BDTOhio_v1_output",s6j3t),
    Plot(ROOT.TH1F("BDToutput_4j4t_1","BDT output (4j4t)",20,-1,1),"BDTOhio_v1_output",s4j4t),
    Plot(ROOT.TH1F("BDToutput_5j4t_1","BDT output (5j4t)",20,-1,1),"BDTOhio_v1_output",s5j4t),
    Plot(ROOT.TH1F("BDToutput_6j4t_1","BDT output (6j4t)",20,-1,1),"BDTOhio_v1_output",s6j4t),
