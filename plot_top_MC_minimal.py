...
from plotconfig_top_MC_minimal import *
...
writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('ttbar'):SignalSampleNames.index('ST_s')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('ttbar'):SignalSampleNames.index('ST_s')+1],"","mus_top",True,False,False,"",False,False,False)

#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Zprime1500700_ttZ'):SignalSampleNames.index('Zprime25001500_ttZ')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Zprime1500700_ttZ'):SignalSampleNames.index('Zprime25001500_ttZ')+1],"","mus",True,False,False,"",False,False,False)

#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Zprime1500700_ttH'):SignalSampleNames.index('Zprime25001500_ttH')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Zprime1500700_ttH'):SignalSampleNames.index('Zprime25001500_ttH')+1],"","mus",True,False,False,"",False,False,False)
...
for l,plot in zip(listOfHistoListsSignal,plotnames):
    ...
    for h in l:
        ...
        #h.GetMean()
        #print plot,"   ttbar:",av1500/float(n1500),"  tW:",av2000/float(n2000),"  t-chan:",av2500/float(n2500),"  s-chan:",av2500/float(n2500)
    
#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime20001500_tWb')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime20001500_tWb')+1],"","mus",True,False,False,"",False,False,False)
#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime22501300_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime22501300_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1],"","mus",True,False,False,"",False,False,False)
##writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1],"","mus",True,False,False,"",False,False,False)
##writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1],"","mus",True,False,False,"",False,False,False)
##writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_tWb'):SignalSampleNames.index('Gprime25001800_tWb')+1],"","mus",True,False,False,"",False,False,False)

##writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_ttZ'):SignalSampleNames.index('Gprime40003000_ttZ')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_ttZ'):SignalSampleNames.index('Gprime40003000_ttZ')+1],"","mus",True,False,False,"",False,False,False)

#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime1500800_ttH'):SignalSampleNames.index('Gprime20001500_ttH')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime1500800_ttH'):SignalSampleNames.index('Gprime20001500_ttH')+1],"","mus",True,False,False,"",False,False,False)
#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime22501300_ttH'):SignalSampleNames.index('Gprime27501500_ttH')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime22501300_ttH'):SignalSampleNames.index('Gprime27501500_ttH')+1],"","mus",True,False,False,"",False,False,False)
#writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Gprime30001500_ttH'):SignalSampleNames.index('Gprime40003000_ttH')+1])[plotnames.index('Weight_scale_variation_muR0p5_muF0p5'):plotnames.index('Weight_LHA_NNPDF30_nlo_as_0118_down')+1],SignalSamples[SignalSampleNames.index('Gprime30001500_ttH'):SignalSampleNames.index('Gprime40003000_ttH')+1],"","mus",True,False,False,"",False,False,False)
