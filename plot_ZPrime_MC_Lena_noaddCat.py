...
plots=[
    ...
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag2_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
...
#Tprime
    ...
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
...
#ABCD2
    ...
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag2_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag2_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalnotopbtag" ,"1 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag2_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalwithtopbtag" ,"2 btag") ,
    ...
    Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" +"IsnoSignalinclusive" ,"1 btag"),

    Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag"),
    Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M",  plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" +"IsnoSignalinclusive" ,"1 btag") ,
