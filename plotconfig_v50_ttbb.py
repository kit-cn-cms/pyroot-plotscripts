...
systs_tt_and_ttH_weights=[
                    ...
                    "dummyWeight_CMS_ttH_NNPDFDown:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_LHA_306000_down*internalNormFactor_weight_LHA_306000_down*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
...
#print "limit samples"
samplesLimits=[
Sample('t#bar{t}+b',ROOT.kRed-2,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusB',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+b OpenLoops',ROOT.kRed-2,path_karim_new+"/TTbb_Powheg_Openloops_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==1)'+sel_MET,'ttbarPlusB_OL',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+b helac',ROOT.kRed-2,path_karim_new+"/TTbb_Powheg_Helac_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==1)'+sel_MET,'ttbarPlusB_helac',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+b amc',ROOT.kRed-2,path_karim_new+"/ttbb_4FS_ckm_NNPDF31_TuneCP5_amcatnlo_madspin_pythia_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==1)'+sel_MET,'ttbarPlusB_amc',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    
                    Sample('t#bar{t}+2b',ROOT.kRed+2,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,'ttbarPlus2B',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+2b OpenLoops',ROOT.kRed+2,path_karim_new+"/TTbb_Powheg_Openloops_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==2)'+sel_MET,'ttbarPlus2B_OL',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+2b helac',ROOT.kRed+2,path_karim_new+"/TTbb_Powheg_Helac_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==2)'+sel_MET,'ttbarPlus2B_helac',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    Sample('t#bar{t}+2b amc',ROOT.kRed+2,path_karim_new+"/ttbb_4FS_ckm_NNPDF31_TuneCP5_amcatnlo_madspin_pythia_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==2)'+sel_MET,'ttbarPlus2B_amc',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees),
                    
                    Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusBBbar',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees), 
                    Sample('t#bar{t}+b#bar{b} OpenLoops',ROOT.kRed+3,path_karim_new+"/TTbb_Powheg_Openloops_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==3)'+sel_MET,'ttbarPlusBBbar_OL',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees), 
                    Sample('t#bar{t}+b#bar{b} helac',ROOT.kRed+3,path_karim_new+"/TTbb_Powheg_Helac_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==3)'+sel_MET,'ttbarPlusBBbar_helac',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees), 
                    Sample('t#bar{t}+b#bar{b} amc',ROOT.kRed+3,path_karim_new+"/ttbb_4FS_ckm_NNPDF31_TuneCP5_amcatnlo_madspin_pythia_new_pmx/*nominal*root",mcWeightAll+'*(GenEvt_I_TTPlusBB==3)'+sel_MET,'ttbarPlusBBbar_amc',systsAllSamples,samDict=sampleDict, readTrees=doReadTrees), 
]
