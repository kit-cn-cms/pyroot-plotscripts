...
from plotconfig_Zprime_MC_kevin import *
...
plots=[
        ...
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Zprime_Pt" ,"p_{T}(Z') in GeV, anti-btag",50,0,1000),"Sideband_bottom_anti_Topfirst_Zprime_Pt",plotselection2+"&&Sideband_bottom_anti_Topfirst_Zprime_Pt>0","1 anti-btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tprime_M" ,"m(T') in GeV, anti-btag",50,0,5000),"Sideband_bottom_anti_Topfirst_Tprime_M",plotselection2+"&&Sideband_bottom_anti_Topfirst_Tprime_M>0","1 anti-btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tprime_Pt" ,"p_{T}(T') in GeV, anti-btag",50,0,1000),"Sideband_bottom_anti_Topfirst_Tprime_Pt",plotselection2+"&&Sideband_bottom_anti_Topfirst_Tprime_Pt>0","1 anti-btag"),        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tops_Pt" ,"p_{T}(t) in GeV",50,0,2000),"Sideband_bottom_anti_Topfirst_Tops_Pt",plotselection2+"&&Sideband_bottom_anti_Topfirst_Tops_Pt>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tops_Eta" ,"eta(t), anti-btag",60,-3,3),"Sideband_bottom_anti_Topfirst_Tops_Eta",plotselection2+"","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tops_MSD" ,"m_{SD}(t) in GeV, anti-btag",60,0,300),"Sideband_bottom_anti_Topfirst_Tops_MSD",plotselection2+"&&Sideband_bottom_anti_Topfirst_Zprime_M>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Tops_t32" ,"tau_{32}(t), anti-btag",20,0,1),"Sideband_bottom_anti_Topfirst_Tops_t32",plotselection2+"&&Sideband_bottom_anti_Topfirst_Zprime_M>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Ws_Pt" ,"p_{T}(W) in GeV, anti-btag",50,0,2000),"Sideband_bottom_anti_Topfirst_Ws_Pt",plotselection2+"&&Sideband_bottom_anti_Topfirst_Ws_Pt>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Ws_Eta" ,"eta(W), anti-btag",60,-3,3),"Sideband_bottom_anti_Topfirst_Ws_Eta",plotselection2+"","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Ws_MSD" ,"m_{SD}(W) in GeV, anti-btag",60,0,300),"Sideband_bottom_anti_Topfirst_Ws_MSD",plotselection2+"&&Sideband_bottom_anti_Topfirst_Zprime_M>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Ws_t21" ,"tau_{21}(W), anti-btag",20,0,1),"Sideband_bottom_anti_Topfirst_Ws_t21",plotselection2+"&&Sideband_bottom_anti_Topfirst_Zprime_M>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Bottoms_Pt" ,"p_{T}(b) in GeV, anti-btag",50,0,2000),"Sideband_bottom_anti_Topfirst_Bottoms_Pt",plotselection2+"&&Sideband_bottom_anti_Topfirst_Bottoms_Pt>0","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Bottoms_Eta" ,"eta(b), anti-btag",60,-3,3),"Sideband_bottom_anti_Topfirst_Bottoms_Eta",plotselection2+"","1 btag"),
        Plot(ROOT.TH1F("Sideband_bottom_anti_Topfirst_Bottoms_CSVv2" ,"CSVv2, anti-btag",40,-1,1),"Sideband_bottom_anti_Topfirst_Bottoms_CSVv2",plotselection2+"&&Sideband_bottom_anti_Topfirst_Bottoms_CSVv2>-1","1 btag"),
        ...
        #Plot(ROOT.TH2F("ABCD_top_tau32_vs_top_MSD" ,"tau_{32}(t) over m_{SD}(t)",20,0,1,30,0,300),"Tops_ABCD_MSD:Tops_ABCD_t32",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_tau32_vs_W_tau21" ,"tau_{32}(t) over tau_{21}(W)",20,0,1,20,0,1),"Tops_ABCD_t32","Ws_ABCD_t21",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_tau32_vs_W_MSD" ,"tau_{32}(t) over m_{SD}(W)",20,0,1,30,0,300),"Tops_ABCD_t32","Ws_ABCD_MSD",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_tau32_vs_Bottom_CSV_v2" ,"tau_{32}(t) over CSV_v2(b)",20,0,1,20,0,1),"Tops_ABCD_t32","Bottoms_ABCD_CSV",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_MSD_vs_W_tau21" ,"m_{SD}(t) over tau_{21}(W)",30,0,300,20,0,1),"Tops_ABCD_MSD","Ws_ABCD_t21",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_MSD_vs_W_MSD" ,"m_{SD}(t) over tau_{21}(W)",30,0,300,30,0,300),"Tops_ABCD_MSD","Ws_ABCD_MSD",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_top_MSD_vs_Bottom_CSV_v2" ,"m_{SD}(t) over CSV_v2(b)",30,0,300,20,0,1),"Tops_ABCD_MSD","Bottoms_ABCD_CSV",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_W_MSD_vs_W_tau21" ,"m_{SD}(W) over tau_{21}(W)",30,0,300,20,0,1),"Ws_ABCD_MSD","Ws_ABCD_t21",plotselection2+"","1 btag"),
        #Plot(ROOT.TH2F("ABCD_W_MSD_vs_Bottom_CSV_v2" ,"m_{SD}(W) over CSV_v2(b)",30,0,300,20,0,1),"Ws_ABCD_MSD","Bottoms_ABCD_CSV",plotselection2+"","1 btag"),

        Plot(ROOT.TH1F("N_packedPatJetsAK8PFCHSSoftDrop" ,"N_packedPatJetsAK8PFCHSSoftDrop",10,0,10),"N_packedPatJetsAK8PFCHSSoftDrop",plotselection1+"","1 btag"),
        Plot(ROOT.TH1F("packedPatJetsAK8PFCHSSoftDrop_1_Pt" ,"p_{T}(AK8_1) in GeV",50,0,1000),"packedPatJetsAK8PFCHSSoftDrop_Pt[0]",plotselection1+"&&packedPatJetsAK8PFCHSSoftDrop_Pt[0]>0","1 btag"),
        Plot(ROOT.TH1F("packedPatJetsAK8PFCHSSoftDrop_2_Pt" ,"p_{T}(AK8_2) in GeV",50,0,1000),"packedPatJetsAK8PFCHSSoftDrop_Pt[1]",plotselection1+"&&packedPatJetsAK8PFCHSSoftDrop_Pt[1]>0","1 btag"),
        Plot(ROOT.TH1F("packedPatJetsAK8PFCHSSoftDrop_3_Pt" ,"p_{T}(AK8_3) in GeV",50,0,1000),"packedPatJetsAK8PFCHSSoftDrop_Pt[2]",plotselection1+"&&packedPatJetsAK8PFCHSSoftDrop_Pt[2]>0","1 btag"),
        Plot(ROOT.TH1F("packedPatJetsAK8PFCHSSoftDrop_4_Pt" ,"p_{T}(AK8_4) in GeV",50,0,1000),"packedPatJetsAK8PFCHSSoftDrop_Pt[3]",plotselection1+"&&packedPatJetsAK8PFCHSSoftDrop_Pt[3]>0","1 btag"),

        Plot(ROOT.TH1F("N_Jets" ,"N_Jets",10,0,10),"N_Jets",plotselection1+"","1 btag"),
        Plot(ROOT.TH1F("Jet_1_Pt" ,"p_{T}(AK4_1) in GeV",50,0,1000),"Jet_Pt[0]",plotselection1+"&&Jet_Pt[0]>0","1 btag"),
        Plot(ROOT.TH1F("Jet_2_Pt" ,"p_{T}(AK4_2) in GeV",50,0,1000),"Jet_Pt[1]",plotselection1+"&&Jet_Pt[1]>0","1 btag"),
        ...
        Plot(ROOT.TH1F("t_tagrate","p_{T} in GeV, t-tagrate",50,0,2000),"tagged_top_pt",plotselection1+"&&tagged_top_pt>0","1 btag"),
        Plot(ROOT.TH1F("W_tagrate","p_{T} in GeV, W-tagrate",50,0,2000),"tagged_W_pt",plotselection1+"&&tagged_W_pt>0","1 btag"),
        Plot(ROOT.TH1F("b_tagrate","p_{T} in GeV, b-tagrate",50,0,2000),"tagged_bottom_pt",plotselection1+"&&tagged_bottom_pt>0","1 btag"),
        Plot(ROOT.TH1F("t_misstagrate","p_{T} in GeV, t-misstagrate",50,0,2000),"misstagged_top_pt",plotselection1+"&&misstagged_top_pt>0","1 btag"),
        Plot(ROOT.TH1F("W_misstagrate","p_{T} in GeV, W-misstagrate",50,0,2000),"misstagged_W_pt",plotselection1+"&&misstagged_W_pt>0","1 btag"),
        Plot(ROOT.TH1F("b_misstagrate","p_{T} in GeV, b-misstagrate",50,0,2000),"misstagged_bottom_pt",plotselection1+"&&misstagged_bottom_pt>0","1 btag"),
        Plot(ROOT.TH1F("tanti_tagrate","p_{T} in GeV, tanti-tagrate",50,0,2000),"tagged_top_anti_pt",plotselection1+"&&tagged_top_anti_pt>0","1 btag"),
        Plot(ROOT.TH1F("Wanti_tagrate","p_{T} in GeV, Wanti-tagrate",50,0,2000),"tagged_W_anti_pt",plotselection1+"&&tagged_W_anti_pt>0","1 btag"),
        Plot(ROOT.TH1F("banti_tagrate","p_{T} in GeV, banti-tagrate",50,0,2000),"tagged_bottom_anti_pt",plotselection1+"&&tagged_bottom_anti_pt>0","1 btag"),
        Plot(ROOT.TH1F("tanti_misstagrate","p_{T} in GeV, tanti-misstagrate",50,0,2000),"misstagged_top_anti_pt",plotselection1+"&&misstagged_top_anti_pt>0","1 btag"),
        Plot(ROOT.TH1F("Wanti_misstagrate","p_{T} in GeV, Wanti-misstagrate",50,0,2000),"misstagged_W_anti_pt",plotselection1+"&&misstagged_W_anti_pt>0","1 btag"),
        Plot(ROOT.TH1F("banti_misstagrate","p_{T} in GeV, banti-misstagrate",50,0,2000),"misstagged_bottom_anti_pt",plotselection1+"&&misstagged_bottom_anti_pt>0","1 btag"),
...
#plotnames=[
    #'Signal_Topfirst_Zprime_M','Signal_Topfirst_Zprime_Pt','Signal_Topfirst_Tprime_M','Signal_Topfirst_Tprime_Pt','Signal_Topfirst_Tops_Pt','Signal_Topfirst_Tops_Eta','Signal_Topfirst_Tops_MSD','Signal_Topfirst_Tops_t32','Signal_Topfirst_Ws_Pt','Signal_Topfirst_Ws_Eta','Signal_Topfirst_Ws_MSD','Signal_Topfirst_Ws_t21','Signal_Topfirst_Bottoms_Pt','Signal_Topfirst_Bottoms_Eta','Signal_Topfirst_Bottoms_CSVv2'
    
    #,'Sideband_bottom_anti_Topfirst_Zprime_M','Sideband_bottom_anti_Topfirst_Zprime_Pt','Sideband_bottom_anti_Topfirst_Tprime_M','Sideband_bottom_anti_Topfirst_Tprime_Pt','Sideband_bottom_anti_Topfirst_Tops_Pt','Sideband_bottom_anti_Topfirst_Tops_Eta','Sideband_bottom_anti_Topfirst_Tops_MSD','Sideband_bottom_anti_Topfirst_Tops_t32','Sideband_bottom_anti_Topfirst_Ws_Pt','Sideband_bottom_anti_Topfirst_Ws_Eta','Sideband_bottom_anti_Topfirst_Ws_MSD','Sideband_bottom_anti_Topfirst_Ws_t21','Sideband_bottom_anti_Topfirst_Bottoms_Pt','Sideband_bottom_anti_Topfirst_Bottoms_Eta','Sideband_bottom_anti_Topfirst_Bottoms_CSVv2'
    
    #,'Sideband_W_anti_Topfirst_Zprime_M','Sideband_W_anti_Topfirst_Zprime_Pt','Sideband_W_anti_Topfirst_Tprime_M','Sideband_W_anti_Topfirst_Tprime_Pt','Sideband_W_anti_Topfirst_Tops_Pt','Sideband_W_anti_Topfirst_Tops_Eta','Sideband_W_anti_Topfirst_Tops_MSD','Sideband_W_anti_Topfirst_Tops_t32','Sideband_W_anti_Topfirst_Ws_Pt','Sideband_W_anti_Topfirst_Ws_Eta','Sideband_W_anti_Topfirst_Ws_MSD','Sideband_W_anti_Topfirst_Ws_t21','Sideband_W_anti_Topfirst_Bottoms_Pt','Sideband_W_anti_Topfirst_Bottoms_Eta','Sideband_W_anti_Topfirst_Bottoms_CSVv2'
    
    #,'Sideband_top_anti_Topfirst_Zprime_M','Sideband_top_anti_Topfirst_Zprime_Pt','Sideband_top_anti_Topfirst_Tprime_M','Sideband_top_anti_Topfirst_Tprime_Pt','Sideband_top_anti_Topfirst_Tops_Pt','Sideband_top_anti_Topfirst_Tops_Eta','Sideband_top_anti_Topfirst_Tops_MSD','Sideband_top_anti_Topfirst_Tops_t32','Sideband_top_anti_Topfirst_Ws_Pt','Sideband_top_anti_Topfirst_Ws_Eta','Sideband_top_anti_Topfirst_Ws_MSD','Sideband_top_anti_Topfirst_Ws_t21','Sideband_top_anti_Topfirst_Bottoms_Pt','Sideband_top_anti_Topfirst_Bottoms_Eta','Sideband_top_anti_Topfirst_Bottoms_CSVv2'
    
    #,'SB_SF_bottom_anti_Zprime_M','SB_SF_bottom_anti_Tops_Pt','SB_SF_bottom_anti_Tops_MSD','SB_SF_bottom_anti_Tops_t32','SB_SF_bottom_anti_Ws_Pt','SB_SF_bottom_anti_Ws_MSD','SB_SF_bottom_anti_Ws_t21','SB_SF_bottom_anti_Bottoms_Pt'
    #,'SB_SF_W_anti_Zprime_M','SB_SF_W_anti_Tops_Pt','SB_SF_W_anti_Tops_MSD','SB_SF_W_anti_Tops_t32','SB_SF_W_anti_Ws_Pt','SB_SF_W_anti_Bottoms_Pt','SB_SF_W_anti_Bottoms_CSVv2'
    #,'SB_SF_top_anti_Zprime_M','SB_SF_top_anti_Tops_Pt','SB_SF_top_anti_Ws_Pt','SB_SF_top_anti_Ws_MSD','SB_SF_top_anti_Ws_t21','SB_SF_top_anti_Bottoms_Pt','SB_SF_top_anti_Bottoms_CSVv2'
...
##,'ABCD_top_tau32_vs_top_MSD'
    ...
    #,'t_tagrate','W_tagrate','b_tagrate','t_misstagrate','W_misstagrate','b_misstagrate','tanti_tagrate','Wanti_tagrate','banti_tagrate','tanti_misstagrate','Wanti_misstagrate','banti_misstagrate','AK8_top_tag_candidates_pt','AK8_W_tag_candidates_pt','AK4_bottom_tag_candidates_pt','AK8_top_misstagged_candidates_pt','AK8_W_misstagged_candidates_pt','AK4_bottom_misstagged_candidates_pt'
#]
...
print name,4000000,plots,SignalSamples+BackgroundSamples+DataSamples,[''],['1.']
#outputpath=plotParallel(name,4000000,plots,samples)
outputpath=plotParallel(name,4000000,plots,SignalSamples+BackgroundSamples+DataSamples)
