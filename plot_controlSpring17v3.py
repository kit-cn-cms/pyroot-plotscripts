...
plots43=[
    ...
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h1","BDT_common5_input_h1",30,0.0,0.15),"BDT_common5_input_h1",plotselection,plotlabel),
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h2","BDT_common5_input_h2",30,0.0,0.15),"BDT_common5_input_h2",plotselection,plotlabel),
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h3","BDT_common5_input_h3",30,0.0,0.15),"BDT_common5_input_h3",plotselection,plotlabel),
...
plots44=[
    ...
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h0","BDT_common5_input_h0",20,0.1,0.5),"BDT_common5_input_h0",plotselection,plotlabel),
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h1","BDT_common5_input_h1",20,0.0,0.15),"BDT_common5_input_h1",plotselection,plotlabel),
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h2","BDT_common5_input_h2",20,0.0,0.15),"BDT_common5_input_h2",plotselection,plotlabel),
    Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h3","BDT_common5_input_h3",20,0.0,0.15),"BDT_common5_input_h3",plotselection,plotlabel),
