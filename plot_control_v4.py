...
from plotconfig_v1 import *


def main(argv):

    # Create analysis object with output name
    name='controlplots_v4'
    ...
    plots=[
        ...
        Plot(ROOT.TH1F("N_Jets","Number of ak4 jets",11,3.5,14.5),"N_Jets",plotselection,plotlabel),
        ...
        Plot(ROOT.TH1F("N_AK8_Jets","Number of ak8 jets",10,0.5,10.5),"N_AK8Jets",plotselection,plotlabel),
        Plot(ROOT.TH1F("ptallak8jets","p_{T} of all ak8 jets",60,200,1000),"AK8Jet_Pt",plotselection,plotlabel),
    ...
    plotsAdditional=[
        ...
        Plot(ROOT.TH1F("N_PrimaryVertices","Reconstructed primary vertices",26,-.5,50.5),"N_PrimaryVertices",plotselection,plotlabel),
    ...
    if analysis.doDrawParallel==False or analysis.plotNumber == None :
        if not os.path.exists(analysis.rootFilePath):
            ...
            outputpath=plotParallel(name,5000000,discriminatorPlots,samples+samples_data+systsamples,[''],['1.'],weightSystNames,systWeights,additionalvariables,[],"/nfs/dust/cms/user/kelmorab/treeJsons/treejson_Summer18_15072018_v1.json",otherSystNames+PSSystNames+QCDSystNames,addCodeInterfacePaths=[],cirun=False)
