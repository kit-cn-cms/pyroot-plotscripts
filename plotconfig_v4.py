...
sel_singleel="(N_LooseMuons==0 && N_TightElectrons==1 && (Triggered_HLT_Ele35_WPTight_Gsf_vX==1 || Triggered_HLT_Ele28_eta2p1_WPTight_Gsf_HT150_vX))*(N_Jets>=4 && N_BTagsM>=2)" # need to veto muon events in electron dataset to avoid double countung
...
#mcTriggerWeight='(1.0)'
mcTriggerWeight='((1.0) * (1.0*(N_LooseMuons==0 && N_TightElectrons==1 && (Triggered_HLT_Ele35_WPTight_Gsf_vX==1 || Triggered_HLT_Ele28_eta2p1_WPTight_Gsf_HT150_vX)) +internalMuTriggerWeight*(N_LooseElectrons==0 && N_TightMuons==1 && (Triggered_HLT_IsoMu24_2p1_vX==1 || Triggered_HLT_IsoMu27_vX==1))))*(N_Jets>=4 && N_BTagsM>=2)'

#TODO Check that SFs and uncertainties are correct
sfs="Weight_ElectronSFID*Weight_MuonSFID*Weight_ElectronSFGFS*Weight_MuonSFIso"
...
systs_tt_all=[
  #"_CMS_ttHbb_FSRUp","_CMS_ttHbb_FSRDown","_CMS_ttHbb_ISRUp","_CMS_ttHbb_ISRDown","_CMS_ttHbb_HDAMPUp","_CMS_ttHbb_HDAMPDown","_CMS_ttHbb_UEUp","_CMS_ttHbb_UEDown"
  ]
...
systs_tt_lf=[
  #"_CMS_ttHbb_FSR_ttbarOtherUp","_CMS_ttHbb_FSR_ttbarOtherDown","_CMS_ttHbb_ISR_ttbarOtherUp","_CMS_ttHbb_ISR_ttbarOtherDown","_CMS_ttHbb_HDAMP_ttbarOtherUp","_CMS_ttHbb_HDAMP_ttbarOtherDown","_CMS_ttHbb_UE_ttbarOtherUp","_CMS_ttHbb_UE_ttbarOtherDown"
  ]
systs_tt_lf_weights=[
...
samplesControlPlots=[
                    Sample('t#bar{t}H',ROOT.kBlue+1,path_michael+'/ttH*/*nominal*.root',mcWeightAll+sel_MET+sel_StrangeMuWeights,'ttH',systsAllSamples,samDict=sampleDict) ,     
#                    Sample('t#bar{t}',ROOT.kRed+1,path_80x+'/ttbar/*nominal*.root',mcWeight,'ttbar',systsAllSamples) ,     
                    Sample('t#bar{t}+lf',ROOT.kRed-7,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)','ttbarOther',systsAllSamples+systsTtbar+systs_tt_lf,samDict=sampleDict),
                    Sample('t#bar{t}+c#bar{c}',ROOT.kRed+1,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusCC==1)','ttbarPlusCCbar',systsAllSamples+systsTtbar+systs_tt_cc,samDict=sampleDict),
                    Sample('t#bar{t}+b',ROOT.kRed-2,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==1)','ttbarPlusB',systsAllSamples+systsTtbar+systs_tt_b,samDict=sampleDict),
                    Sample('t#bar{t}+2b',ROOT.kRed+2,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==2)','ttbarPlus2B',systsAllSamples+systsTtbar+systs_tt_2b,samDict=sampleDict),
                    Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==3)','ttbarPlusBBbar',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict),  
...
#print "limit samples"
samplesLimits=[
                    Sample('t#bar{t}H',ROOT.kBlue+1,path_michael+'/ttH*/*nominal*.root',mcWeight+evenSel+sel_MET+sel_StrangeMuWeights,'ttH',systsAllSamples,samDict=sampleDict) ,     
