...
from plotconfig_v53_aux import *
...
def main(argv):
    ...
    discriminatorPlots=[
                Plot(ROOT.TH1D(discrname+"_ljets" ,"jet-process categories",len(categoriesJT),0.5,0.5+len(categoriesJT)),catstringJT,categoriesJTsel,"SL"),
]
    ...
    DNNplots.append(Plot(ROOT.TH1F(discrname+"_"+"N_Jets","N_Jets",11,3.5,14.5),"N_Jets","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    DNNplots.append(Plot(ROOT.TH1F(discrname+"_"+"N_BTagsM","N_BTagsM",4,1.5,5.5),"N_BTagsM","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    DNNplots.append(Plot(ROOT.TH1F(discrname+"_"+"total","Evt_HT_Jets",1,0,3000),"N_BTagsM","(N_Jets>=4&&N_BTagsM>=2)","1 lepton, #geq 4 jets, #geq 2 b-tags"))
    
    discriminatorPlots+=DNNplots
    
    binlabels=["ljets","N_Jets","N_BTagsM","total"]
