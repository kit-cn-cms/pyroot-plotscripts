...
plots=[
    ...
    #beta (tau21)
        ...
        Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
