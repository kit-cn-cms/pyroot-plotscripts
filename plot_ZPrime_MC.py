...
plots=[
    ...
    #beta (tau21)
        ...
        Plot(ROOT.TH1F("ABCD_notopbtag_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        
        Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),

        Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD_inclusive_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"2 btag"),

        Plot(ROOT.TH1F("ABCD_inclusive_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"2 btag") ,


        Plot(ROOT.TH1F("ABCD2_notopbtag_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),

        Plot(ROOT.TH1F("ABCD2_notopbtag_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag") ,

        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),

        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD2_inclusive_CatA_Zprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Zprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 +  " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Zprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Zprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),

        Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Zprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Zprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Zprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Zprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Zprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag") ,




        Plot(ROOT.TH1F("ABCD_notopbtag_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        
        Plot(ROOT.TH1F("ABCD_notopbtag_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_notopbtag_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD_withtopbtag_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),

        Plot(ROOT.TH1F("ABCD_withtopbtag_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD_withtopbtag_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && "  + plotselection_topsubjetCSVv2+ " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD_inclusive_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),

        Plot(ROOT.TH1F("ABCD_inclusive_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD_inclusive_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag") ,


        Plot(ROOT.TH1F("ABCD2_notopbtag_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),

        Plot(ROOT.TH1F("ABCD2_notopbtag_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_notopbtag_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalnotopbtag" ,"1 btag") ,

        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),

        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag"),
        Plot(ROOT.TH1F("ABCD2_withtopbtag_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_topsubjetCSVv2_anti+ " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalwithtopbtag" ,"2 btag") ,

        Plot(ROOT.TH1F("ABCD2_inclusive_CatA_Tprime_M" ,"m(Z') in GeV, CatA " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && "  + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatB_Tprime_M" ,"m(Z') in GeV, CatB " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 +  " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatC_Tprime_M" ,"m(Z') in GeV, CatC " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatD_Tprime_M" ,"m(Z') in GeV, CatD " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21 + "&&" + "IsnoSignalinclusive" ,"1 btag"),

        Plot(ROOT.TH1F("ABCD2_inclusive_CatE_Tprime_M" ,"m(Z') in GeV, CatE " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatF_Tprime_M" ,"m(Z') in GeV, CatF " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatG_Tprime_M" ,"m(Z') in GeV, CatG " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag"),
        Plot(ROOT.TH1F("ABCD2_inclusive_CatH_Tprime_M" ,"m(Z') in GeV, CatH " ,50,0,5000),"Tprimes_ABCD_M",    plotselection_ABCD_general_beta2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti + "&&" + "IsnoSignalinclusive" ,"1 btag") ,
...
#################with Syst notoptag #####################R
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','QCDMadgraph', 'fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','QCDMadgraph', 'fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','QCDPythia8', 'fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','QCDPythia8', 'fancy_ABCD_'+loose+'WP')
################with Syst withtopbtag ############################
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD','QCDMadgraph','fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD','QCDMadgraph', 'fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD','QCDPythia8', 'fancy_ABCD_'+loose+'WP')
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD','QCDPythia8', 'fancy_ABCD_'+loose+'WP')
################with Syst inclusive ############################
ABCDBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_inclusive_CatA', 'ABCD_inclusive_CatB', 'ABCD_inclusive_CatC', 'ABCD_inclusive_CatD','QCDMadgraph','fancy_ABCD_'+loose+'WP')
...
#################with Syst notoptag #####################R
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','ABCD_notopbtag_CatE', 'ABCD_notopbtag_CatF', 'ABCD_notopbtag_CatG', 'ABCD_notopbtag_CatH','QCDMadgraph', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','ABCD_notopbtag_CatE', 'ABCD_notopbtag_CatF', 'ABCD_notopbtag_CatG', 'ABCD_notopbtag_CatH','QCDMadgraph', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','ABCD_notopbtag_CatE', 'ABCD_notopbtag_CatF', 'ABCD_notopbtag_CatG', 'ABCD_notopbtag_CatH','QCDPythia8', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_notopbtag_CatA', 'ABCD_notopbtag_CatB', 'ABCD_notopbtag_CatC', 'ABCD_notopbtag_CatD','ABCD_notopbtag_CatE', 'ABCD_notopbtag_CatF', 'ABCD_notopbtag_CatG', 'ABCD_notopbtag_CatH','QCDPythia8', 'fancy_ABCDcorrE')
################with Syst withtopbtag ############################
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD', 'ABCD_withtopbtag_CatE', 'ABCD_withtopbtag_CatF', 'ABCD_withtopbtag_CatG', 'ABCD_withtopbtag_CatH','QCDMadgraph','fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD', 'ABCD_withtopbtag_CatE', 'ABCD_withtopbtag_CatF', 'ABCD_withtopbtag_CatG', 'ABCD_withtopbtag_CatH','QCDMadgraph', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD', 'ABCD_withtopbtag_CatE', 'ABCD_withtopbtag_CatF', 'ABCD_withtopbtag_CatG', 'ABCD_withtopbtag_CatH','QCDPythia8', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_withtopbtag_CatA', 'ABCD_withtopbtag_CatB', 'ABCD_withtopbtag_CatC', 'ABCD_withtopbtag_CatD', 'ABCD_withtopbtag_CatE', 'ABCD_withtopbtag_CatF', 'ABCD_withtopbtag_CatG', 'ABCD_withtopbtag_CatH','QCDPythia8', 'fancy_ABCDcorrE')
################with Syst inclusive ############################
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_inclusive_CatA', 'ABCD_inclusive_CatB', 'ABCD_inclusive_CatC', 'ABCD_inclusive_CatD', 'ABCD_inclusive_CatE', 'ABCD_inclusive_CatF', 'ABCD_inclusive_CatG', 'ABCD_inclusive_CatH','QCDMadgraph','fancy_ABCDcorrE')
...
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD_inclusive_CatA', 'ABCD_inclusive_CatB', 'ABCD_inclusive_CatC', 'ABCD_inclusive_CatD', 'ABCD_inclusive_CatE', 'ABCD_inclusive_CatF', 'ABCD_inclusive_CatG', 'ABCD_inclusive_CatH','QCDPythia8', 'fancy_ABCDcorrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD_inclusive_CatA', 'ABCD_inclusive_CatB', 'ABCD_inclusive_CatC', 'ABCD_inclusive_CatD', 'ABCD_inclusive_CatE', 'ABCD_inclusive_CatF', 'ABCD_inclusive_CatG', 'ABCD_inclusive_CatH','QCDPythia8', 'fancy_ABCDcorrE')
...
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD2_notopbtag_CatA', 'ABCD2_notopbtag_CatB', 'ABCD2_notopbtag_CatC', 'ABCD2_notopbtag_CatD','ABCD2_notopbtag_CatE', 'ABCD2_notopbtag_CatF', 'ABCD2_notopbtag_CatG', 'ABCD2_notopbtag_CatH','QCDPythia8', 'fancy_ABCD2corrE')
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'BKG_Zprime25001200_1pb','SC_Zprime25001200_1pb','Zprime25001200','ABCD2_notopbtag_CatA', 'ABCD2_notopbtag_CatB', 'ABCD2_notopbtag_CatC', 'ABCD2_notopbtag_CatD','ABCD2_notopbtag_CatE', 'ABCD2_notopbtag_CatF', 'ABCD2_notopbtag_CatG', 'ABCD2_notopbtag_CatH','QCDPythia8', 'fancy_ABCD2corrE')
################with Syst withtopbtag ############################
ABCDcorrEBackgroundEstimationCalculationAndPlotsWithSystematics(listOfHistoListsDataMadgraph,lllData_Madgraph,listOfHistoListsBackground,lllBackground,lllBackgroundnosyst,listOfHistoListsSignal,BackgroundSamples,SignalSamples,DataSampleNames,BackgroundSampleNames, SignalSampleNames, plotnames,allweightsystnames,'DATA_BKG','SC_none','Zprime25001200','ABCD2_withtopbtag_CatA', 'ABCD2_withtopbtag_CatB', 'ABCD2_withtopbtag_CatC', 'ABCD2_withtopbtag_CatD', 'ABCD2_withtopbtag_CatE', 'ABCD2_withtopbtag_CatF', 'ABCD2_withtopbtag_CatG', 'ABCD2_withtopbtag_CatH','QCDMadgraph','fancy_ABCD2corrE')
