...
name='Zprime_BKG_'+ABCDeventhandling+'_'+ABCDversion+radi+'_'+WPs
...
##############ABCD JetmassScaleUp###########################
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatA_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatA " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatA_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleUp, "1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatB_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV" ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatB_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatC_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatC " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatC_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatD_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatD " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatD_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"1 btag"),

    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatE_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatE " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatE_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatF_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatF " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatF_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatG_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatG " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatG_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3  + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatH_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatH " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatH_notopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"1 btag") ,

    ##withtopsubbtag
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatA_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatA " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatA_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleUp, "2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatB_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV" ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatB_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatC_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatC " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatC_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatD_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatD " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatD_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleUp  ,"2 btag"),

    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatE_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatE " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatE_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatF_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatF " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatF_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatG_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatG " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatG_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3  + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatH_Zprime_M_JetmassScaleUp" ,"m(Z') in GeV, CatH " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatH_withtopbtag" + " && " + generalselection_JetMassScaleUp + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleUp  ,"2 btag") ,
    
    
##############ABCD JetmassScaleDown###########################
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatA_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatA " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatA_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleDown, "1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatB_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV" ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatB_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatC_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatC " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatC_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatD_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatD " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatD_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"1 btag"),

    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatE_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatE " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatE_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatF_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatF " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatF_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatG_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatG " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatG_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3  + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"1 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_notopbtag_CatH_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatH " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatH_notopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2_anti + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"1 btag") ,

    ##withtopsubbtag
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatA_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatA " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatA_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleDown, "2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatB_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV" ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatB_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatC_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatC " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatC_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatD_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatD " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatD_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_JetMassScaleDown  ,"2 btag"),

    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatE_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatE " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatE_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3 + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatF_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatF " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatF_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2 + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatG_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatG " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatG_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3  + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"2 btag"),
    #Plot(ROOT.TH1F( ABCDversion + "_withtopbtag_CatH_Zprime_M_JetmassScaleDown" ,"m(Z') in GeV, CatH " ,80,1000,5000),"Zprimes_ABCD"+radi+"_M", "ABCD_CatID==ABCD_CatH_withtopbtag" + " && " + generalselection_JetMassScaleDown + " && " + plotselection_topsubjetCSVv2 + " && " + cut3_anti + "&&" + cut2_anti + "&& " + plotselection_W_MSD_anti_JetMassScaleDown  ,"2 btag") ,
...
#############ABCD JetmassResDown###########################
    ...
    #Plot(ROOT.TH1F( "asda" ,"asda" ,17000000,0,17000000),"asda", "asda>0", "1 btag"),
...
OnlyFirstList[plotnames.index(ABCDversion + "_notopbtag_CatA_Zprime_M"):plotnames.index(ABCDversion + "_withtopbtag_CatH_Zprime_M_JetmassResDown") +1 ] = len(OnlyFirstList[plotnames.index(ABCDversion + "_notopbtag_CatA_Zprime_M"):plotnames.index(ABCDversion + "_withtopbtag_CatH_Zprime_M_JetmassResDown") + 1 ] ) * [True]
...
outputpath=plotParallel(name,2000000,plots,BackgroundSamples+systsamples,[""],["1"],allweightsystnames,allsystweights,additionalvariables,additionalfunctions,additionalobjectsfromaddtionalrootfile,OnlyFirstList,otherSystNames)
