...
#                    Sample('t#bar{t}',ROOT.kRed+1,path_80x+'/ttbar/*nominal*.root',mcWeight,'ttbar',systsAllSamples) ,     
                    ...
                    #Sample('t#bar{t}+b#bar{b} sherpa',ROOT.kRed+7,ttbarSherpaPath,mcWeightAll+specialSherpaWeightWithGenValue+'*(GenEvt_I_TTPlusBB==3)'+sel_MET,'ttbarPlusBBbarSherpa',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict),
...
#                    Sample('t#bar{t}',ROOT.kRed+1,path_80x+'/ttbar/*nominal*.root',mcWeight+evenSel,'ttbar',samDict=sampleDict) ,     
                    ...
                    #Sample('t#bar{t}+b#bar{b} ngw',ROOT.kRed+3,ttbarSherpaPath,mcWeightAll+specialSherpaWeight+'*(GenEvt_I_TTPlusBB==3)'+sel_MET,'ttbarPlusBBbarNoGenWeight',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict), 
