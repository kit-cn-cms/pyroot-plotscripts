...
#loosenedselection=True
loosenedselection=False
...
#WPs='tWP'+topWP+'tSJWP'+topSJWP+'WWP'+WWP+'bWP'+bottomWP+'HTcut'+str(HTcut)
...
if old:
    ...
    if loosenedselection:
        plotselection1="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"+*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M) && Ws_ABCD"+radi+"_Pt>150 && Tops_ABCD"+radi+"_Pt>150 && Bottoms_ABCD" + radi + "_Pt>75"
        plotselection1_i="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[i]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[i]) && Ws_ABCD"+radi+"_Pt[i]>150 && Tops_ABCD"+radi+"_Pt[i]>150 && Bottoms_ABCD" + radi + "_Pt[i]>75"
        plotselection1_0="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[0]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[0]) && Ws_ABCD"+radi+"_Pt[0]>150 && Tops_ABCD"+radi+"_Pt[0]>150 && Bottoms_ABCD" + radi + "_Pt[0]>75"        
    else:
        plotselection1="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M) && Ws_ABCD"+radi+"_Pt>200 && Tops_ABCD"+radi+"_Pt>400 && Bottoms_ABCD" + radi + "_Pt>100"
        plotselection1_i="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[i]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[i]) && Ws_ABCD"+radi+"_Pt[i]>200 && Tops_ABCD"+radi+"_Pt[i]>400 && Bottoms_ABCD" + radi + "_Pt[i]>100"
        plotselection1_0="Evt_HT_Jets>1000 && Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[0]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[0]) && Ws_ABCD"+radi+"_Pt[0]>200 && Tops_ABCD"+radi+"_Pt[0]>400 && Bottoms_ABCD" + radi + "_Pt[0]>100"

        #plotselection1="Evt_HT_Jets>1000 && Ws_ABCD"+radi+"_Pt>200 && Tops_ABCD"+radi+"_Pt>400 && Bottoms_ABCD" + radi + "_Pt>100"
    #plotselection1_i="Evt_HT_Jets>1000 && Ws_ABCD"+radi+"_Pt[i]>200 && Tops_ABCD"+radi+"_Pt[i]>400 && Bottoms_ABCD" + radi + "_Pt[i]>100"
    #plotselection1_0="Evt_HT_Jets>1000 && Ws_ABCD"+radi+"_Pt[0]>200 && Tops_ABCD"+radi+"_Pt[0]>400 && Bottoms_ABCD" + radi + "_Pt[0]>100"    
    #plotselection_EvtHT="Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M)"
    #plotselection_EvtHT_i="Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[i]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[i])"
    #plotselection_EvtHT_0="Evt_HT_Jets>("+str(1-HTcut)+"*Zprimes_ABCD" +  radi + "_M[0]) && Evt_HT_Jets<("+str(1+HTcut)+"*Zprimes_ABCD" +  radi + "_M[0])"
    if PVgecut:
...
if not MSDgap:
	...
	plotselection2=plotselection1 + " && (40 < Ws_ABCD"+radi+"_MSD * Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD * Ws_ABCD"+radi+"_corrL2L3 < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 500)  && Ws_ABCD"+radi+"_t21 <0.75"
        plotselection2_i=plotselection1_i + " && (40 < Ws_ABCD"+radi+"_MSD[i] * Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i] * Ws_ABCD"+radi+"_corrL2L3[i] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[i]  &&   Tops_ABCD"+radi+"_MSD[i] < 500)  && Ws_ABCD"+radi+"_t21[i] <0.75"
        plotselection2_0=plotselection1_0 + " && (40 < Ws_ABCD"+radi+"_MSD[0] * Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0] * Ws_ABCD"+radi+"_corrL2L3[0] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[0]  &&   Tops_ABCD"+radi+"_MSD[0] < 500)  && Ws_ABCD"+radi+"_t21[0] <0.75"
