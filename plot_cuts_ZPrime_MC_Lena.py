...
if not MSDgap:
	...
	plotselection2=plotselection1 + " && (40 < Ws_ABCD"+radi+"_MSD * Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD * Ws_ABCD"+radi+"_corrL2L3 < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD * Tops_ABCD"+radi+"_corrL2L3 &&   Tops_ABCD"+radi+"_MSD * Tops_ABCD"+radi+"_corrL2L3< 500) "
        plotselection2_i=plotselection1_i + " && (40 < Ws_ABCD"+radi+"_MSD[i] * Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i] * Ws_ABCD"+radi+"_corrL2L3[i] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[i] * Tops_ABCD"+radi+"_corrL2L3[i]  &&   Tops_ABCD"+radi+"_MSD[i] * Tops_ABCD"+radi+"_corrL2L3[i] < 1000) "
        plotselection2_0=plotselection1_0 + " && (40 < Ws_ABCD"+radi+"_MSD[0] * Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0] * Ws_ABCD"+radi+"_corrL2L3[0] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[0] * Tops_ABCD"+radi+"_corrL2L3[0]  &&   Tops_ABCD"+radi+"_MSD[0] * Tops_ABCD"+radi+"_corrL2L3[0] < 1000) "
...
if not toponsided:
    ...
    plotselection_t_MSD_anti = " (60 > Tops_ABCD"+radi+"_MSD * Tops_ABCD"+radi+"_corrL2L3|| Tops_ABCD"+radi+"_MSD * Tops_ABCD"+radi+"_corrL2L3> 210) "
    plotselection_t_MSD_anti_i = " (60 > Tops_ABCD"+radi+"_MSD[i] * Tops_ABCD"+radi+"_corrL2L3[i] || Tops_ABCD"+radi+"_MSD[i] * Tops_ABCD"+radi+"_corrL2L3[i] > 210) "
    plotselection_t_MSD_anti_0 = " (60 > Tops_ABCD"+radi+"_MSD[0] * Tops_ABCD"+radi+"_corrL2L3[0] || Tops_ABCD"+radi+"_MSD[0] * Tops_ABCD"+radi+"_corrL2L3[0] > 210) "
...
plotselection_ABCD_general_beta5 =  plotselection2 +  "  &&  " + " Ws_ABCD"+radi+"_Pt>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M>1000 " + "  &&  " + plotselection_t_MSD + " && " + plotselection_tau32 + "  &&  " + plotselection_TprimeMass 
plotselection_ABCD_general_beta5_0 =  plotselection2_0 +  "  &&  " + " Ws_ABCD"+radi+"_Pt[0]>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M[0]>1000 " + "  &&  "+ plotselection_t_MSD_0 + " && " + plotselection_tau32_0 + "  &&  " + plotselection_TprimeMass_0 
plotselection_ABCD_general_beta5_i =  plotselection2_i +  "  &&  " + " Ws_ABCD"+radi+"_Pt[i]>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M[i]>1000 " + "  &&  " + plotselection_t_MSD_i + " && " + plotselection_tau32_i + "  &&  " + plotselection_TprimeMass_i 
...
plotselection_ABCD_general_beta10 =  plotselection2 +  "  &&  " + " Ws_ABCD"+radi+"_Pt>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M>1000 " + "  &&  " + plotselection_W_MSD + " && " + plotselection_tau32 + "  &&  " + plotselection_t_MSD 
plotselection_ABCD_general_beta10_0 =  plotselection2_0 +  "  &&  " + " Ws_ABCD"+radi+"_Pt[0]>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M[0]>1000 " + "  &&  "+ plotselection_W_MSD_0 + " && " + plotselection_tau32_0 + "  &&  " + plotselection_t_MSD_0 
plotselection_ABCD_general_beta10_i =  plotselection2_i +  "  &&  " + " Ws_ABCD"+radi+"_Pt[i]>200" + "  &&  "+ " Zprimes_ABCD"+radi+"_M[i]>1000 " + "  &&  " + plotselection_W_MSD_i + " && " + plotselection_tau32_i + "  &&  " + plotselection_t_MSD_i 
