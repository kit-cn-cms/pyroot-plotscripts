...
for b,bl,nb,minx,maxx in zip(bins,binlabels,nhistobins,minxvals,maxxvals):
    bdts.append(MVAPlot(ROOT.TH1F("BDT_ljets"+"_"+bl,"BDT_ljets"+" ("+bl+")",nb,minx,maxx),"/nfs/dust/cms/user/kelmorab/limitstudies0111/pyroot-plotscripts/weights/weights_Final_64_64_common5OptMem.xml",b))
