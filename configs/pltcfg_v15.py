...
systs_tt_all_weights=[
                    ...
                    "dummyWeight_CMS_ttH_ttbar_NNPDFUp:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_scale_variation_muR_2p0_muF_1p0*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    "dummyWeight_CMS_ttH_ttbar_NNPDFDown:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_scale_variation_muR_0p5_muF_1p0*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    
                    "dummyWeight_CMS_ttH_ttbar_NNPDFUp:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_scale_variation_muR_1p0_muF_2p0*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    "dummyWeight_CMS_ttH_ttbar_NNPDFDown:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*Weight_scale_variation_muR_1p0_muF_0p5*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    
                    "dummyWeight_CMS_ttH_ttbar_NNPDFUp:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*GenWeight_6*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    "dummyWeight_CMS_ttH_ttbar_NNPDFDown:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*GenWeight_8*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    
                    "dummyWeight_CMS_ttH_ttbar_NNPDFUp:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*GenWeight_7*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
                    "dummyWeight_CMS_ttH_ttbar_NNPDFDown:="+usualWeights+"*"+mcTriggerWeight+"*internalCSVweight*GenWeight_9*1.0*(DoWeights==1)+(DoWeights==0)*1.0",
...
systs_tt_b=[
  #"_CMS_ttHbb_FSR_ttbarPlusBUp","_CMS_ttHbb_FSR_ttbarPlusBDown","_CMS_ttHbb_ISR_ttbarPlusBUp","_CMS_ttHbb_ISR_ttbarPlusBDown","_CMS_ttHbb_HDAMP_ttbarPlusBUp","_CMS_ttHbb_HDAMP_ttbarPlusBDown","_CMS_ttHbb_UE_ttbarPlusBUp","_CMS_ttHbb_UE_ttbarPlusBDown"
  ]
systs_tt_b_weights=[
...
systs_tt_2b=[
  #"_CMS_ttHbb_FSR_ttbarPlus2BUp","_CMS_ttHbb_FSR_ttbarPlus2BDown","_CMS_ttHbb_ISR_ttbarPlus2BUp","_CMS_ttHbb_ISR_ttbarPlus2BDown","_CMS_ttHbb_HDAMP_ttbarPlus2BUp","_CMS_ttHbb_HDAMP_ttbarPlus2BDown","_CMS_ttHbb_UE_ttbarPlus2BUp","_CMS_ttHbb_UE_ttbarPlus2BDown"
  ]
systs_tt_2b_weights=[
...
systs_tt_bb=[
  #"_CMS_ttHbb_FSR_ttbarPlusBBbarUp","_CMS_ttHbb_FSR_ttbarPlusBBbarDown","_CMS_ttHbb_ISR_ttbarPlusBBbarUp","_CMS_ttHbb_ISR_ttbarPlusBBbarDown","_CMS_ttHbb_HDAMP_ttbarPlusBBbarUp","_CMS_ttHbb_HDAMP_ttbarPlusBBbarDown","_CMS_ttHbb_UE_ttbarPlusBBbarUp","_CMS_ttHbb_UE_ttbarPlusBBbarDown"
  ]
systs_tt_bb_weights=[
...
systs_tt_cc=[
  #"_CMS_ttHbb_FSR_ttbarPlusCCbarUp","_CMS_ttHbb_FSR_ttbarPlusCCbarDown","_CMS_ttHbb_ISR_ttbarPlusCCbarUp","_CMS_ttHbb_ISR_ttbarPlusCCbarDown","_CMS_ttHbb_HDAMP_ttbarPlusCCbarUp","_CMS_ttHbb_HDAMP_ttbarPlusCCbarDown","_CMS_ttHbb_UE_ttbarPlusCCbarUp","_CMS_ttHbb_UE_ttbarPlusCCbarDown"
  ]
systs_tt_cc_weights=[
...
print("$"*10)
print("systWeights:\n")
for w in systWeights:
    print w
print("$"*10)
print("systWeightNames:\n")
for w in weightSystNames:
    print w
print("$"*10)
...
VJetsPathS=path_karim+'/DYJets*/*nominal*.root'+';'+'/WJets*/*nominal*.root'
ttVPathS=path_karim+'/TTW*/*nominal*.root'+';'+'/TTZ*/*nominal*.root'
dibosonPathS=path_karim+'/WW_*/*nominal*.root'+';'+'/WZ_*/*nominal*.root'+';'+'/ZZ_*/*nominal*.root'
...
samplesControlPlots=[
                    ...
                    plotClasses.Sample('t#bar{t}+lf',ROOT.kRed-7,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)*Weight_pu69p2','ttbarOther',systsAllSamples+systsTtbar+systs_tt_lf,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kRed+1,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusCC==1)*Weight_pu69p2','ttbarPlusCCbar',systsAllSamples+systsTtbar+systs_tt_cc,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+b',ROOT.kRed-2,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==1)*Weight_pu69p2','ttbarPlusB',systsAllSamples+systsTtbar+systs_tt_b,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+2b',ROOT.kRed+2,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==2)*Weight_pu69p2','ttbarPlus2B',systsAllSamples+systsTtbar+systs_tt_2b,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,ttbarPathS,mcWeightAll+sel_MET+sel_StrangeMuWeights+'*(GenEvt_I_TTPlusBB==3)*Weight_pu69p2','ttbarPlusBBbar',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict),  
                    ...
                    plotClasses.Sample('V+jets',ROOT.kGreen-3,VJetsPathS,mcWeightAll+sel_MET,'Vjets',systsAllSamples,samDict=sampleDict) , 
                    plotClasses.Sample('t#bar{t}+V',ROOT.kBlue-10,ttVPathS,mcWeightAll+sel_MET,'ttV',systsAllSamples,samDict=sampleDict),         
                    plotClasses.Sample('Diboson',ROOT.kAzure+2,dibosonPathS,mcWeightAll+sel_MET,'diboson',systsAllSamples,samDict=sampleDict) , 
...
samplesLimits=[
                    ...
                    plotClasses.Sample('t#bar{t}H, H to b#bar{b}',ROOT.kBlue+1,path_karim+'/ttHTobb/*nominal*.root','1.0*'+mcWeight+evenSel+sel_MET+sel_StrangeMuWeights,'ttH_hbb',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to c#bar{c}',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hccSel+sel_MET+sel_StrangeMuWeights,'ttH_hcc',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #tau#tau',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+httSel+sel_MET+sel_StrangeMuWeights,'ttH_htt',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #gamma#gamma',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hggSel+sel_MET+sel_StrangeMuWeights,'ttH_hgg',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to gluglu',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hglugluSel+sel_MET+sel_StrangeMuWeights,'ttH_hgluglu',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to WW',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hwwSel+sel_MET+sel_StrangeMuWeights,'ttH_hww',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to ZZ',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hzzSel+sel_MET+sel_StrangeMuWeights,'ttH_hzz',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #gamma Z',ROOT.kBlue+1,path_karim+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hzgSel+sel_MET+sel_StrangeMuWeights,'ttH_hzg',systsAllSamples,samDict=sampleDict) ,
                    
                    plotClasses.Sample('t#bar{t}+lf',ROOT.kRed-7,ttbarPathS,mcWeight+evenSel+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+sel_StrangeMuWeights,'ttbarOther',systsAllSamples+systsTtbar+systs_tt_lf,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kRed+1,ttbarPathS,mcWeight+evenSel+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusCCbar',systsAllSamples+systsTtbar+systs_tt_cc,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+b',ROOT.kRed-2,ttbarPathS,mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusB',systsAllSamples+systsTtbar+systs_tt_b,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+2b',ROOT.kRed+2,ttbarPathS,mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,'ttbarPlus2B',systsAllSamples+systsTtbar+systs_tt_2b,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,ttbarPathS,mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusBBbar',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict), 
                    ...
                    plotClasses.Sample('Z+jets',ROOT.kGreen-3,path_karim+'/DYJets*/*nominal*.root',mcWeightAll+sel_MET,'zjets',systsAllSamples,samDict=sampleDict) , 
