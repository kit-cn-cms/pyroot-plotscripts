...
def plots_ge4j_ge3t(data=None):
    ...
    plots = [
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Electron_Pt","p_{T}(electron)",50,0,500),"Electron_Pt",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_N_BTagsM","N_BTagsM",5,1.5,6.5),"N_BTagsM",selection,label),
    ...
    plots_tHW=[
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_top_eta","Reco_JABDT_tHW_abs_top_eta",40,0.0,4.0),"Reco_JABDT_tHW_abs_top_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whad_phi","Reco_tHW_whad_phi",34,-3.14,3.14),"Reco_tHW_whad_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_h_pt","Reco_JABDT_tHW_log_h_pt",37,0.0,7.4),"Reco_JABDT_tHW_log_h_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_btop_eta","Reco_JABDT_tHW_abs_btop_eta",25,0.0,2.5),"Reco_JABDT_tHW_abs_btop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_h_m","Reco_JABDT_tHW_log_h_m",22,3.0,7.2),"Reco_JABDT_tHW_log_h_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_whad_pt","Reco_JABDT_tHW_log_whad_pt",36,0.0,7.2),"Reco_JABDT_tHW_log_whad_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_idx2","Reco_tHW_whaddau_idx2",15,0,15),"Reco_tHW_whaddau_idx2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_idx1","Reco_tHW_whaddau_idx1",15,0,15),"Reco_tHW_whaddau_idx1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wb_h_dr","Reco_tHW_wb_h_dr",45,0,4.5),"Reco_tHW_wb_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_phi","Reco_tHW_btop_phi",34,-3.14,3.14),"Reco_tHW_btop_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_h_eta","Reco_tHW_h_eta",40,-4.0,4.0),"Reco_tHW_h_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wtop_eta","Reco_tHW_wtop_eta",42,-4.2,4.2),"Reco_tHW_wtop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wb_pt","Reco_tHW_wb_pt",55,0,550),"Reco_tHW_wb_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_eta1","Reco_tHW_whaddau_eta1",40,-4.0,4.0),"Reco_tHW_whaddau_eta1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_eta2","Reco_tHW_whaddau_eta2",40,-4.0,4.0),"Reco_tHW_whaddau_eta2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_top_h_dr","Reco_tHW_top_h_dr",50,0,5),"Reco_tHW_top_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whad_pt","Reco_tHW_whad_pt",45,0,450),"Reco_tHW_whad_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_eta1","Reco_tHW_hdau_eta1",50,-2.5,2.5),"Reco_tHW_hdau_eta1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_eta","Reco_tHW_btop_eta",50,-2.5,2.5),"Reco_tHW_btop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_m","Reco_tHW_btop_m",45,0,90),"Reco_tHW_btop_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_eta2","Reco_tHW_hdau_eta2",50,-2.5,2.5),"Reco_tHW_hdau_eta2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_h_pt","Reco_tHW_h_pt",75,0,750),"Reco_tHW_h_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_whad_m","Reco_JABDT_tHW_log_whad_m",25,3.0,8),"Reco_JABDT_tHW_log_whad_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_top_eta__M__wb_eta","Reco_JABDT_tHW_abs_top_eta__M__wb_eta",55,0.0,5.5),"Reco_JABDT_tHW_abs_top_eta__M__wb_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wtop_pt","Reco_tHW_wtop_pt",45,0,450),"Reco_tHW_wtop_pt",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_pt1","Reco_tHW_hdau_pt1",35,0,350),"Reco_tHW_hdau_pt1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_pt2","Reco_tHW_hdau_pt2",35,0,350),"Reco_tHW_hdau_pt2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_top_eta__M__higg_eta","Reco_JABDT_tHW_abs_top_eta__M__higg_eta",55,0.0,5.5),"Reco_JABDT_tHW_abs_top_eta__M__higg_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_idx","Reco_tHW_btop_idx",15,0,15),"Reco_tHW_btop_idx",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_m2","Reco_tHW_hdau_m2",45,0,90),"Reco_tHW_hdau_m2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_h_phi","Reco_tHW_h_phi",34,-3.14,3.14),"Reco_tHW_h_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wb_m","Reco_tHW_wb_m",35,0,350),"Reco_tHW_wb_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_top_pt__P__h_pt__P__wb_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt","Reco_JABDT_tHW_top_pt__P__h_pt__P__wb_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt",50,0,1),"Reco_JABDT_tHW_top_pt__P__h_pt__P__wb_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wtop_m","Reco_tHW_wtop_m",40,0,400),"Reco_tHW_wtop_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wtop_h_dr","Reco_tHW_wtop_h_dr",50,0,5.0),"Reco_tHW_wtop_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_top_m","Reco_JABDT_tHW_log_top_m",35,4.0,7.5),"Reco_JABDT_tHW_log_top_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_wlep_eta__M__whad_eta","Reco_JABDT_tHW_abs_wlep_eta__M__whad_eta",55,0.0,5.5),"Reco_JABDT_tHW_abs_wlep_eta__M__whad_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_top_pt","Reco_JABDT_tHW_log_top_pt",31,1.0,7.2),"Reco_JABDT_tHW_log_top_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_m1","Reco_tHW_whaddau_m1",60,0,60),"Reco_tHW_whaddau_m1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_top_pt","Reco_tHW_top_pt",70,0,700),"Reco_tHW_top_pt",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_m2","Reco_tHW_whaddau_m2",40,0,40),"Reco_tHW_whaddau_m2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wb_phi","Reco_tHW_wb_phi",34,-3.14,3.14),"Reco_tHW_wb_phi",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_h_m","Reco_tHW_h_m",30,0,300),"Reco_tHW_h_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_wb_m","Reco_JABDT_tHW_log_wb_m",25,3.0,8),"Reco_JABDT_tHW_log_wb_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_phi2","Reco_tHW_hdau_phi2",34,-3.14,3.14),"Reco_tHW_hdau_phi2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whad_dr","Reco_tHW_whad_dr",52,0,5.2),"Reco_tHW_whad_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_lepw_dr","Reco_tHW_btop_lepw_dr",45,0,4.5),"Reco_tHW_btop_lepw_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wtop_phi","Reco_tHW_wtop_phi",34,-3.14,3.14),"Reco_tHW_wtop_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_abs_wb_eta","Reco_JABDT_tHW_abs_wb_eta",42,0.0,4.2),"Reco_JABDT_tHW_abs_wb_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_wb_eta","Reco_tHW_wb_eta",42,-4.2,4.2),"Reco_tHW_wb_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_m1","Reco_tHW_hdau_m1",45,0,90),"Reco_tHW_hdau_m1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_h_dr","Reco_tHW_h_dr",40,0,4),"Reco_tHW_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_top_phi","Reco_tHW_top_phi",34,-3.14,3.14),"Reco_tHW_top_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_phi2","Reco_tHW_whaddau_phi2",34,-3.14,3.14),"Reco_tHW_whaddau_phi2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_phi1","Reco_tHW_whaddau_phi1",34,-3.14,3.14),"Reco_tHW_whaddau_phi1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_log_wb_pt","Reco_JABDT_tHW_log_wb_pt",50,0.0,7.5),"Reco_JABDT_tHW_log_wb_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_top_eta","Reco_tHW_top_eta",42,-4.2,4.2),"Reco_tHW_top_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_idx2","Reco_tHW_hdau_idx2",15,0,15),"Reco_tHW_hdau_idx2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_idx1","Reco_tHW_hdau_idx1",15,0,15),"Reco_tHW_hdau_idx1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whad_eta","Reco_tHW_whad_eta",40,-4.0,4.0),"Reco_tHW_whad_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_wlep_pt__M__whad_pt","Reco_JABDT_tHW_wlep_pt__M__whad_pt",35,0,350),"Reco_JABDT_tHW_wlep_pt__M__whad_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_hdau_phi1","Reco_tHW_hdau_phi1",34,-3.14,3.14),"Reco_tHW_hdau_phi1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_btop_pt","Reco_tHW_btop_pt",30,0,300),"Reco_tHW_btop_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_leptonictop","Reco_tHW_leptonictop",10,0,1),"Reco_tHW_leptonictop",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHW_costheta_btop_lep","Reco_JABDT_tHW_costheta_btop_lep",50,-1.0,1.0),"Reco_JABDT_tHW_costheta_btop_lep",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_top_m","Reco_tHW_top_m",70,0,700),"Reco_tHW_top_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whad_m","Reco_tHW_whad_m",40,0,400),"Reco_tHW_whad_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_pt2","Reco_tHW_whaddau_pt2",20,0,200),"Reco_tHW_whaddau_pt2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHW_whaddau_pt1","Reco_tHW_whaddau_pt1",40,0,400),"Reco_tHW_whaddau_pt1",selection,label),
    ]
    plots_THQ=[
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_top_phi","Reco_tHq_top_phi",34,-3.14,3.14),"Reco_tHq_top_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_idx","Reco_tHq_btop_idx",15,0,15),"Reco_tHq_btop_idx",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_top_pt__P__h_pt__P__ljet_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt","Reco_JABDT_tHq_top_pt__P__h_pt__P__ljet_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt",50,0,1),"Reco_JABDT_tHq_top_pt__P__h_pt__P__ljet_pt__DIV__Evt_HT__P__Evt_Pt_MET__P__Lep_Pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_btop_eta","Reco_JABDT_tHq_abs_btop_eta",25,0.0,2.5),"Reco_JABDT_tHq_abs_btop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_ljet_eta","Reco_JABDT_tHq_abs_ljet_eta",33,0.0,3.3),"Reco_JABDT_tHq_abs_ljet_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_phi1","Reco_tHq_hdau_phi1",34,-3.14,3.14),"Reco_tHq_hdau_phi1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_phi2","Reco_tHq_hdau_phi2",34,-3.14,3.14),"Reco_tHq_hdau_phi2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_h_eta","Reco_tHq_h_eta",45,-4.5,4.5),"Reco_tHq_h_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_pt2","Reco_tHq_hdau_pt2",35,0,350),"Reco_tHq_hdau_pt2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_h_m","Reco_tHq_h_m",50,0,250),"Reco_tHq_h_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_ljet_idx","Reco_tHq_ljet_idx",15,0,15),"Reco_tHq_ljet_idx",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_pt1","Reco_tHq_hdau_pt1",35,0,350),"Reco_tHq_hdau_pt1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_h_m","Reco_JABDT_tHq_log_h_m",21,3.0,7.2),"Reco_JABDT_tHq_log_h_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_ljet_phi","Reco_tHq_ljet_phi",34,-3.14,3.14),"Reco_tHq_ljet_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_ljet_eta__M__btop_eta","Reco_JABDT_tHq_abs_ljet_eta__M__btop_eta",50,0.0,5.0),"Reco_JABDT_tHq_abs_ljet_eta__M__btop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_h_pt","Reco_tHq_h_pt",60,0,600),"Reco_tHq_h_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_ljet_pt","Reco_JABDT_tHq_log_ljet_pt",21,3.0,7.2),"Reco_JABDT_tHq_log_ljet_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_idx1","Reco_tHq_hdau_idx1",15,0,15),"Reco_tHq_hdau_idx1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_idx2","Reco_tHq_hdau_idx2",15,0,15),"Reco_tHq_hdau_idx2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_w_dr","Reco_tHq_btop_w_dr",42,0,4.2),"Reco_tHq_btop_w_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_top_eta","Reco_JABDT_tHq_abs_top_eta",45,0.0,4.5),"Reco_JABDT_tHq_abs_top_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_pt","Reco_tHq_btop_pt",35,0,350),"Reco_tHq_btop_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_top_pt","Reco_tHq_top_pt",80,0,800),"Reco_tHq_top_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_eta2","Reco_tHq_hdau_eta2",50,-2.5,2.5),"Reco_tHq_hdau_eta2",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_h_phi","Reco_tHq_h_phi",34,-3.14,3.14),"Reco_tHq_h_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_costheta_btop_lep","Reco_JABDT_tHq_costheta_btop_lep",50,-1.0,1.0),"Reco_JABDT_tHq_costheta_btop_lep",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_top_h_dr","Reco_tHq_top_h_dr",50,0,5),"Reco_tHq_top_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_top_m","Reco_JABDT_tHq_log_top_m",30,4.2,7.2),"Reco_JABDT_tHq_log_top_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_top_pt","Reco_JABDT_tHq_log_top_pt",41,-1.0,7.2),"Reco_JABDT_tHq_log_top_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_ljet_pt","Reco_tHq_ljet_pt",60,0,600),"Reco_tHq_ljet_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_costhetastar","Reco_tHq_costhetastar",50,-1.0,1.0),"Reco_tHq_costhetastar",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_min_hdau1_pt_hdau2_pt","Reco_JABDT_tHq_log_min_hdau1_pt_hdau2_pt",21,3.0,7.2),"Reco_JABDT_tHq_log_min_hdau1_pt_hdau2_pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_ljet_e__M__btop_e","Reco_JABDT_tHq_ljet_e__M__btop_e",60,0,600),"Reco_JABDT_tHq_ljet_e__M__btop_e",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_top_eta","Reco_tHq_top_eta",45,-4.5,4.5),"Reco_tHq_top_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_top_m","Reco_tHq_top_m",70,50,750),"Reco_tHq_top_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_m","Reco_tHq_btop_m",40,0,100),"Reco_tHq_btop_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_phi","Reco_tHq_btop_phi",34,-3.14,3.14),"Reco_tHq_btop_phi",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_eta","Reco_tHq_btop_eta",50,-2.5,2.5),"Reco_tHq_btop_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_h_eta","Reco_JABDT_tHq_abs_h_eta",45,0.0,4.5),"Reco_JABDT_tHq_abs_h_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_log_h_pt","Reco_JABDT_tHq_log_h_pt",41,-1.0,7.2),"Reco_JABDT_tHq_log_h_pt",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_JABDT_tHq_abs_top_eta__M__higg_eta","Reco_JABDT_tHq_abs_top_eta__M__higg_eta",60,0.0,6.0),"Reco_JABDT_tHq_abs_top_eta__M__higg_eta",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_m2","Reco_tHq_hdau_m2",50,0,125),"Reco_tHq_hdau_m2",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_btop_lep_dr","Reco_tHq_btop_lep_dr",42,0,4.2),"Reco_tHq_btop_lep_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_m1","Reco_tHq_hdau_m1",50,0,125),"Reco_tHq_hdau_m1",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_h_dr","Reco_tHq_h_dr",40,0,4),"Reco_tHq_h_dr",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_ljet_eta","Reco_tHq_ljet_eta",40,-4.0,4.0),"Reco_tHq_ljet_eta",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_ljet_m","Reco_tHq_ljet_m",55,0,110),"Reco_tHq_ljet_m",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Reco_tHq_hdau_eta1","Reco_tHq_hdau_eta1",50,-2.5,2.5),"Reco_tHq_hdau_eta1",selection,label),
    ]
