...
def plots_ge4j_ge3t(data = None):
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_jet1_M","mass of first jet / GeV",50,0.,35.),"dnnbb_ft_RecoX_jet1_M",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_jet2_E","energy of second jet / GeV",50,30.,900.),"dnnbb_ft_RecoX_jet2_E",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_jet2_Pt","p_{T} of second jet / GeV",50,30.,400.),"dnnbb_ft_RecoX_jet2_Pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_jet2_M","mass of second jet / GeV",50,0.,50.),"dnnbb_ft_RecoX_jet2_M",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_X_dPt","#Deltap_{T} of di-jet combination / GeV",50,0.0,450.),"dnnbb_ft_RecoX_X_dPt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnbb_ft_RecoX_X_btagAverage","average of the two b-tag values",50,0.0,1.0),"dnnbb_ft_RecoX_X_btagAverage",selection,label),
