...
def plots_ge4j_ge3t(data = None):
    ...
    plots = [
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet1_btagValue","btag value of first Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet1_E","energy of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet1_Eta","#eta of first Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet1_Pt","p_{T} of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet2_btagValue","btag value of second Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet2_E","energy of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet2_Eta","#eta of second Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnZ_ft_RecoX_jet2_Pt","p_{T} of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_Pt",selection,label),
         ...
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet1_btagValue","btag value of first H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet1_E","energy of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet1_Eta","#eta of first H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet1_Pt","p_{T} of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet2_btagValue","btag value of second H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet2_E","energy of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet2_Eta","#eta of second H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_dnnH_ft_RecoX_jet2_Pt","p_{T} of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_Pt",selection,label),
...
def plots_4j_ge3t(data = None):
    ...
    plots = [
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet1_btagValue","btag value of first Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet1_E","energy of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet1_Eta","#eta of first Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet1_Pt","p_{T} of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet2_btagValue","btag value of second Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet2_E","energy of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet2_Eta","#eta of second Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnZ_ft_RecoX_jet2_Pt","p_{T} of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_Pt",selection,label),
         ...
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet1_btagValue","btag value of first H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet1_E","energy of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet1_Eta","#eta of first H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet1_Pt","p_{T} of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet2_btagValue","btag value of second H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet2_E","energy of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet2_Eta","#eta of second H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_dnnH_ft_RecoX_jet2_Pt","p_{T} of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_Pt",selection,label),
...
def plots_5j_ge3t(data = None):
    ...
    plots = [
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet1_btagValue","btag value of first Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet1_E","energy of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet1_Eta","#eta of first Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet1_Pt","p_{T} of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet2_btagValue","btag value of second Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet2_E","energy of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet2_Eta","#eta of second Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnZ_ft_RecoX_jet2_Pt","p_{T} of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_Pt",selection,label),
 	 ...
 	 plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Jet_Pt_0","p_{T} of leading jet",100,0.,1000.),"Jet_Pt[0]",selection,label),
         ...
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet1_btagValue","btag value of first H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet1_E","energy of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet1_Eta","#eta of first H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet1_Pt","p_{T} of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet2_btagValue","btag value of second H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet2_E","energy of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet2_Eta","#eta of second H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_dnnH_ft_RecoX_jet2_Pt","p_{T} of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_Pt",selection,label),
...
def plots_ge4j_ge4t(data = None):
    ...
    plots = [
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet1_btagValue","btag value of first Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet1_E","energy of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet1_Eta","#eta of first Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet1_Pt","p_{T} of first Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet2_btagValue","btag value of second Z b-jet",30,0.0,1.0),"dnnZ_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet2_E","energy of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet2_Eta","#eta of second Z b-jet",30,-2.4,2.4),"dnnZ_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnZ_ft_RecoX_jet2_Pt","p_{T} of second Z b-jet",30,0.,500.),"dnnZ_ft_RecoX_jet2_Pt",selection,label),
         ...
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet1_btagValue","btag value of first H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet1_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet1_E","energy of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet1_Eta","#eta of first H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet1_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet1_Pt","p_{T} of first H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet1_Pt",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet2_btagValue","btag value of second H b-jet",30,0.0,1.0),"dnnH_ft_RecoX_jet2_btagValue",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet2_E","energy of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_E",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet2_Eta","#eta of second H b-jet",30,-2.4,2.4),"dnnH_ft_RecoX_jet2_Eta",selection,label),
         plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge4t_dnnH_ft_RecoX_jet2_Pt","p_{T} of second H b-jet",30,0.,500.),"dnnH_ft_RecoX_jet2_Pt",selection,label),
