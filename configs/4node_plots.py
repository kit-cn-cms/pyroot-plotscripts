...
def plots_dnn(data, discrname):
    ...
    nhistobins += [ndefaultbins, 1, 1, 1]
    minxvals += [0.25, 0.25, 0.25, 0.25]
    maxxvals += [0.87, 0.87, 0.55, 0.7]

    categories += [
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==0)","ljets_ge4j_3t_ttH_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==1)","ljets_ge4j_3t_tthf_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==2)","ljets_ge4j_3t_ttcc_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==3)","ljets_ge4j_3t_ttlf_node_v2",""),
        ]
    discrs += [
        "DNNOutput_ge4j_3t_node_ttH",
        "DNNOutput_ge4j_3t_node_tthf",
    ...
    nhistobins += [ndefaultbins, ndefaultbins, 1, 1]
    minxvals += [0.25, 0.25, 0.25, 0.25]
    maxxvals += [0.87, 0.87, 0.55, 0.7]
    ...
    # plots for ge4j_ge4t
    categories += [
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==0)","ljets_ge4j_ge4t_ttH_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==1)","ljets_ge4j_ge4t_tthf_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==2)","ljets_ge4j_ge4t_ttcc_node_v2",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==3)","ljets_ge4j_ge4t_ttlf_node_v2",""),
        ]
    discrs += [
        "DNNOutput_ge4j_ge4t_node_ttH",
        "DNNOutput_ge4j_ge4t_node_tthf",
