...
def plots_dnn(data, discrname):
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==2)","ljets_ge4j_ge4t_ttbb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==3)","ljets_ge4j_ge4t_tt2b_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==4)","ljets_ge4j_ge4t_ttb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==5)","ljets_ge4j_ge4t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==6)","ljets_ge4j_ge4t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_ge4j_ge4t_node_ttZ",
        "DNNOutput_ge4j_ge4t_node_ttH",
        "DNNOutput_ge4j_ge4t_node_ttbb",
        "DNNOutput_ge4j_ge4t_node_tt2b",
        "DNNOutput_ge4j_ge4t_node_ttb",
        "DNNOutput_ge4j_ge4t_node_ttcc",
        "DNNOutput_ge4j_ge4t_node_ttlf",
        ]
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.8, 0.6, 0.85, 0.75, 0.4, 0.45, 0.6]
    ...
    categories += [
        ...
        ("((N_Jets>=6&&N_BTagsM>=3)&&DNNPredictedClass_ge6j_ge3t==2)","ljets_ge6j_ge3t_ttbb_node",""),
        ("((N_Jets>=6&&N_BTagsM>=3)&&DNNPredictedClass_ge6j_ge3t==3)","ljets_ge6j_ge3t_tt2b_node",""),
        ("((N_Jets>=6&&N_BTagsM>=3)&&DNNPredictedClass_ge6j_ge3t==4)","ljets_ge6j_ge3t_ttb_node",""),
        ("((N_Jets>=6&&N_BTagsM>=3)&&DNNPredictedClass_ge6j_ge3t==5)","ljets_ge6j_ge3t_ttcc_node",""),
        ("((N_Jets>=6&&N_BTagsM>=3)&&DNNPredictedClass_ge6j_ge3t==6)","ljets_ge6j_ge3t_ttlf_node",""),
        ]
    discrs += [
    ...
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.85, 0.7, 0.7, 0.7, 0.5, 0.4, 0.6]
    ...
    categories += [
        ...
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==2)","ljets_le5j_ge3t_ttbb_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==3)","ljets_le5j_ge3t_tt2b_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==4)","ljets_le5j_ge3t_ttb_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==5)","ljets_le5j_ge3t_ttcc_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==6)","ljets_le5j_ge3t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_le5j_ge3t_node_ttZ",
        "DNNOutput_le5j_ge3t_node_ttH",
        "DNNOutput_le5j_ge3t_node_ttbb",
        "DNNOutput_le5j_ge3t_node_tt2b",
        "DNNOutput_le5j_ge3t_node_ttb",
        "DNNOutput_le5j_ge3t_node_ttcc",
        "DNNOutput_le5j_ge3t_node_ttlf",
        ]
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.85, 0.65, 0.75, 0.75, 0.45, 0.4, 0.6]
    ...
    categories += [
        ...
        ("((N_Jets==5&&N_BTagsM>=3)&&DNNPredictedClass_5j_ge3t==2)","ljets_5j_ge3t_ttbb_node",""),
        ("((N_Jets==5&&N_BTagsM>=3)&&DNNPredictedClass_5j_ge3t==3)","ljets_5j_ge3t_tt2b_node",""),
        ("((N_Jets==5&&N_BTagsM>=3)&&DNNPredictedClass_5j_ge3t==4)","ljets_5j_ge3t_ttb_node",""),
        ("((N_Jets==5&&N_BTagsM>=3)&&DNNPredictedClass_5j_ge3t==5)","ljets_5j_ge3t_ttcc_node",""),
        ("((N_Jets==5&&N_BTagsM>=3)&&DNNPredictedClass_5j_ge3t==6)","ljets_5j_ge3t_ttlf_node",""),
        ]
    discrs += [
    ...
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.75, 0.7, 0.8, 0.7, 0.5, 0.35, 0.55]
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==2)","ljets_ge4j_ge3t_ttbb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==3)","ljets_ge4j_ge3t_tt2b_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==4)","ljets_ge4j_ge3t_ttb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==5)","ljets_ge4j_ge3t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==6)","ljets_ge4j_ge3t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_ge4j_ge3t_node_ttZ",
        "DNNOutput_ge4j_ge3t_node_ttH",
        "DNNOutput_ge4j_ge3t_node_ttbb",
        "DNNOutput_ge4j_ge3t_node_tt2b",
        "DNNOutput_ge4j_ge3t_node_ttb",
        "DNNOutput_ge4j_ge3t_node_ttcc",
        "DNNOutput_ge4j_ge3t_node_ttlf",
        ]
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.8, 0.7, 0.8, 0.7, 0.5, 0.35, 0.65]
    ...
    categories += [
        ...
        ("((N_Jets==4&&N_BTagsM>=3)&&DNNPredictedClass_4j_ge3t==2)","ljets_4j_ge3t_ttbb_node",""),
        ("((N_Jets==4&&N_BTagsM>=3)&&DNNPredictedClass_4j_ge3t==3)","ljets_4j_ge3t_tt2b_node",""),
        ("((N_Jets==4&&N_BTagsM>=3)&&DNNPredictedClass_4j_ge3t==4)","ljets_4j_ge3t_ttb_node",""),
        ("((N_Jets==4&&N_BTagsM>=3)&&DNNPredictedClass_4j_ge3t==5)","ljets_4j_ge3t_ttcc_node",""),
        ("((N_Jets==4&&N_BTagsM>=3)&&DNNPredictedClass_4j_ge3t==6)","ljets_4j_ge3t_ttlf_node",""),
        ]
    discrs += [
    ...
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.9, 0.65, 0.8, 0.7, 0.4, 0.45, 0.5]
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==2)","ljets_ge4j_3t_ttbb_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==3)","ljets_ge4j_3t_tt2b_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==4)","ljets_ge4j_3t_ttb_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==5)","ljets_ge4j_3t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==6)","ljets_ge4j_3t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_ge4j_3t_node_ttZ",
        "DNNOutput_ge4j_3t_node_ttH",
        "DNNOutput_ge4j_3t_node_ttbb",
        "DNNOutput_ge4j_3t_node_tt2b",
        "DNNOutput_ge4j_3t_node_ttb",
        "DNNOutput_ge4j_3t_node_ttcc",
        "DNNOutput_ge4j_3t_node_ttlf",
        ]
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15]
    maxxvals += [0.75, 0.55, 0.65, 0.65, 0.55, 0.35, 0.65]
