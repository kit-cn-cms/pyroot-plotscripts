...
#sel_jettag+= "*(abs(Evt_M2_closestTo91TaggedJets-91.)>=20.)"
...
samples = [
    ...
    plotClasses.Sample('t#bar{t}Z', ROOT.kOrange+7,
            path_vdlinden+"/TTZToQQ*/*nominal*.root;"+path_vdlinden+"/TTZToLLNuNu_M-10*/*nominal*.root",
...
sortedProcesses = ["ttlf", "ttcc", "ttb", "tt2b", "ttbb", "singlet", "ttH","ttZ", "misc"]
