...
sel_jettag+="*(abs(Evt_M2_closestTo125TaggedJets-125.)>=15.)"
...
datacard_processes  = [p for p in processes if not p == "tthf"]
...
sortedProcesses = ["ttZ", "ttlf", "ttcc", "tthf", "ttb", "tt2b", "ttbb", "singlet", "misc", "ttH"]
