...
#plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_CSV_avg_tagged","average b-tag value of tagged jets",30,0.4,1.0),"Evt_CSV_avg_tagged",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_M2_TaggedJetsAverage","m^{b,b}_{avg}",30,40.0,500.0),"Evt_M2_TaggedJetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_M2_minDrTaggedJets","m(#DeltaR^{b,b}_{min})",30,20.0,350.0),"Evt_M2_minDrTaggedJets",selection,label),
        #plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_MTW","m_{T}^{W}",30,0.0,250.0),"Evt_MTW",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_M_TaggedJetsAverage","m^{b}_{avg}",30,5.0,35.0),"Evt_M_TaggedJetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_Evt_Pt_minDrTaggedJets","p_{T}(#DeltaR^{b,b}_{min})",30,30.0,450.0),"Evt_Pt_minDrTaggedJets",selection,label),
    ...
    #plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_RecoTTZ_Chi2Z_log","t#bar{t}+Z reconstruction ln(#chi^{2})(Z)",30,-10.0,7.0),"RecoTTZ_Chi2Z_log",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_RecoTTZ_Z_M_log","t#bar{t}+Z reconstruction ln(m)(Z)",30,3.5,6.0),"RecoTTZ_Z_M_log",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge6j_ge3t_RecoTTZ_Z_Pt","t#bar{t}+Z reconstruction p_{T}(Z)",30,0.0,600.0),"RecoTTZ_Z_Pt",selection,label),
        ]
...
#plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_CSV_avg","average b-tag value",30,0.2,0.8),"Evt_CSV_avg",selection,label),
    ...
    #plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_Deta_JetsAverage","#Delta#eta^{j,j}_{avg}",30,0.25,2.5),"Evt_Deta_JetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_M2_TaggedJetsAverage","m^{b,b}_{avg}",30,40.0,500.0),"Evt_M2_TaggedJetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_M2_minDrJets","m(#DeltaR^{j,j}_{min})",30,20.0,200.0),"Evt_M2_minDrJets",selection,label),
    #plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_M2_minDrTaggedJets","m(#DeltaR^{b,b}_{min})",30,20.0,350.0),"Evt_M2_minDrTaggedJets",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_M_TaggedJetsAverage","m^{b}_{avg}",30,5.0,30.0),"Evt_M_TaggedJetsAverage",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_M_Total","m_{tot}",30,400.0,2000.0),"Evt_M_Total",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_5j_ge3t_Evt_Pt_minDrJets","p_{T}(#DeltaR^{j,j}_{min})",30,40.0,500.0),"Evt_Pt_minDrJets",selection,label),
...
#plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_CSV_min_tagged","minimal b-tag value of tagged jets",30,0.277,1.0),"Evt_CSV_min_tagged",selection,label),
    ...
    #plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_M2_minDrTaggedJets","m(#DeltaR^{b,b}_{min})",30,20.0,300.0),"Evt_M2_minDrTaggedJets",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_MHT","missing H_{T}",30,0.0,250.0),"Evt_MHT",selection,label),
    ...
    #plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_M_TaggedJetsAverage","m^{b}_{avg}",30,5.0,30.0),"Evt_M_TaggedJetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_Pt_TaggedJetsAverage","p_{T, avg}^{b,b}",30,40.0,250.0),"Evt_Pt_TaggedJetsAverage",selection,label),
    ...
    #plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_Evt_Pt_minDrTaggedJets","p_{T}(#DeltaR^{b,b}_{min})",30,0.0,400.0),"Evt_Pt_minDrTaggedJets",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_RecoTTZ_TopHad_M","t#bar{t}+Z reconstruction m(t_{had})",30,100.0,500.0),"RecoTTZ_TopHad_M",selection,label),
    #plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_RecoTTZ_TopHad_Pt","t#bar{t}+Z reconstruction p_{T}(t_{had})",30,0.0,500.0),"RecoTTZ_TopHad_Pt",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_4j_ge3t_RecoTTZ_TopHad_W_M","t#bar{t}+Z reconstruction m(W_{had})",30,20.0,250.0),"RecoTTZ_TopHad_W_M",selection,label),
        ]
