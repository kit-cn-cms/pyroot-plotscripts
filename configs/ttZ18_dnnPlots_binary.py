...
def plots_ge4j_ge4t():
    ...
    plots = [
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_Evt_M_MinDeltaRJets","mass of min #DeltaR(jet jet)",30,20.0,200.0),"Evt_M_MinDeltaRJets",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_Evt_M2_JetsAverage","average M_{2}(jets)",30,50.0,500.0),"Evt_M2_JetsAverage",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_LooseLepton_E_0","E(lep)",30,0.0,600.0),"LooseLepton_E[0]",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_MVA_MHT","missing H_{T}",30,0.0,300.0),"MVA_MHT",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_Jet_Pt_2","p_{T} of third jet",30,30.0,300.0),"Jet_Pt[2]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_MVA_aplanarity","aplanarity",30,0.0,0.5),"MVA_aplanarity",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge4t_MVA_cos_theta_l_bhad","cos#theta(lep b_{had})",30,-1.0,1.0),"MVA_cos_theta_l_bhad",selection,label),
...
def plots_5j_ge3t():
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_N_LooseJets","N(LooseJets)",7,3.5,10.5),"N_LooseJets",selection,label),
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_MVA_aplanarity","aplanarity",30,0.0,0.5),"MVA_aplanarity",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_MVA_MET","MET",30,0.0,300.0),"MVA_MET",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_Evt_M_MinDeltaRLeptonJet","mass of min #DeltaR(lep jet)",30,20.0,250.0),"Evt_M_MinDeltaRLeptonJet",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_Evt_Pt_MET","p_{T}(MET)",30,20.0,400.0),"Evt_Pt_MET",selection,label),
        plotClasses.Plot(ROOT.TH1D("5j_ge3t_Evt_Dr_MinDeltaRJets","min #DeltaR(jet jet)",30,0.4,2.2),"Evt_Dr_MinDeltaRJets",selection,label),
...
def plots_ge4j_ge3t():
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_MVA_aplanarity","aplanarity",30,0.0,0.5),"MVA_aplanarity",selection,label),
...
def plots_4j_ge3t():
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_Evt_Jet_MaxDeta_Jets","max #Delta#eta(jet jet)",30,0.0,4.5),"Evt_Jet_MaxDeta_Jets",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_MVA_MET","MET",30,0.0,300.0),"MVA_MET",selection,label),
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_Jet_Pt_2","p_{T} of third jet",30,30.0,300.0),"Jet_Pt[2]",selection,label),
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_MVA_aplanarity","aplanarity",30,0.0,0.5),"MVA_aplanarity",selection,label),
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_Jet_M_3","mass of fourth jet",30,0.0,30.0),"Jet_M[3]",selection,label),
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_Evt_Pt_MET","p_{T}(MET)",30,20.0,400.0),"Evt_Pt_MET",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("4j_ge3t_MVA_max_dR_jj","max #DeltaR(jet jet)",30,2.0,5.0),"MVA_max_dR_jj",selection,label),
...
def plots_ge4j_3t():
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_3t_Evt_Pt_MET","p_{T}(MET)",30,20.0,400.0),"Evt_Pt_MET",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_3t_MVA_aplanarity","aplanarity",30,0.0,0.5),"MVA_aplanarity",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_3t_Evt_Dr_MinDeltaRJets","min #DeltaR(jet jet)",30,0.4,2.2),"Evt_Dr_MinDeltaRJets",selection,label),
