...
#             'ttH_htt',
#             sammcWeightDict=sampleDict, readTrees=doReadTrees),

#     plotClassesmcWeight.Sample('t#bar{t}H, H to #gamma#gamma',ROOT.kBlue+1,
#             patmcWeighth_mwassmer+'/ttHToNonbb*/*nominal*.root',
...
#            samDict=sampleDict, readTrees=doReadTrees),
    ...
    plotClasses.Sample('t#bar{t}+hf',ROOT.kRed+3,
            ...
            mcWeight+TTbbweight+'*((GenEvt_I_TTPlusBB==1)||(GenEvt_I_TTPlusBB==2)||(GenEvt_I_TTPlusBB==3))'+sel_MET+sel_StrangeMuWeights,
            'ttbarPlusHF',
            samDict=sampleDict, readTrees=doReadTrees), 
