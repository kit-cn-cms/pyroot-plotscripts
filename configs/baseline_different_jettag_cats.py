...
def plots_dnn(data, discrname):
    ...
    #     ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==1)","ljets_ge4j_3t_ttbb_node",""),
    #     ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==2)","ljets_ge4j_3t_tt2b_node",""),
    #     ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==3)","ljets_ge4j_3t_ttb_node",""),
    #     ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==4)","ljets_ge4j_3t_ttcc_node",""),
    #     ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==5)","ljets_ge4j_3t_ttlf_node",""),
    #     ]
    # discrs += [
    ...
    #     ]
    # nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    # minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    # maxxvals += [0.72, 0.61, 0.7, 0.47, 0.34, 0.61]
    ...
    #     ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==1)","ljets_le5j_ge3t_ttbb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==2)","ljets_le5j_ge3t_tt2b_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==3)","ljets_le5j_ge3t_ttb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==4)","ljets_le5j_ge3t_ttcc_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==5)","ljets_le5j_ge3t_ttlf_node",""),
    #     ]
    # discrs += [
    ...
    # nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    # minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    # maxxvals += [0.81, 0.76, 0.69, 0.47, 0.34, 0.56]
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==1)","ljets_ge4j_ge3t_ttbb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==2)","ljets_ge4j_ge3t_tt2b_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==3)","ljets_ge4j_ge3t_ttb_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==4)","ljets_ge4j_ge3t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==5)","ljets_ge4j_ge3t_ttlf_node",""),
        ]
    discrs += [
    ...
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    maxxvals += [0.82, 0.82, 0.86, 0.52, 0.38, 0.62]
    ...
    #     ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==1)","ljets_le5j_3t_ttbb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==2)","ljets_le5j_3t_tt2b_node",""),
    #     ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==3)","ljets_le5j_3t_ttb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==4)","ljets_le5j_3t_ttcc_node",""),
    #     ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==5)","ljets_le5j_3t_ttlf_node",""),
    #     ]
    # discrs += [
    #     "DNNOutput_le5j_3t_node_ttH",
    #     "DNNOutput_le5j_3t_node_ttbb",
    #     "DNNOutput_le5j_3t_node_tt2b",
    #     "DNNOutput_le5j_3t_node_ttb",
    #     "DNNOutput_le5j_3t_node_ttcc",
    #     "DNNOutput_le5j_3t_node_ttlf",
    #     ]
    # nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    # minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    # maxxvals += [0.7, 0.68, 0.62, 0.43, 0.34, 0.55]
    ...
    #     ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==1)","ljets_le5j_ge4t_ttbb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==2)","ljets_le5j_ge4t_tt2b_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==3)","ljets_le5j_ge4t_ttb_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==4)","ljets_le5j_ge4t_ttcc_node",""),
    #     ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==5)","ljets_le5j_ge4t_ttlf_node",""),
    #     ]
    # discrs += [
    #     "DNNOutput_le5j_ge4t_node_ttH",
    #     "DNNOutput_le5j_ge4t_node_ttbb",
    #     "DNNOutput_le5j_ge4t_node_tt2b",
    #     "DNNOutput_le5j_ge4t_node_ttb",
    #     "DNNOutput_le5j_ge4t_node_ttcc",
    #     "DNNOutput_le5j_ge4t_node_ttlf",
    #     ]
    # nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    # minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    # maxxvals += [0.84, 0.68, 0.6, 0.34, 0.37, 0.55]
    ...
    #     ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==1)","ljets_ge4j_ge4t_ttbb_node",""),
    #     ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==2)","ljets_ge4j_ge4t_tt2b_node",""),
    #     ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==3)","ljets_ge4j_ge4t_ttb_node",""),
    #     ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==4)","ljets_ge4j_ge4t_ttcc_node",""),
    #     ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==5)","ljets_ge4j_ge4t_ttlf_node",""),
    #     ]
    # discrs += [
    ...
    # nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    # minxvals += [0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    # maxxvals += [0.79, 0.66, 0.55, 0.4, 0.45, 0.6]
