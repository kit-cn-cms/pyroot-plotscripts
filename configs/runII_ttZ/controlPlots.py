...
def plots_control(cat,selection,label):
    ...
    if cat == "ge4j_ge3t":
        plots += [
            ...
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF","btagSF (orig tree vs friend tree)",50,0.,5.,50,0.,5.),
                "Weight_btagSF","weight_ft_btagSF",selection,label),

            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_lfup","btagSF lf up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_LFup","weight_ft_btagSF_up_lf_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_lfdown","btagSF lf down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_LFdown","weight_ft_btagSF_down_lf_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_hfup","btagSF hf up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_HFup","weight_ft_btagSF_up_hf_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_hfdown","btagSF hf down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_HFdown","weight_ft_btagSF_down_hf_rel",selection,label),

            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_c2up","btagSF c2 up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_CErr2up","weight_ft_btagSF_up_cferr2_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_c1up","btagSF c1 up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_CErr1up","weight_ft_btagSF_up_cferr1_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_c2down","btagSF c2 down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_CErr2down","weight_ft_btagSF_down_cferr2_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_c1down","btagSF c1 down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_CErr1down","weight_ft_btagSF_down_cferr1_rel",selection,label),

            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_lfs1up","btagSF lf s1 up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_LFStats1up","weight_ft_btagSF_up_lfstats1_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_lfs1down","btagSF lf s1 down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_LFStats1down","weight_ft_btagSF_down_lfstats1_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_hfs1up","btagSF hf s1 up (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_HFStats1up","weight_ft_btagSF_up_hfstats1_rel",selection,label),
            plotClasses.TwoDimPlot(ROOT.TH2F(cat+"_crosscheck_btagSF_hfs1down","btagSF hf s1 down (orig tree vs friend tree)",50,0.,2.,50,0.,2.),
                "Weight_btagSF_HFStats1down","weight_ft_btagSF_down_hfstats1_rel",selection,label),
