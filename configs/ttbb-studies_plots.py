...
def add_plots():
	# book plots
	plotlabel="t#overline{t}+b-jets, semileptonic top decays"
	...
	plots=[
		...
		# plotClasses.Plot(ROOT.TH1D("AdditionalBHadrons_GenJet_Dr" ,"additional b-hadron #Delta{R}",1200,0.0,12.0),AdditionalBHadrons_GenJet_Dr,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalBHadrons_GenJet_M" ,"additional b-hadron M [GeV]",200,0.0,2000.0),AdditionalBHadrons_GenJet_M,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("Weight_LHECentral" ,"Weight_LHECentral",1000,0.0,1.0),Weight_LHECentral,plotselection,plotlabel),
		...
		plotClasses.Plot(ROOT.TH1D("AdditionalBHadron_Pt" ,"additional b-hadron p_{T} [GeV]",250,0.0,2500.0),AdditionalBHadron_Pt,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("AdditionalGenBJet_Eta" ,"additional b-jet #eta",600,-3.0,3.0),AdditionalGenBJet_Eta,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("AdditionalGenBJet_Phi" ,"additional b-jet #Phi",700,-3.5,3.5),AdditionalGenBJet_Phi,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalGenBJet_Pt" ,"additional b-jet p_{T} [GeV]",250,0.0,2500.0),AdditionalGenBJet_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalGenBJet_1st_Pt" ,"additional b-jet p_{T} [GeV] of leading jet",250,0.0,2500.0),AdditionalGenBJet_1st_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalGenBJet_2nd_Pt" ,"additional b-jet p_{T} [GeV] of second jet",250,0.0,2500.0),AdditionalGenBJet_2nd_Pt,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("AdditionalLightGenJet_Pt" ,"additional light flavor jet p_{T} [GeV]",250,0.0,2500.0),AdditionalLightGenJet_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalLightGenJet_1st_Pt" ,"additional light flavor jet p_{T} [GeV] of leading jet",250,0.0,2500.0),AdditionalLightGenJet_1st_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("AdditionalLightGenJet_2nd_Pt" ,"additional light flavor jet p_{T} [GeV] of second jet",250,0.0,2500.0),AdditionalLightGenJet_2nd_Pt,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("GenJet_Pt" ,"jet p_{T} [GeV]",250,0.0,2500.0),GenJet_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_1st_Pt" ,"jet p_{T} [GeV] of leading jet",250,0.0,2500.0),GenJet_1st_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_2nd_Pt" ,"jet p_{T} [GeV] of second jet",250,0.0,2500.0),GenJet_2nd_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_3rd_Pt" ,"jet p_{T} [GeV] of third jet",250,0.0,2500.0),GenJet_3rd_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_4th_Pt" ,"jet p_{T} [GeV] of fourth jet",250,0.0,2500.0),GenJet_4th_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_5th_Pt" ,"jet p_{T} [GeV] of fifth jet",250,0.0,2500.0),GenJet_5th_Pt,plotselection,plotlabel),
		# plotClasses.Plot(ROOT.TH1D("GenJet_6th_Pt" ,"jet p_{T} [GeV] of sixth jet",250,0.0,2500.0),GenJet_6th_Pt,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("GenTopHad_B_GenJet_Pt" ,"b-jet p_{T} [GeV] from top quark",250,0.0,2500.0),GenTopHad_B_GenJet_Pt,plotselection,plotlabel),
		...
		# plotClasses.Plot(ROOT.TH1D("GenTopLep_B_GenJet_Pt" ,"b-jet p_{T} [GeV] from top quark",250,0.0,2500.0),GenTopLep_B_GenJet_Pt,plotselection,plotlabel),
