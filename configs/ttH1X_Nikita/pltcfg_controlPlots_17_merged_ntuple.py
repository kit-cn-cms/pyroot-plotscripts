...
mergedPath = path+"/TTbb_Powheg_Openloops_new_pmx/*nominal*.root"
...
stpath = path+'/ST_*TuneCP5_PSweights*/*nominal*.root'+';'+ \
         path+'/ST_t-channel*/*nominal*.root'
...
# WEIGHTS #
# ======= #
defaultWeight = sel_jettag+"*Weight_GEN_nom*Weight_pu69p2*Weight_CSV"
TTbbweight='*35.8038266498504*0.43937838*1.0'
...
samples=[
    # signal samples
    plotClasses.Sample('t#bar{t}H',ROOT.kBlue,
            ttHpath,
            lumi+evenSel+sel_MET,
            'ttH',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),

    plotClasses.Sample('tHW',ROOT.kCyan+1,
            THWpath,
            lumi+evenSel+sel_MET,
            'THW',
         samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),

    plotClasses.Sample('tHQ',ROOT.kCyan+3,
            THQpath,
            lumi+evenSel+sel_MET,
            'THQ',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
...
#
    ...
    plotClasses.Sample('t#bar{t}+b',ROOT.kRed-2,
            mergedPath,
            lumi+TTbbweight+evenSel+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,
            'ttbarPlusB',
            samDict=sampleDict, readTrees=doReadTrees),

    plotClasses.Sample('t#bar{t}+2b',ROOT.kRed+2,
            mergedPath,
            lumi+TTbbweight+evenSel+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,
            'ttbarPlus2B',
            samDict=sampleDict, readTrees=doReadTrees),

    plotClasses.Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,
            mergedPath,
            lumi+TTbbweight+evenSel+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,
            'ttbarPlusBBbar',
            samDict=sampleDict, readTrees=doReadTrees),
