...
def plots_dnn(data, discrname):
    ...
    interf_ljets_ge4j_ge4t_ttH_node.maxxval = 1.0
    ...
    interf_ljets_ge4j_ge4t_tt2b_node.category = ("((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t==1))","ljets_ge4j_ge4t_tt2b_node","")
    interf_ljets_ge4j_ge4t_tt2b_node.minxval = 0.2
    interf_ljets_ge4j_ge4t_tt2b_node.maxxval = 0.76
    ...
    interf_ljets_ge4j_ge4t_ttcc_node.maxxval = 0.57
    ...
    interf_ljets_ge4j_ge4t_ttlf_node.maxxval = 0.72
    interf_ljets_ge4j_ge4t_ttlf_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_ge4t_ttlf_node)
    
    interf_ljets_ge4j_ge4t_ttb_bb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_node_ttb_bb",
                                            label          = "ljets_ge4j_ge4t_ttb_bb_node",
                                            selection      = "((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t==4))")
    interf_ljets_ge4j_ge4t_ttb_bb_node.category = ("((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t==4))","ljets_ge4j_ge4t_ttb_bb_node","")
    interf_ljets_ge4j_ge4t_ttb_bb_node.minxval = 0.2
    interf_ljets_ge4j_ge4t_ttb_bb_node.maxxval = 0.84
    interf_ljets_ge4j_ge4t_ttb_bb_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_ge4t_ttb_bb_node)
    ...
    interf_ljets_ge4j_3t_ttH_node.maxxval = 0.86
    ...
    interf_ljets_ge4j_3t_tt2b_node.category = ("((N_Jets>=4&&N_BTagsM==3)&&(1.)&&(DNNPredictedClass_ge4j_3t==1))","ljets_ge4j_3t_tt2b_node","")
    interf_ljets_ge4j_3t_tt2b_node.minxval = 0.2
    interf_ljets_ge4j_3t_tt2b_node.maxxval = 0.8
    ...
    interf_ljets_ge4j_3t_ttcc_node.maxxval = 0.46
    ...
    interf_ljets_ge4j_3t_ttlf_node.maxxval = 0.72
    interf_ljets_ge4j_3t_ttlf_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_3t_ttlf_node)
    
    interf_ljets_ge4j_3t_ttb_bb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_node_ttb_bb",
                                            label          = "ljets_ge4j_3t_ttb_bb_node",
                                            selection      = "((N_Jets>=4&&N_BTagsM==3)&&(1.)&&(DNNPredictedClass_ge4j_3t==4))")
    interf_ljets_ge4j_3t_ttb_bb_node.category = ("((N_Jets>=4&&N_BTagsM==3)&&(1.)&&(DNNPredictedClass_ge4j_3t==4))","ljets_ge4j_3t_ttb_bb_node","")
    interf_ljets_ge4j_3t_ttb_bb_node.minxval = 0.2
    interf_ljets_ge4j_3t_ttb_bb_node.maxxval = 0.7
    interf_ljets_ge4j_3t_ttb_bb_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_3t_ttb_bb_node)
