...
STXS_stage1_b1 = '*(GenHiggs_Pt<60)'
STXS_stage1_b2 = '*((GenHiggs_Pt>60)&&(GenHiggs_Pt<120))'
STXS_stage1_b3 = '*((GenHiggs_Pt>120)&&(GenHiggs_Pt<200))'
STXS_stage1_b4 = '*((GenHiggs_Pt>200)&&(GenHiggs_Pt<300))'
STXS_stage1_b5 = '*(GenHiggs_Pt>300)'
...
samples=[
    # signal samples
    plotClasses.Sample('t#bar{t}H_1',830,
            ttHpath,
            lumi+sel_MET+STXS_stage0+STXS_stage1_b1,
            'ttH_1',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
    plotClasses.Sample('t#bar{t}H_2',418,
            ttHpath,
            lumi+sel_MET+STXS_stage0+STXS_stage1_b2,
            'ttH_2',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
    plotClasses.Sample('t#bar{t}H_3',433,
            ttHpath,
            lumi+sel_MET+STXS_stage0+STXS_stage1_b3,
            'ttH_3',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
    plotClasses.Sample('t#bar{t}H_4',867,
            ttHpath,
            lumi+sel_MET+STXS_stage0+STXS_stage1_b4,
            'ttH_4',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
    plotClasses.Sample('t#bar{t}H_5',602,
            ttHpath,
            lumi+sel_MET+STXS_stage0+STXS_stage1_b5,
            'ttH_5',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
