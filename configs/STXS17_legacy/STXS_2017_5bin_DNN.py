...
def plots_dnn(data, discrname):
    ...
    interf_ljets_ge4j_ge4t_ttH_ttH_incl_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_ttH_node_ttH",
                                            label          = "ljets_ge4j_ge4t_ttH_ttH_incl_node",
                                            selection      = "((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_ttH==0))")
    interf_ljets_ge4j_ge4t_ttH_ttH_incl_node.category = ("((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_ttH==0))","ljets_ge4j_ge4t_ttH_ttH_1_node","")
    interf_ljets_ge4j_ge4t_ttH_ttH_incl_node.minxval = 0.24
    interf_ljets_ge4j_ge4t_ttH_ttH_incl_node.maxxval = 0.66
    interf_ljets_ge4j_ge4t_ttH_ttH_incl_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_ge4t_ttH_ttH_incl_node)
