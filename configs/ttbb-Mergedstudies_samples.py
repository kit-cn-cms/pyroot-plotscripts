...
def getSamplesPowheg(pltcfg):
    return pltcfg.samplesPowheg
    
def getSamplesPowOL(pltcfg):
    return pltcfg.samplesPowhegOL
    
def getSamplesPowHel(pltcfg):
    return pltcfg.samplesPowHel

def getSamples( pltcfg ):
    # ~ return pltcfg.samplesControlPlots
    return getSamplesPowheg(pltcfg) + getSamplesPowOL(pltcfg) + getSamplesPowHel(pltcfg)
