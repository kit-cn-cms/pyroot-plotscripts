...
# new cross section (14TeV)
ttH_XS_scale = "*(0.6128/0.5065)"
ttbar_XS_scale = "*(984.5/831.76)"
...
samples_ttH_decay = [
    plotClasses.Sample('t#bar{t}H (bb)',ROOT.kBlue+1,
            ttHpath,
            lumi+sel_MET+hbbSel+ttH_XS_scale,
            'ttH_hbb',
...
samples_ttbb_4FS = [
     plotClasses.Sample('t#bar{t}+b#bar{b} (4FS)',ROOT.kRed+3,
             path_ttbb,
             lumi+evenSel+ttbb_4FS_scale+'*((GenEvt_I_TTPlusBB==1)||(GenEvt_I_TTPlusBB==2)||(GenEvt_I_TTPlusBB==3))'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
             'ttbb',
...
samples_ttbar_hf_spilt = [
     plotClasses.Sample('t#bar{t}+b',ROOT.kRed-2,
             ttbarPathS,
             lumi+evenSel+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
             'ttbarPlusB',
             samDict=sampleDict, readTrees=doReadTrees),

     plotClasses.Sample('t#bar{t}+2b',ROOT.kRed+2,
             ttbarPathS,
             lumi+evenSel+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
             'ttbarPlus2B',
             samDict=sampleDict, readTrees=doReadTrees),

     plotClasses.Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,
             ttbarPathS,
             lumi+evenSel+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
             'ttbarPlusBBbar',
             samDict=sampleDict, readTrees=doReadTrees), 
    ]
...
samples_ttbb_decay_modes_5FS = [
    plotClasses.Sample('t#bar{t}+b#bar{b}(sl) (5FS)',ROOT.kRed+3,
            ...
            lumi+'*((GenEvt_I_TTPlusBB==1)||(GenEvt_I_TTPlusBB==2)||(GenEvt_I_TTPlusBB==3))'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
            'ttbb_5FS_SL',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"), 
...
samples_ttnonbb = [
    ...
    plotClasses.Sample('t#bar{t}+lf',ROOT.kRed-7,
            ttbarPathS,
            lumi+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
            'ttlf',
            samDict=sampleDict, readTrees=doReadTrees),

    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kRed+1,
            ttbarPathS,
            lumi+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+sel_StrangeMuWeights+ttbar_XS_scale,
            'ttcc',
            samDict=sampleDict, readTrees=doReadTrees),
    ]
