...
def add_plots():
    ...
    plotsGEN=[
        ...
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_Pt" ,"jet p_{T} [GeV]",25,0.0,1000.0),"GenJet_Jet_Pt",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_1st_Pt" ,"jet p_{T} [GeV] of leading jet",25,0.0,1000.0),"GenJet_Jet_Pt[0]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_2nd_Pt" ,"jet p_{T} [GeV] of second jet",25,0.0,1000.0),"GenJet_Jet_Pt[1]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_3rd_Pt" ,"jet p_{T} [GeV] of third jet",25,0.0,1000.0),"GenJet_Jet_Pt[2]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_4th_Pt" ,"jet p_{T} [GeV] of fourth jet",25,0.0,1000.0),"GenJet_Jet_Pt[3]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_5th_Pt" ,"jet p_{T} [GeV] of fifth jet",25,0.0,1000.0),"GenJet_Jet_Pt[4]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenJet_6th_Pt" ,"jet p_{T} [GeV] of sixth jet",25,0.0,1000.0),"GenJet_Jet_Pt[5]",plotselection,plotlabel),
