...
def add_plots():
    ...
    plots=[
        ...
        plotClasses.Plot(ROOT.TH1D("Evt_HT","Sum p_{T} all particles",75,0,1500),"Evt_HT",plotselection,plotlabel),
        ...
        plotClasses.Plot(ROOT.TH1D("csvdeepflavalljets","DeepFlavourCSV of all jets",44,-.1,1),"Jet_DeepFlavourCSV",plotselection,plotlabel),
...
def add_sl6j3t():
    ...
    plots63=[
        ...
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt5","p_{T} of fifth gen-jet",40,0,200),"Jet_GenJet_Pt[4]",plotselection,plotlabel),
