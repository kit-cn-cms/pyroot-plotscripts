...
def plots_ge4j_ge3t():
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Jet_CSV_1","Jet CSV[1]",30,0.0,1.0),"Jet_CSV[1]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Jet_CSV_2","Jet CSV[2]",30,0.0,1.0),"Jet_CSV[2]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Jet_CSV_3","Jet CSV[3]",30,0.0,1.0),"Jet_CSV[3]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_CSV_0","highest b-tag value",30,0.3,1.0),"CSV[0]",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_N_BTagsT","number of b-tags (tight)",6,-0.5,5.5),"N_BTagsT",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Evt_blr_ETH","b-tag likelihood ratio",30,0.0,1.0),"Evt_blr_ETH",selection,label),
        ...
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Evt_CSV_Average_Tagged","average b-tag value of tagged jets",30,0.3,1.0),"Evt_CSV_Average_Tagged",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Evt_CSV_Average","average b-tag value",30,0.3,1.0),"Evt_CSV_Average",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Evt_blr_ETH_transformed","transformed b-tag likelihood ratio",30,-6.0,12.0),"Evt_blr_ETH_transformed",selection,label),
        plotClasses.Plot(ROOT.TH1D("ge4j_ge3t_Evt_CSV_Min","min b-tag value",30,0.0,0.6),"Evt_CSV_Min",selection,label),
...
def plots_dnn(data, discrname):
    ...
    category_dict["category"] = ("((N_Jets>=4&&N_BTagsM>=3)&&(1.)&&(DNNPredictedClass_ge4j_ge3t==1))","ljets_ge4j_ge3t_tthf_node","")
    ...
    category_dict["category"] = ("((N_Jets>=4&&N_BTagsM>=3)&&(1.)&&(DNNPredictedClass_ge4j_ge3t==2))","ljets_ge4j_ge3t_ttcc_node","")
    ...
    category_dict["category"] = ("((N_Jets>=4&&N_BTagsM>=3)&&(1.)&&(DNNPredictedClass_ge4j_ge3t==3))","ljets_ge4j_ge3t_ttlf_node","")
