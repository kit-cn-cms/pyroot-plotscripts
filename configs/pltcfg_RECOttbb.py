...
samplesControlPlots=[                    
                    ...
                    plotClasses.Sample('Powheg t#bar{t}b#bar{b}-cuts',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB>1)'+sel_MET+sel_StrangeMuWeights,'tt-inclusive',systsAllSamples+systs_tt_all+systs_tt_bb+systs_ttbb_incl+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    
                    plotClasses.Sample('Powheg+OpenLoops t#bar{t}b#bar{b}-cuts',ROOT.kRed,ttbbPathPowOL,mcWeightAll+'*(GenEvt_I_TTPlusBB>1)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowOL',systsAllSamples+systs_ttbb_PowOL+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+Helac t#bar{t}b#bar{b}-cuts',ROOT.kSpring-1,ttbbPathPowHel,mcWeightAll+'*(GenEvt_I_TTPlusBB>1)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowHel',systsAllSamples+systs_ttbb_PowHel+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
