...
def plots_crossCheck(cat,selection,label):
    plots = [
        ...
        # plotClasses.TwoDimPlot(
        #     ROOT.TH2F(cat+"_crosscheck_N_BTagsM","number of B tags (orig tree vs friend tree)",6,3.5,9.5,6,3.5,9.5),
        #     "N_BTagsM","MEMDB.N_BTagsM",selection,label),
        # plotClasses.Plot(ROOT.TH1D(cat+"_ID","Evt_ID-MEMDB.Evt_ID",400,-400,400),"Evt_ID-(MEMDB.Evt_ID)",selection,label),
        # plotClasses.Plot(ROOT.TH1D(cat+"_Run","Evt_Run-MEMDB.Evt_Run",400,-400,400),"Evt_Run-(MEMDB.Evt_Run)",selection,label),
        # plotClasses.Plot(ROOT.TH1D(cat+"_Lumi","Evt_Lumi-MEMDB.Evt_Lumi",400,-400,400),"Evt_Lumi-(MEMDB.Evt_Lumi)",selection,label)
    ]
    return plots
...
def plots_control(cat,selection,label):
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_1","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[1]",selection,label),
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_2","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[2]",selection,label),
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_3","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[3]",selection,label),
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_4","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[4]",selection,label),
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_5","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[5]",selection,label),
        plotClasses.Plot(ROOT.TH1D(cat+"_Jet_Phi_6","Jet_Phi[0]",30,-3.3,3.3),"Jet_Phi[6]",selection,label),
