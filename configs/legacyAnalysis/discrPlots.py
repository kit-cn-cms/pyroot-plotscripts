...
def plots_dnn(data, discrname):
    ...
    interf_ljets_ge4j_ge4t_ttH_node.maxxval = 0.79
    interf_ljets_ge4j_ge4t_ttH_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_ge4t_ttH_node)
    
    interf_ljets_ge4j_ge4t_ttbb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_node_ttbb",
                                            label          = "ljets_ge4j_ge4t_ttbb_node",
                                            selection      = "((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t==1))")
    interf_ljets_ge4j_ge4t_ttbb_node.category = ("((N_Jets>=4&&N_BTagsM>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t==1))","ljets_ge4j_ge4t_ttbb_node","")
    interf_ljets_ge4j_ge4t_ttbb_node.category_label = "\geq 4 jets, \geq 4 b-tags"
    interf_ljets_ge4j_ge4t_ttbb_node.minxval = 0.14
    interf_ljets_ge4j_ge4t_ttbb_node.maxxval = 0.67
    interf_ljets_ge4j_ge4t_ttbb_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_ge4t_ttbb_node)
    ...
    interf_ljets_ge4j_ge4t_tt2b_node.maxxval = 0.86
    ...
    interf_ljets_ge4j_ge4t_ttcc_node.maxxval = 0.5
    ...
    interf_ljets_ge4j_ge4t_ttlf_node.maxxval = 0.7
    ...
    interf_ljets_ge4j_3t_ttH_node.maxxval = 0.75
    interf_ljets_ge4j_3t_ttH_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_3t_ttH_node)
    
    interf_ljets_ge4j_3t_ttbb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_node_ttbb",
                                            label          = "ljets_ge4j_3t_ttbb_node",
                                            selection      = "((N_Jets>=4&&N_BTagsM==3)&&(1.)&&(DNNPredictedClass_ge4j_3t==1))")
    interf_ljets_ge4j_3t_ttbb_node.category = ("((N_Jets>=4&&N_BTagsM==3)&&(1.)&&(DNNPredictedClass_ge4j_3t==1))","ljets_ge4j_3t_ttbb_node","")
    interf_ljets_ge4j_3t_ttbb_node.category_label = "\geq 4 jets, 3 b-tags"
    interf_ljets_ge4j_3t_ttbb_node.minxval = 0.14
    interf_ljets_ge4j_3t_ttbb_node.maxxval = 0.45
    interf_ljets_ge4j_3t_ttbb_node.nhistobins = ndefaultbins
    interfaces.append(interf_ljets_ge4j_3t_ttbb_node)
    ...
    interf_ljets_ge4j_3t_tt2b_node.maxxval = 0.92
    ...
    interf_ljets_ge4j_3t_ttcc_node.maxxval = 0.45
    ...
    interf_ljets_ge4j_3t_tHq_node.maxxval = 1.0
    ...
    for interf in interfaces:
        ...
        interf.histotitle = "ANN discriminator ({})".format(l)
