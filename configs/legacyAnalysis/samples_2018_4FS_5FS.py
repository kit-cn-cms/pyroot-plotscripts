...
# samples
# input path 
path  = "/nfs/dust/cms/user/vdlinden/legacyTTH/ntuples/legacy_2018_ttH"
...
TTbbSLDLweight =  "*((abs(Weight_XS-6.098641461e-05)<1e-10)"+TTbbweightDL+")"
TTbbSLDLweight += "*((abs(Weight_XS-8.5467709141e-06)<1e-10)"+TTbbweightSL+")"
