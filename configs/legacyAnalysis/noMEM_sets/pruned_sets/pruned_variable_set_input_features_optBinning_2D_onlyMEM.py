...
def plots_ge4j_ge4t_top20(data = None):
    ...
    interf_ljets_ge4j_ge4t_memDBp = vhi.variableHistoInterface(variable_name  = "memDBp",
                                            ...
                                            selection      = "(N_Jets>=4&&N_BTagsM>=4)&&(1.)")
    interf_ljets_ge4j_ge4t_memDBp.category = ("(N_Jets>=4&&N_BTagsM>=4)&&(1.)","ljets_ge4j_ge4t_memDBp","")
...
def plots_ge4j_3t_top20(data = None):
    ...
    interf_ljets_ge4j_3t_memDBp = vhi.variableHistoInterface(variable_name  = "memDBp",
                                            label          = "ljets_ge4j_3t_memDBp",
                                            selection      = "(N_Jets>=4&&N_BTagsM>=4)&&(1.)")
    interf_ljets_ge4j_3t_memDBp.category = ("(N_Jets>=4&&N_BTagsM==3)&&(1.)","ljets_ge4j_3t_memDBp","")
