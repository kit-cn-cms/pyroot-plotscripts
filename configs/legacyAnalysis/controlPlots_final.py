...
def plots_control(cat,selection,label):
    ...
    if cat == "ge4j_ge3t":
        plots += [
            ...
            plotClasses.Plot(ROOT.TH1D(cat+"_CSV_4","CSV[4]",30,0.0,1.0),"CSV[4]",selection,label),
            plotClasses.Plot(ROOT.TH1D(cat+"_CSV_5","CSV[5]",30,0.0,1.0),"CSV[5]",selection,label),
            plotClasses.Plot(ROOT.TH1D(cat+"_CSV_6","CSV[6]",30,0.0,1.0),"CSV[6]",selection,label),
