...
path_5FS_ttbar_SL = path+"/TTToSemiLeptonic_TuneCP5_PSweights*/*nominal*.root"
path_5FS_ttbar_DL = path+"/TTTo2L2Nu_TuneCP5_PSweights*/*nominal*.root"
path_5FS_ttbar_FH = path+"/TTToHadronic_TuneCP5_PSweights*/*nominal*.root"

path_ttH_bb       = path+"/ttHTobb_M125*/*nominal*.root"
path_ttH_nonbb    = path+"/ttHToNonbb_M125_TuneCP5*/*nominal*.root"
