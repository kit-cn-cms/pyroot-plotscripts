...
# samples
# input path 
path_swieland  = "/nfs/dust/cms/user/swieland/ttH_legacy/ntupleHadded_2017"

ttbarPathS = path_swieland+'/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/*nominal*.root'+';'+ \
             path_swieland+'/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/*nominal*.root'+';'+\
             path_swieland+'/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_new_pmx/*nominal*.root'

VJetsPathS = path_swieland+'/DYJets*/*nominal*.root'+';'+ \
             path_swieland+'/WJets*/*nominal*.root'

ttVPathS = path_swieland+'/TTW*/*nominal*.root'+';'+ \
           path_swieland+'/TTZToLLNuNu*/*nominal*.root'+';'+ \
           path_swieland+'/TTZToQQ*/*nominal*.root'

dibosonPathS = path_swieland+'/WW_*/*nominal*.root'+';'+ \
               path_swieland+'/WZ_*/*nominal*.root'+';'+ \
               path_swieland+'/ZZ_*/*nominal*.root'

stpath = path_swieland+'/ST_s-channel_4f_leptonDecays_TuneCP5_PSweights_13TeV-amcatnlo-pythia8_new_pmx/*nominal*.root'+';'+ \
         path_swieland+'/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8*/*nominal*.root'+';'+ \
         path_swieland+'/ST_tW_top_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8_new_pmx*/*nominal*.root'+';'+ \
         path_swieland+'/ST_t-channel_antitop_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8*/*nominal*.root'+';'+ \
         path_swieland+'/ST_t-channel_top_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8_new_pmx*/*nominal*.root'

THWpath = path_swieland+'/THW_*ctcvcp*/*nominal*.root'
THQpath = path_swieland+'/THQ_*ctcvcp*/*nominal*.root'

ttZPath  = path_swieland+'/TTZToLLNuNu*/*nominal*.root'+';'+ \
           path_swieland+'TTZToQQ_TuneCP5_13TeV-amcatnlo-pythia8_1/*nominal*.root'
...
#print "limit samples"
samples = [     ## this list needs to be adjusted??!!
    # signal samples     
    plotClasses.Sample('t#bar{t}Z(b#bar{b})',ROOT.kOrange+7,
            path_swieland+'/TTZToBB*/*nominal*.root',
    ...
    plotClasses.Sample('t#bar{t}Z(ll)', ROOT.kOrange+7,
            path_swieland+'/TTZToLLNuNu_M-10*/*nominal*.root',
            lumi+"*1.014"+evenSel+sel_MET+sel_StrangeMuWeights,
            'ttZll',
            samDict=sampleDict, readTrees=doReadTrees, typ = "signal"),
    ...
    plotClasses.Sample('Z+jets',ROOT.kGreen-3,
            path_swieland+'/DYJets*/*nominal*.root',
            lumi+evenSel+sel_MET,
            'zjets',
            samDict=sampleDict, readTrees=doReadTrees),
    ...
    plotClasses.Sample('t#bar{t}+W',ROOT.kBlue-10,
            path_swieland+'/TTW*/*nominal*.root',
...
sortedProcesses = ["ttZ", "ttH","ttlf", "ttcc", "tthf", "singlet", "misc"]
