...
samplesDataControlPlots=[
                    plotClasses.Sample('SingleMu',ROOT.kBlack,path_michael+'/SingleMuon*/*nominal*.root',sel_singlemu+sel_MET,'SingleMu',samDict=sampleDict),
                    plotClasses.Sample('SingleEl',ROOT.kBlack,path_michael+'/SingleElectron*/*nominal*.root',sel_singleel+sel_MET,'SingleEl',samDict=sampleDict)
]
...
samplesControlPlots=[
                    plotClasses.Sample('t#bar{t}H',ROOT.kBlue+1,path_michael+'/ttH*/*nominal*.root',mcWeightAll+sel_MET,'ttH',systsAllSamples,samDict=sampleDict) ,     
                    ...
                    plotClasses.Sample('Single Top',ROOT.kMagenta,path_michael+'/ST*/*nominal*.root',mcWeightAll+sel_MET,'SingleTop',systsAllSamples,samDict=sampleDict) , 
...
#print "limit samples"
samplesLimits=[
                    plotClasses.Sample('t#bar{t}H',ROOT.kBlue+1,path_michael+'/ttH*/*nominal*.root',mcWeight+evenSel+sel_MET,'ttH',systsAllSamples,samDict=sampleDict) ,     
                    plotClasses.Sample('t#bar{t}H, H to b#bar{b}',ROOT.kBlue+1,path_michael+'/ttHTobb/*nominal*.root','1.0*'+mcWeight+evenSel+sel_MET+sel_StrangeMuWeights,'ttH_hbb',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to c#bar{c}',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hccSel+sel_MET+sel_StrangeMuWeights,'ttH_hcc',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #tau#tau',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+httSel+sel_MET+sel_StrangeMuWeights,'ttH_htt',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #gamma#gamma',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hggSel+sel_MET+sel_StrangeMuWeights,'ttH_hgg',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to gluglu',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hglugluSel+sel_MET+sel_StrangeMuWeights,'ttH_hgluglu',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to WW',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hwwSel+sel_MET+sel_StrangeMuWeights,'ttH_hww',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to ZZ',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hzzSel+sel_MET+sel_StrangeMuWeights,'ttH_hzz',systsAllSamples,samDict=sampleDict) ,  
                    plotClasses.Sample('t#bar{t}H, H to #gamma Z',ROOT.kBlue+1,path_michael+'/ttHToNonbb/*nominal*.root','1.0*'+mcWeightAll+hzgSel+sel_MET+sel_StrangeMuWeights,'ttH_hzg',systsAllSamples,samDict=sampleDict) ,
                    ...
                    plotClasses.Sample('Single Top',ROOT.kMagenta,path_michael+'/ST*/*nominal*.root',mcWeightAll+sel_MET,'singlet',systsAllSamples,samDict=sampleDict) , 
                    plotClasses.Sample('Z+jets',ROOT.kGreen-3,path_michael+'/DYJets*/*nominal*.root',mcWeightAll+sel_MET,'zjets',systsAllSamples,samDict=sampleDict) , 
                    plotClasses.Sample('W+jets',ROOT.kGreen-7,path_michael+'/WJets*/*nominal*.root',mcWeightAll+sel_MET,'wjets',systsAllSamples,samDict=sampleDict) , 
                    plotClasses.Sample('t#bar{t}+W',ROOT.kBlue-10,path_michael+'/ttW_*/*nominal*.root',mcWeightAll+sel_MET,'ttbarW',systsAllSamples,samDict=sampleDict),
                    plotClasses.Sample('t#bar{t}+Z',ROOT.kBlue-6,path_michael+'/ttZ_*/*nominal*.root',mcWeightAll+sel_MET,'ttbarZ',systsAllSamples,samDict=sampleDict),
                    plotClasses.Sample('Diboson',ROOT.kAzure+2,dibosonPathS,mcWeightAll+sel_MET,'diboson',systsAllSamples,samDict=sampleDict) , 
                    #plotClasses.Sample('QCD',ROOT.kYellow,iso_inverted_paths,'1.'+sel_MET+'*internalQCDweight'+'*(((Weight_XS==1.0)*1.0*((electron_data*'+sel_singleel+')+(muon_data*'+sel_singlemu+')))+((Weight_XS!=1.0)*(-1.0)*35.91823))','QCD',[systsAllSamples[0]]+QCDSystNames,samDict=sampleDict),  
]
