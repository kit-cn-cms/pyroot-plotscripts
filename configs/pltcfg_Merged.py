...
samplesPowheg = [               
                    ...
                    plotClasses.Sample('t#bar{t}+lf',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+sel_StrangeMuWeights,'ttbarOther',systsAllSamples+systs_tt_all+systs_tt_lf+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_lf,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusCCbar',systsAllSamples+systs_tt_all+systs_tt_cc+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_cc,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg t#bar{t}+b ',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,'tt-inclusivettbarPlusB',systsAllSamples+systs_tt_all+systs_tt_bb+systs_ttbb_incl+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg t#bar{t}+2b ',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,'tt-inclusivettbarPlus2B',systsAllSamples+systs_tt_all+systs_tt_bb+systs_ttbb_incl+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg t#bar{t}+b#bar{b} ',ROOT.kBlack,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,'tt-inclusivettbarPlusBBbar',systsAllSamples+systs_tt_all+systs_tt_bb+systs_ttbb_incl+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                ]
                    
samplesPowhegOL=[
                    plotClasses.Sample('t#bar{t}+lf',ROOT.kRed,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+sel_StrangeMuWeights,'ttbarOther',systsAllSamples+systs_tt_all+systs_tt_lf+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_lf,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kRed,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusCCbar',systsAllSamples+systs_tt_all+systs_tt_cc+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_cc,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+OpenLoops t#bar{t}+b',ROOT.kRed,ttbbPathPowOL,mcWeightAll+'*1000*7.0998136282*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowOLttbarPlusB',systsAllSamples+systs_ttbb_PowOL+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+OpenLoops t#bar{t}+2b',ROOT.kRed,ttbbPathPowOL,mcWeightAll+'*1000*7.0998136282*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowOLttbarPlus2B',systsAllSamples+systs_ttbb_PowOL+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+OpenLoops t#bar{t}+b#bar{b}',ROOT.kRed,ttbbPathPowOL,mcWeightAll+'*1000*7.0998136282*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowOLttbarPlusBBbar',systsAllSamples+systs_ttbb_PowOL+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                ]
                
samplesPowHel = [
                    plotClasses.Sample('t#bar{t}+lf',ROOT.kSpring-1,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+sel_StrangeMuWeights,'ttbarOther',systsAllSamples+systs_tt_all+systs_tt_lf+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_lf,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('t#bar{t}+c#bar{c}',ROOT.kSpring-1,ttbarPathS,mcWeightAll+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+sel_StrangeMuWeights,'ttbarPlusCCbar',systsAllSamples+systs_tt_all+systs_tt_cc+systs_tt_and_ttH+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_cc,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+Helac t#bar{t}+b',ROOT.kSpring-1,ttbbPathPowHel,mcWeightAll+'*15.8627187515*(GenEvt_I_TTPlusBB==1)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowHelttbarPlusB',systsAllSamples+systs_ttbb_PowHel+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+Helac t#bar{t}+2b',ROOT.kSpring-1,ttbbPathPowHel,mcWeightAll+'*15.8627187515*(GenEvt_I_TTPlusBB==2)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowHelttbarPlus2B',systsAllSamples+systs_ttbb_PowHel+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                    plotClasses.Sample('Powheg+Helac t#bar{t}+b#bar{b}',ROOT.kSpring-1,ttbbPathPowHel,mcWeightAll+'*15.8627187515*(GenEvt_I_TTPlusBB==3)'+sel_MET+sel_StrangeMuWeights,'ttbb-PowHelttbarPlusBBbar',systsAllSamples+systs_ttbb_PowHel+hdamp_ue_filenames_tt_all+hdamp_ue_filenames_tt_bb,samDict=sampleDict, readTrees=doReadTrees),
                ]
