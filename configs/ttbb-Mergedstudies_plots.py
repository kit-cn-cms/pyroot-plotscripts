...
def add_plots():
    ...
    plotsGEN=[
        ...
        plotClasses.Plot(ROOT.TH1D("genptallbjets" ,"additional gen-b-jet p_{T}",60,0,300),"AdditionalGenBJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genbjetpt1" ,"additional gen-b-jet p_{T} of leading jet",50,0,500),"AdditionalGenBJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genbjetpt2" ,"additional gen-b-jet p_{T} of second jet",50,0,500),"AdditionalGenBJet_Pt[1]",plotselection,plotlabel),
        ...
        plotClasses.Plot(ROOT.TH1D("genptalllightjets" ,"additional light flavor gen-jet p_{T}",60,0,300),"AdditionalLightGenJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genlightjetpt1" ,"additional light flavor gen-jet p_{T} of leading jet",50,0,500),"AdditionalLightGenJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genlightjetpt2" ,"additional light flavor gen-jet p_{T} of second jet",50,0,500),"AdditionalLightGenJet_Pt[1]",plotselection,plotlabel),
        ...
        plotClasses.Plot(ROOT.TH1D("genptalljets" ,"p_{T} of all gen-jets",60,0,300),"Jet_GenJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt1","p_{T} of leading gen-jet",50,0,500),"Jet_GenJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt2","p_{T} of second gen-jet",50,0,500),"Jet_GenJet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt3","p_{T} of third gen-jet",40,0,400),"Jet_GenJet_Pt[2]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt4","p_{T} of fourth gen-jet",60,0,300),"Jet_GenJet_Pt[3]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt5","p_{T} of fifth gen-jet",40,0,200),"Jet_GenJet_Pt[4]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genjetpt6","p_{T} of sixth gen-jet",40,0,200),"Jet_GenJet_Pt[5]",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D("GenTopHad_B_E" ,"b- E [GeV] from top quark",420,0.0,4200.0),"GenTopHad_B_E",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("genetaalljets","#eta of all gen-jets",60,-2.5,2.5),"Jet_GenJet_Eta",plotselection,plotlabel),
    ...
    plots=[
        ...
        plotClasses.Plot(ROOT.TH1D("Evt_HT_Jets","Sum p_{T} reco-jets",75,0,1500),"Evt_HT_Jets",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("Evt_HT","Sum p_{T} all reco-particles",75,0,1500),"Evt_HT",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("ptalljets","p_{T} of all reco-jets",60,0,300),"Jet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("etaalljets","#eta of all reco-jets",60,-2.5,2.5),"Jet_Eta",plotselection,plotlabel),
        ...
        plotClasses.Plot(ROOT.TH1D("csvalljets","DeepCSV of all reco-jets",44,-.1,1),"Jet_CSV",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("csvdeepflavalljets","DeepFlavourCSV of all reco-jets",44,-.1,1),"Jet_DeepFlavourCSV",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("leppt","reco-lepton p_{T}",50,0,200),"LooseLepton_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("lepeta","reco-lepton #eta",50,-2.5,2.5),"LooseLepton_Eta[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("elleppt","reco-electron p_{T}",50,0,200),"Electron_Pt[0]",'Electron_Pt[0]>10',plotlabel),
        plotClasses.Plot(ROOT.TH1D("ellepeta","reco-electron #eta",50,-2.5,2.5),"Electron_Eta[0]",'Electron_Pt[0]>10',plotlabel),
        plotClasses.Plot(ROOT.TH1D("muleppt","reco-muon p_{T}",50,0,200),"Muon_Pt[0]",'Muon_Pt[0]>10',plotlabel),
        plotClasses.Plot(ROOT.TH1D("mulepeta","reco-muon #eta",50,-2.5,2.5),"Muon_Eta[0]",'Muon_Pt[0]>10',plotlabel),  
        
        plotClasses.Plot(ROOT.TH1D("ptalllightjets" ,"additional light flavor reco-jet p_{T}",60,0,300),"AdditionalLightGenJet_RecoJetPt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("lightjetpt1" ,"additional light flavor reco-jet p_{T} of leading jet",50,0,500),"AdditionalLightGenJet_RecoJetPt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("lightjetpt2" ,"additional light flavor reco-jet p_{T} of second jet",50,0,500),"AdditionalLightGenJet_RecoJetPt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("ptallbjets" ,"additional reco-b-jet p_{T}",60,0,300),"AdditionalGenBJet_RecoJetPt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("bjetpt1" ,"additional reco-b-jet p_{T} of leading jet",50,0,500),"AdditionalGenBJet_RecoJetPt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("bjetpt2" ,"additional reco-b-jet p_{T} of second jet",50,0,500),"AdditionalGenBJet_RecoJetPt[1]",plotselection,plotlabel),
    ]
    ...
    plotsAdditional=[
        ...
        plotClasses.Plot(ROOT.TH1D("jetpt1","p_{T} of leading reco-jet",50,0,500),"Jet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("jetpt2","p_{T} of second reco-jet",50,0,500),"Jet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("jetpt3","p_{T} of third reco-jet",40,0,400),"Jet_Pt[2]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("jetpt4","p_{T} of fourth reco-jet",60,0,300),"Jet_Pt[3]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("jetpt5","p_{T} of fifth reco-jet",40,0,200),"Jet_Pt[4]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D("jetpt6","p_{T} of sixth reco-jet",40,0,200),"Jet_Pt[5]",plotselection,plotlabel),
    ...
    return plotsGEN + plots + plotsAdditional
...
def add_sl6j3t():
    ...
    plotprefix="s63_"
    plots63=[
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genptallbjets" ,"additional gen-b-jet p_{T}",60,0,300),"AdditionalGenBJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genbjetpt1" ,"additional gen-b-jet p_{T} of leading jet",50,0,500),"AdditionalGenBJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genbjetpt2" ,"additional gen-b-jet p_{T} of second jet",50,0,500),"AdditionalGenBJet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genptalllightjets" ,"additional light flavor gen-jet p_{T}",60,0,300),"AdditionalLightGenJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genlightjetpt1" ,"additional light flavor gen-jet p_{T} of leading jet",50,0,500),"AdditionalLightGenJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genlightjetpt2" ,"additional light flavor gen-jet p_{T} of second jet",50,0,500),"AdditionalLightGenJet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genptalljets" ,"p_{T} of all gen-jets",60,0,300),"Jet_GenJet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt1","p_{T} of leading gen-jet",50,0,500),"Jet_GenJet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt2","p_{T} of second gen-jet",50,0,500),"Jet_GenJet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt3","p_{T} of third gen-jet",40,0,400),"Jet_GenJet_Pt[2]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt4","p_{T} of fourth gen-jet",60,0,300),"Jet_GenJet_Pt[3]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt5","p_{T} of fifth gen-",40,0,200),"Jet_GenJet_Pt[4]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genjetpt6","p_{T} of sixth gen-jet",40,0,200),"Jet_GenJet_Pt[5]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"genetaalljets","#eta of all gen-jets",60,-2.5,2.5),"Jet_GenJet_Eta",plotselection,plotlabel),
        
        
        plotClasses.Plot(ROOT.TH1D(plotprefix+"N_Jets","Number of ak4 jets",11,3.5,14.5),"N_Jets",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_HT_Jets","Sum p_{T} jets",75,0,1500),"Evt_HT_Jets",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_HT","Sum p_{T} all particles",75,0,1500),"Evt_HT",plotselection,plotlabel),
        
        plotClasses.Plot(ROOT.TH1D(plotprefix+"ptalljets","p_{T} of all reco-jets",60,0,300),"Jet_Pt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"etaalljets","#eta of all reco-jets",60,-2.5,2.5),"Jet_Eta",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt1","p_{T} of leading reco-jet",50,0,500),"Jet_Pt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt2","p_{T} of second reco-jet",50,0,500),"Jet_Pt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt3","p_{T} of third reco-jet",40,0,400),"Jet_Pt[2]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt4","p_{T} of fourth reco-jet",60,0,300),"Jet_Pt[3]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt5","p_{T} of fifth reco-jet",40,0,200),"Jet_Pt[4]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"jetpt6","p_{T} of sixth reco-jet",40,0,200),"Jet_Pt[5]",plotselection,plotlabel),
        
        plotClasses.Plot(ROOT.TH1D(plotprefix+"ptalllightjets" ,"additional light flavor reco-jet p_{T}",60,0,300),"AdditionalLightGenJet_RecoJetPt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"lightjetpt1" ,"additional light flavor reco-jet p_{T} of leading jet",50,0,500),"AdditionalLightGenJet_RecoJetPt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"lightjetpt2" ,"additional light flavor reco-jet p_{T} of second jet",50,0,500),"AdditionalLightGenJet_RecoJetPt[1]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"ptallbjets" ,"additional reco-b-jet p_{T}",60,0,300),"AdditionalGenBJet_RecoJetPt",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"bjetpt1" ,"additional reco-b-jet p_{T} of leading jet",50,0,500),"AdditionalGenBJet_RecoJetPt[0]",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"bjetpt2" ,"additional reco-b-jet p_{T} of second jet",50,0,500),"AdditionalGenBJet_RecoJetPt[1]",plotselection,plotlabel),
        
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_Jet_MaxDeta_Jets","max #Delta #eta (jet,jet)",50,0.,5.0),"Evt_Jet_MaxDeta_Jets",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_TaggedJet_MaxDeta_Jets","max #Delta #eta (tag,jet)",50,0.,5.0),"Evt_TaggedJet_MaxDeta_Jets",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_TaggedJet_MaxDeta_TaggedJets","max #Delta #eta (tag,tag)",60,0.,6.0),"Evt_TaggedJet_MaxDeta_TaggedJets",plotselection,plotlabel),
        
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Sphericity","Sphericity",50,0,1),"Evt_Sphericity",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Aplanarity","Aplanarity",50,0,0.5),"Evt_Aplanarity",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_Deta_UntaggedJetsAverage","avg. #Delta #eta of untagged jets",50,0.,4.5),"Evt_Deta_UntaggedJetsAverage",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_Deta_TaggedJetsAverage","avg. #Delta #eta of tagged jets",50,0.,4.5),"Evt_Deta_TaggedJetsAverage",plotselection,plotlabel),###plotClasses.Plot(ROOT.TH1D(plotprefix+"BDT_common5_input_Evt_CSV_Average","BDT_common5_input_Evt_CSV_Average",30,0.6,1.0),"BDT_common5_input_Evt_CSV_Average",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D(plotprefix+"MEM","MEM",30,0.0,1.0),memexp,plotselection,plotlabel),
    ]
...
def add_sl6j4t():
    ...
    plots64=[
        ...
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Aplanarity","Aplanarity",50,0,0.5),"Evt_Aplanarity",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_Deta_UntaggedJetsAverage","avg. #Delta #eta of untagged jets",50,0.,4.5),"Evt_Deta_UntaggedJetsAverage",plotselection,plotlabel),
        plotClasses.Plot(ROOT.TH1D(plotprefix+"Evt_Deta_TaggedJetsAverage","avg. #Delta #eta of tagged jets",50,0.,4.5),"Evt_Deta_TaggedJetsAverage",plotselection,plotlabel),
        # ~ plotClasses.Plot(ROOT.TH1D(plotprefix+"MEM","MEM",20,0.0,1.0),memexp,plotselection,plotlabel),
    ]
