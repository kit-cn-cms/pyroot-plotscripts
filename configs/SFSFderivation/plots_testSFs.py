...
def plots_control(data = None):
    selection = "(N_LooseLeptons==1&&N_TightLeptons==1&&N_Jets>=4&&N_BTagsM>=3)"
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("Jet_Eta","Jet_Eta",50,-2.5,2.5),"Jet_Eta",selection,label),
    ...
    plots+= [
        ...
        plotClasses.Plot(ROOT.TH1D("inclusive_Jet_Eta","Jet_Eta",50,-2.5,2.5),"Jet_Eta",selection,label),
