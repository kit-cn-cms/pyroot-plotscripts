...
defaultWeight = "Weight_GEN_nom*internalCSVweight*sf_N_Jets__btag_NOMINAL"
...
plottingsamples = [
    plotClasses.Sample("t#bar{t}+bb (4FS)", ROOT.kRed+3, "", "",
        "ttbb", addsamples = ["ttbb_4FS_SL","ttbb_4FS_DL", "ttbb_4FS_FH"],
        samDict = sampleDict, readTrees = doReadTrees),
    plotClasses.Sample("t#bar{t}+cc", ROOT.kRed+1, "", "",
        "ttcc", addsamples = ["ttcc_SL","ttcc_DL", "ttcc_FH"],
        samDict = sampleDict, readTrees = doReadTrees),
    plotClasses.Sample("t#bar{t}+lf", ROOT.kRed-7, "", "",
        "ttlf", addsamples = ["ttlf_SL","ttlf_DL", "ttlf_FH"],
        samDict = sampleDict, readTrees = doReadTrees),
    plotClasses.Sample("t#bar{t}+H", ROOT.kBlue+1, "", "",
        "ttH", addsamples = ["ttH_bb","ttH_nonbb"],
        samDict = sampleDict, readTrees = doReadTrees),
