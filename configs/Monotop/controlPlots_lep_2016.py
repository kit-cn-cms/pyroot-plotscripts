...
def control_plots_lep_CR_ttbarlep(data=None):
    ...
    selection += "*((N_LooseMuons==1 && N_TightMuons==1 && N_LooseElectrons==0 && (Triggered_HLT_IsoMu24_vX==1 || Triggered_HLT_IsoTkMu24_vX==1)) || (N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && (Triggered_HLT_Ele27_WPTight_Gsf_vX==1 || Triggered_HLT_Photon175_vX==1)))"
