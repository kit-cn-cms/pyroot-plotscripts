...
def control_plots_had_CR_ZElEl(data=None):
    ...
    selection += "*(Triggered_HLT_Ele27_WPTight_Gsf_vX==1)"
...
def control_plots_had_CR_ttbarlep(data=None):
    ...
    selection = generalselection
    selection += "*((N_LooseMuons==1 && N_TightMuons==1 && N_LooseElectrons==0 && ((Triggered_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_vX == 1) || (Triggered_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_vX == 1))) || (N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && (Triggered_HLT_Ele27_WPTight_Gsf_vX==1)))"
...
def control_plots_had_CR_Wlep(data=None):
    ...
    selection = generalselection
    selection += "*((N_LooseMuons==1 && N_TightMuons==1 && N_LooseElectrons==0 && ((Triggered_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_vX == 1) || (Triggered_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_vX == 1))) || (N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && (Triggered_HLT_Ele27_WPTight_Gsf_vX==1) && Evt_Pt_MET>50.))"
    selection += "*(N_LoosePhotons==0)"
    selection += "*(N_AK4JetsLooseTagged_outside_AK15Jets==0)"
    #selection += "*((AK15Jet_DeepAK15_probTbqq[0]+AK15Jet_DeepAK15_probTbcq[0])>0.5)
