...
def control_plots_lep_CR_ttbarEl(data=None):
    ...
    selection += "*(N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && Electron_Pt[0]>37. && (Triggered_HLT_Ele35_WPTight_Gsf_vX==1 || Triggered_HLT_Photon200_vX==1))"
    ...
    plots = [
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "DeltaPhi_AK4Jet_MET_0" + extension, "#Delta#phi(AK4 Jet 0, #slash{E}_{T})", 30, 0.0, 3.14
            ),
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "DeltaPhi_AK4Jet_MET_1" + extension, "#Delta#phi(AK4 Jet 1, #slash{E}_{T})", 30, 0.0, 3.14
            ),
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "DeltaPhi_AK4Jet_MET_2" + extension, "#Delta#phi(AK4 Jet 2, #slash{E}_{T})", 30, 0.0, 3.14
            ),
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "Electron_Pt" + extension, "Tight Electron p_{T} [GeV]", 20, 10.0, 410.0
            ),
            "Electron_Pt",
            selection,
            label,
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "DeltaPhi_LooseElectron_MET" + extension, "#Delta#phi(e, #slash{E}_{T})", 30, 0.0, 3.14
            ),
...
def control_plots_lep_CR_ttbarMu(data=None):
    ...
    plots = [
        ...
        #),
        plotClasses.Plot(
            ROOT.TH1D("Muon_Pt" + extension, "Tight Muon p_{T} [GeV]", 20, 10.0, 410.0),
            "Muon_Pt",
            selection,
            label,
        ),
        ...
        plotClasses.Plot(
            ROOT.TH1D(
                "DeltaPhi_LooseMuon_MET" + extension, "#Delta#phi(#mu, #slash{E}_{T})", 30, 0.0, 3.14
            ),
