...
generalselection = "(N_AK15Jets==1)*(Hadr_Recoil_Pt>250.)*(DeltaPhi_AK15Jet_MET[0]>1.5)*(AK15Jet_Pt[0]>=200.)"
...
def control_plots_had_CR_ttbarEl(data=None):
    ...
    selection = generalselection
    selection += "*(N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && (Triggered_HLT_Ele32_WPTight_Gsf_vX_2017==1 || Triggered_HLT_Photon200_vX==1))"
...
def control_plots_had_CR_WEl(data=None):
    ...
    selection = generalselection
    selection += "*(N_LooseElectrons==1 && N_TightElectrons==1 && N_LooseMuons==0 && (Triggered_HLT_Ele32_WPTight_Gsf_vX_2017==1 || Triggered_HLT_Photon200_vX==1) && Evt_Pt_MET>50.)"
    selection += "*(N_LoosePhotons==0)"
    selection += "*(N_AK4JetsLooseTagged_outside_AK15Jets==0)"
    #selection += "*((AK15Jet_DeepAK15_probTbqq[0]+AK15Jet_DeepAK15_probTbcq[0])>0.5)
