...
def control_plots_had_CR_ZMuMu(data=None):
    ...
    plots = [
        ...
        plotClasses.Plot(
            ROOT.TH1D("Evt_Pt_MET" + extension, "#slash{E}_{T} [GeV]", 20, 0.0, 200.0),
            "Evt_Pt_MET",
            selection,
            label,
        ),
...
def control_plots_had_CR_ZElEl(data=None):
    ...
    selection = generalselection
    selection += "*(N_LooseElectrons==2 && N_TightElectrons>=1 && N_LooseMuons==0 && N_LoosePhotons==0 && Electron_Pt[0]>37.)"
    selection += "*(Triggered_HLT_Ele35_WPTight_Gsf_vX==1 || Triggered_HLT_Photon200_vX==1)"
...
def control_plots_had_CR_ttbarHad(data=None):
    label = "#scale[0.8]{t#bar{t} control region (had)}"
