...
def plots_dnn(data, discrname):
    ...
    categories += [
        ...
        ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==1)","ljets_le5j_3t_tthf_node",""),
        ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==2)","ljets_le5j_3t_ttcc_node",""),
        ("((N_Jets<=5&&N_BTagsM==3)&&DNNPredictedClass_le5j_3t==3)","ljets_le5j_3t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_le5j_3t_node_ttH",
        "DNNOutput_le5j_3t_node_tthf",
    ...
    categories += [
        ...
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==1)","ljets_le5j_ge3t_tthf_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==2)","ljets_le5j_ge3t_ttcc_node",""),
        ("((N_Jets<=5&&N_BTagsM>=3)&&DNNPredictedClass_le5j_ge3t==3)","ljets_le5j_ge3t_ttlf_node",""),
        ]
    discrs += [
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==1)","ljets_ge4j_3t_tthf_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==2)","ljets_ge4j_3t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM==3)&&DNNPredictedClass_ge4j_3t==3)","ljets_ge4j_3t_ttlf_node",""),
        ]
    discrs += [
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==1)","ljets_ge4j_ge4t_tthf_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==2)","ljets_ge4j_ge4t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM>=4)&&DNNPredictedClass_ge4j_ge4t==3)","ljets_ge4j_ge4t_ttlf_node",""),
        ]
    discrs += [
    ...
    categories += [
        ...
        ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==1)","ljets_le5j_ge4t_tthf_node",""),
        ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==2)","ljets_le5j_ge4t_ttcc_node",""),
        ("((N_Jets<=5&&N_BTagsM>=4)&&DNNPredictedClass_le5j_ge4t==3)","ljets_le5j_ge4t_ttlf_node",""),
        ]
    discrs += [
        "DNNOutput_le5j_ge4t_node_ttH",
        "DNNOutput_le5j_ge4t_node_tthf",
        "DNNOutput_le5j_ge4t_node_ttcc",
        "DNNOutput_le5j_ge4t_node_ttlf",
        ]
    nhistobins += [ndefaultbins, ndefaultbins, ndefaultbins, ndefaultbins]
    minxvals += [0.25, 0.25, 0.25, 0.25]
    maxxvals += [0.92, 0.74, 0.47, 0.63]
    ...
    categories += [
        ...
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==1)","ljets_ge4j_ge3t_tthf_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==2)","ljets_ge4j_ge3t_ttcc_node",""),
        ("((N_Jets>=4&&N_BTagsM>=3)&&DNNPredictedClass_ge4j_ge3t==3)","ljets_ge4j_ge3t_ttlf_node",""),
        ]
    discrs += [
