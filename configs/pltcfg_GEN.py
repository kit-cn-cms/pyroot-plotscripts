...
sel_singleel="*1.0" # need to veto muon events in electron dataset to avoid double countung
...
# samples
# input path 
path_ttbbdata="/nfs/dust/cms/user/mhorzela/ttbb_data/ntuples"
ttbarPathS=path_ttbbdata+'TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_new_pmx/*nominal*.root'
ttbbPathPowOL=path_ttbbdata+'TTbb_Powheg_Openloops_new_pmx/*nominal*.root'
ttbbPathPowHel=path_ttbbdata+'TTbb_Powheg_Helac_new_pmx/*nominal*.root'
