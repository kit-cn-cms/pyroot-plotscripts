...
def plots_ge4j_ge3t_classifier(data = None):
    ...
    plots = [
        ...
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Evt_CSV_avg_tagged","Evt_CSV_avg_tagged",50,0.3,1.0),"Evt_CSV_avg_tagged",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Jet_Pt_0","Jet_Pt_0",50,0.0,500.0),"Jet_Pt[0]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Jet_Pt_1","Jet_Pt_1",50,0.0,500.0),"Jet_Pt[1]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Jet_Pt_2","Jet_Pt_2",50,0.0,500.0),"Jet_Pt[2]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_TaggedJet_Pt_0","TaggedJet_Pt_0",50,0.0,500.0),"TaggedJet_Pt[0]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_TaggedJet_Pt_1","TaggedJet_Pt_1",50,0.0,500.0),"TaggedJet_Pt[1]",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_TaggedJet_Pt_2","TaggedJet_Pt_2",50,0.0,500.0),"TaggedJet_Pt[2]",selection,label),

        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Evt_Deta_JetsAverage","Evt_Deta_JetsAverage",50,0.0,3.0),"Evt_Deta_JetsAverage",selection,label),
        plotClasses.Plot(ROOT.TH1D("ljets_ge4j_ge3t_classifier_Evt_Deta_TaggedJetsAverage","Evt_Deta_TaggedJetsAverage",50,0.0,3.0),"Evt_Deta_TaggedJetsAverage",selection,label)
        ]
    if data:
...
def plots_ge4j_ge4t_classifier(data = None):
    ...
    interfaces = []
    selection = "(N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)"
...
def plots_dnn(data, discrname):
    ...
    interf_ljets_ge4j_ge4t_classifier_ttH_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_ttH",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_classifier_ttH_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_classifier_ttH_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_ttmb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_ttmb",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==1))")
    interf_ljets_ge4j_ge4t_classifier_ttmb_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==1))","ljets_ge4j_ge4t_classifier_ttmb_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_tt2b_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_tt2b",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==2))")
    interf_ljets_ge4j_ge4t_classifier_tt2b_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==2))","ljets_ge4j_ge4t_classifier_tt2b_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_ttcc_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_ttcc",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==3))")
    interf_ljets_ge4j_ge4t_classifier_ttcc_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==3))","ljets_ge4j_ge4t_classifier_ttcc_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_ttlf_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_ttlf",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==4))")
    interf_ljets_ge4j_ge4t_classifier_ttlf_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==4))","ljets_ge4j_ge4t_classifier_ttlf_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_tHq_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_tHq",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==5))")
    interf_ljets_ge4j_ge4t_classifier_tHq_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==5))","ljets_ge4j_ge4t_classifier_tHq_node","")
    ...
    interf_ljets_ge4j_ge4t_classifier_tHW_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_classifier_node_tHW",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==6))")
    interf_ljets_ge4j_ge4t_classifier_tHW_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_classifier==6))","ljets_ge4j_ge4t_classifier_tHW_node","")
    ...
    interf_ljets_ge4j_3t_classifier_ttH_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_ttH",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_classifier_ttH_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_classifier_ttH_node","")
    ...
    interf_ljets_ge4j_3t_classifier_ttmb_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_ttmb",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==1))")
    interf_ljets_ge4j_3t_classifier_ttmb_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==1))","ljets_ge4j_3t_classifier_ttmb_node","")
    ...
    interf_ljets_ge4j_3t_classifier_tt2b_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_tt2b",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==2))")
    interf_ljets_ge4j_3t_classifier_tt2b_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==2))","ljets_ge4j_3t_classifier_tt2b_node","")
    ...
    interf_ljets_ge4j_3t_classifier_ttcc_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_ttcc",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==3))")
    interf_ljets_ge4j_3t_classifier_ttcc_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==3))","ljets_ge4j_3t_classifier_ttcc_node","")
    ...
    interf_ljets_ge4j_3t_classifier_ttlf_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_ttlf",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==4))")
    interf_ljets_ge4j_3t_classifier_ttlf_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==4))","ljets_ge4j_3t_classifier_ttlf_node","")
    ...
    interf_ljets_ge4j_3t_classifier_tHq_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_tHq",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==5))")
    interf_ljets_ge4j_3t_classifier_tHq_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==5))","ljets_ge4j_3t_classifier_tHq_node","")
    ...
    interf_ljets_ge4j_3t_classifier_tHW_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_classifier_node_tHW",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==6))")
    interf_ljets_ge4j_3t_classifier_tHW_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_classifier==6))","ljets_ge4j_3t_classifier_tHW_node","")
...
def plots_STXS(data, discrname):
    ...
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_0_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_STXS_node_ttHbb_STXS_0",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==0)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_0_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==0)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_STXS_ttHbb_STXS_0_node","")
    ...
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_1_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_STXS_node_ttHbb_STXS_1",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==1)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_1_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==1)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_STXS_ttHbb_STXS_1_node","")
    ...
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_2_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_STXS_node_ttHbb_STXS_2",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==2)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_2_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==2)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_STXS_ttHbb_STXS_2_node","")
    ...
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_3_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_STXS_node_ttHbb_STXS_3",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==3)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_3_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==3)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_STXS_ttHbb_STXS_3_node","")
    ...
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_4_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_3t_STXS_node_ttHbb_STXS_4",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==4)&&(DNNPredictedClass_ge4j_3t_classifier==0))")
    interf_ljets_ge4j_3t_STXS_ttHbb_STXS_4_node.category = ("((N_Jets>=4&&int(N_BTagsM)==3)&&(1.)&&(DNNPredictedClass_ge4j_3t_STXS==4)&&(DNNPredictedClass_ge4j_3t_classifier==0))","ljets_ge4j_3t_STXS_ttHbb_STXS_4_node","")
   ...
   # plots for ge4j_ge4t_STXS
    ...
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_0_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_STXS_node_ttHbb_STXS_0",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==0)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_0_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==0)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_STXS_ttHbb_STXS_0_node","")
    ...
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_1_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_STXS_node_ttHbb_STXS_1",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==1)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_1_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==1)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_STXS_ttHbb_STXS_1_node","")
    ...
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_2_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_STXS_node_ttHbb_STXS_2",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==2)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_2_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==2)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_STXS_ttHbb_STXS_2_node","")
    ...
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_3_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_STXS_node_ttHbb_STXS_3",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==3)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_3_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==3)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_STXS_ttHbb_STXS_3_node","")
    ...
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_4_node = vhi.variableHistoInterface(variable_name  = "DNNOutput_ge4j_ge4t_STXS_node_ttHbb_STXS_4",
                                            ...
                                            selection      = "((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==4)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))")
    interf_ljets_ge4j_ge4t_STXS_ttHbb_STXS_4_node.category = ("((N_Jets>=4&&int(N_BTagsM)>=4)&&(1.)&&(DNNPredictedClass_ge4j_ge4t_STXS==4)&&(DNNPredictedClass_ge4j_ge4t_classifier==0))","ljets_ge4j_ge4t_STXS_ttHbb_STXS_4_node","")
...
def getDiscriminatorPlots(data = None, discrname = ''):
    discriminatorPlots = []
    discriminatorPlots += plots_ge4j_ge3t_classifier(data)
