...
ExSystNames = ["NUI_CMS_btag_lf",
"NUI_CMS_btag_hf",
"NUI_CMS_btag_hfDown",
"NUI_CMS_btag_hfstats1",
"NUI_CMS_btag_lfstats1",
"NUI_CMS_btag_hfstats2",
"NUI_CMS_btag_lfstats2",
"NUI_CMS_btag_cferr1",
"NUI_CMS_btag_cferr2",
"NUI_Weight_PU",
"NUI_CMS_scale_j",
...
#    print name
	...
	for fit_name, nuis_x in [('b', nuis_b), ('s',nuis_s)]:
		...
		if nuis_p != None:
			if options.plotfile: 
				if fit_name=='b':
					nuisanceVal=nuis_x.getVal()
					if name in ExSystNames:
						nuisanceVal*=-1                
					nuis_p_i+=1
					hist_fit_b.SetBinContent(nuis_p_i,nuisanceVal)
				...
				if fit_name=='s':
					...
					if name in ExSystNames:
						nuisanceVal*=-1
					hist_fit_s.SetBinContent(nuis_p_i,nuisanceVal)
...
if options.plotfile:
	...
	canvas_nuis.SetBottomMargin(canvas_nuis.GetBottomMargin()*2.5)
	...
	hist_prefit.GetXaxis().SetLabelSize(0.025)
	hist_prefit.GetXaxis().LabelsOption("v")
	# hist_prefit.GetXaxis().SetTitleOffset(0)
	hist_prefit.Draw("E2")
