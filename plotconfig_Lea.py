...
#print "limit samples"
samplesLimits=[
                    Sample('t#bar{t}H',ROOT.kBlue+1,path_lea+'/ttH*/*nominal*.root',mcWeight+evenSel+sel_MET+corrFactor_posneg_ttHbb+corrFactor_posneg_ttHnonbb+evenWeight_ttH,'ttH',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,     
#                    Sample('t#bar{t}',ROOT.kRed+1,path_80x+'/ttbar/*nominal*.root',mcWeight+evenSel,'ttbar',samDict=sampleDict, readTrees=doReadInTrees) ,     
                    Sample('t#bar{t}H, H to b#bar{b}',ROOT.kBlue+1,path_lea+'/ttHbb/*nominal*.root','1.0*'+mcWeight+evenSel+sel_MET+corrFactor_posneg_ttHbb+evenWeight_ttH_hbb,'ttH_hbb',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to c#bar{c}',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hccSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hcc',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to #tau#tau',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+httSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_htt',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to #gamma#gamma',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hggSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hgg',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to gluglu',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hglugluSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hgluglu',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to WW',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hwwSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hww',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to ZZ',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hzzSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hzz',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,  
                    Sample('t#bar{t}H, H to #gamma Z',ROOT.kBlue+1,path_lea+'/ttHnonbb/*nominal*.root','1.0*'+mcWeightAll+hzgSel+sel_MET+corrFactor_posneg_ttHnonbb,'ttH_hzg',systsAllSamples,samDict=sampleDict, readTrees=doReadInTrees) ,
                    
                    Sample('t#bar{t}+lf',ROOT.kRed-7,path_lea+'/TTTo*/*nominal*.root',mcWeight+evenSel+'*(GenEvt_I_TTPlusCC==0&&GenEvt_I_TTPlusBB==0)'+sel_MET+evenWeight_ttbarOther,'ttbarOther',systsAllSamples+systsTtbar+systs_tt_lf,samDict=sampleDict, readTrees=doReadInTrees),
                    Sample('t#bar{t}+c#bar{c}',ROOT.kRed+1,path_lea+'/TTTo*/*nominal*.root',mcWeight+evenSel+'*(GenEvt_I_TTPlusCC==1)'+sel_MET+evenWeight_ttbarPlusCCbar,'ttbarPlusCCbar',systsAllSamples+systsTtbar+systs_tt_cc,samDict=sampleDict, readTrees=doReadInTrees),
                    Sample('t#bar{t}+b',ROOT.kRed-2,path_lea+'/TTTo*/*nominal*.root',mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==1)'+sel_MET+evenWeight_ttbarPlusB,'ttbarPlusB',systsAllSamples+systsTtbar+systs_tt_b,samDict=sampleDict, readTrees=doReadInTrees),
                    Sample('t#bar{t}+2b',ROOT.kRed+2,path_lea+'/TTTo*/*nominal*.root',mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==2)'+sel_MET+evenWeight_ttbarPlus2B,'ttbarPlus2B',systsAllSamples+systsTtbar+systs_tt_2b,samDict=sampleDict, readTrees=doReadInTrees),
                    Sample('t#bar{t}+b#bar{b}',ROOT.kRed+3,path_lea+'/TTTo*/*nominal*.root',mcWeight+evenSel+'*(GenEvt_I_TTPlusBB==3)'+sel_MET+evenWeight_ttbarPlusBBbar,'ttbarPlusBBbar',systsAllSamples+systsTtbar+systs_tt_bb,samDict=sampleDict, readTrees=doReadInTrees), 
