...
class Variables:
  ...
  def calculateVarsProgram(self):
    ...
    while allVariablesHandled==False:
      #print'rawVariableList', rawVariableList, ' size ', len(rawVariableList)
      #print'sortedVariableList', sortedVariableList, ' size ', len(sortedVariableList)
      #raw_input()
      variableCounter+=1
	...
	if name in zip(*sortedVariableList)[0]:
	  ...
	  print 'continue0, already have variable '+name
	  continue
	...
	print 'continue3'
	continue
      #print 'alldependenciesresovled'
      alldependenciesresovled=True
      #print zip(*rawVariableList)[0]
      #print zip(*sortedVariableList)
