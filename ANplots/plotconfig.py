...
usualweights="(1*Weight_PU*((Weight>0)-(Weight<0)))"
...
systweights=[
                    "NomWeight:="+usualweights+"*(DoWeights==1)+(DoWeights==0)*1.0",
...
samples_data_controlplots=[
                    Sample('SingleMu',ROOT.kBlack,path_76x+'/mu_*/*nominal*.root',sel_singlemu,'SingleMu'),
...
samplesControlPlots=[
                    Sample('t#bar{t}H',ROOT.kBlue+1,path_76x+'/ttH*/*nominal*.root',mcweight,'ttH',systs_all_samples) ,     
#                    Sample('t#bar{t}',ROOT.kRed+1,path_76x+'/ttbar/*nominal*.root',mcweight,'ttbar',systs_all_samples) ,     
