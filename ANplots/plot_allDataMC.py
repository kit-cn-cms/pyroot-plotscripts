...
plotplotlabelboosted="#splitline{1 lepton, #geq 4 jets, #geq 2 b-tags}{#geq 1 C/A 1.5 jet p_{T} > 200 GeV}"
...
plots=[
        ...
        Plot(ROOT.TH1F("JTB" ,"jet-tag + boosted categories",len(categoriesJTB),0.5,0.5+len(categoriesJTB)),catstringJTB,categoriesJTBsel,"1 lepton"),
...
#        Plot(ROOT.TH1F("elleppt","electron p_{T}",50,0,200),"Electron_Pt[0]",'Electron_Pt>10',plotlabel),
#        Plot(ROOT.TH1F("ellepeta","electron #eta",50,-2.5,2.5),"Electron_Eta[0]",'Electron_Pt>10',plotlabel),
#        Plot(ROOT.TH1F("muleppt","muon p_{T}",50,0,200),"Muon_Pt[0]",'Muon_Pt>10',plotlabel),
#        Plot(ROOT.TH1F("mulepeta","muon #eta",50,-2.5,2.5),"Muon_Eta[0]",'Muon_Pt>10',plotlabel),
#
...
##        Plot(ROOT.TH1F("BJN_N_AvgIp3D","Avg 3D IP",40,0,0.08),"BJN_N_AvgIp3D",plotselection,plotlabel),
##        Plot(ROOT.TH1F("BJN_N_AvgIp3Dsig","Avg 3D IP significance",30,0,15),"BJN_N_AvgIp3Dsig",plotselection,plotlabel),
...
#
##        Plot(ROOT.TH1F("Evt_H0","",40,0.5,4.5),"Evt_H0",plotselection,plotlabel),
...
plotselection=categoriesJTB[1][0]
plotprefix="s43_"
plots43=[
...
plotselection=categoriesJTB[4][0]
plotprefix="s44_"
...
plotselection=categoriesJTB[2][0]
plotprefix="s53_"
plots53=[
...
plotselection=categoriesJTB[5][0]
plotprefix="s54_"
plots54=[
...
plotselection=categoriesJTB[0][0]
plotprefix="s62_"
plots62=[
#        Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_second_jet_pt","jet 2 p_{T}",20,0,300),"BDT_common5_input_second_jet_pt",plotselection,plotlabel),
...
plotselection=categoriesJTB[3][0]
plotprefix="s63_"
plots63=[
          Plot(ROOT.TH1F(plotprefix+"MEM_transformed","MEM discriminator",20,0.,1),"(MEM_p>=0.0)*(MEM_p_sig/(MEM_p_sig+0.15*MEM_p_bkg))+(MEM_p<0.0)*(0.01)",plotselection,plotlabel),
...
plotselection=categoriesJTB[6][0]
plotprefix="s64"
plots64=[
...
print name,2000000,plots,samples+samples_data+systsamples,[''],['1.'],weightsystnames, systweights
...
listOfcustomBinLabels=[categoriesJTlist,categoriesJTBlist,categoriesSplitByBDToptDlist]               
