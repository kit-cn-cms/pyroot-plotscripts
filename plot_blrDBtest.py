...
plots=[
        ...
        Plot(ROOT.TH1F("blrFromTree","B-tagging likelihood ratio",30,-10,10),"Evt_blr_ETH_transformed",plotselection,plotlabel),
        #Plot(ROOT.TH1F("blrFromDataBase","B-tagging likelihood ratio",30,-10,10),"blrDBn_perm_sig",plotselection,plotlabel),
        Plot(ROOT.TH1F("blrFromDataBase","B-tagging likelihood ratio",30,-10,10),"Evt_blr_ETH_transformed",plotselection,plotlabel),
