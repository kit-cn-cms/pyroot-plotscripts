...
name='controlplotsAnalysisV6Test2'
...
plotprefix="s43_"
plots43=[
        Plot(ROOT.TH1F(plotprefix+"MEM_transformed","MEM discriminator",30,0,1.2),"(memDBp>0.0)*(memDBp_sig/(memDBp_sig+0.15*memDBp_bkg))+(memDBp<0.0)*(0.01)",plotselection,plotlabel),
    ...
    #Plot(ROOT.TH1F(plotprefix+"s43_BJN_N_Leptons","Number of soft leptons",6,-.5,5.5),"BJN_N_Leptons",plotselection,plotlabel),
...
plots44=[
    Plot(ROOT.TH1F(plotprefix+"MEM_transformed","MEM discriminator",10,0,1.2),"(memDBp>0.0)*(memDBp_sig/(memDBp_sig+0.15*memDBp_bkg))+(memDBp<0.0)*(0.01)",plotselection,plotlabel),
...
plots54=[
  Plot(ROOT.TH1F(plotprefix+"MEM_transformed","MEM discriminator",10,0,1.2),"(memDBp>0.0)*(memDBp_sig/(memDBp_sig+0.15*memDBp_bkg))+(memDBp<0.0)*(0.01)",plotselection,plotlabel),
    ...
    ##Plot(ROOT.TH1F(plotprefix+"BDT_common5_input_h0","H_{0}",10,0.2,0.5),"BDT_common5_input_h0",plotselection,plotlabel),
