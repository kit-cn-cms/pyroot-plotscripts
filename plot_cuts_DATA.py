...
if WWP=='medium':
    ...
    if radi=='CHSPruning':
            ...
            #MCSF_JetMassScale=" 1.0*(smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[0] "
            #MCSF_JetMassScale_up= " (1.0+0.023)*(smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[0] "
            #MCSF_JetMassScale_down= " (1.0-0.023)*(smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[0] "
            
            #MCSF_JetMassRes=" (smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[0] "
            #MCSF_JetMassScale_up= " (smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[1] "
            #MCSF_JetMassScale_down= " (smearWmassfactor(Ws_ABCD"+radi+"_MSD[i],Ws_ABCD"+radi+"_Phi[i],Ws_ABCD"+radi+"_Eta[i]))[2] "        
...
if WZwindow:
   ...
   plotselection_W_MSD =  " (60 < Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 < 115) "
   plotselection_W_MSD_i =  " (60 < Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] < 115) "
   plotselection_W_MSD_0 =  " (60 < Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] < 115) "
   if not MSDgap:
	plotselection_W_MSD_anti =  " (60 > Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  ||   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 > 115) "
        plotselection_W_MSD_anti_i =  " (60 > Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  ||   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] > 115) "
        plotselection_W_MSD_anti_0 =  " (60 > Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  ||   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] > 115) "
   else:
        plotselection_W_MSD_anti =  " (60 > Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  ||   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 > 150) "
        plotselection_W_MSD_anti_i =  " (60 > Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  ||   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] > 150) "
        plotselection_W_MSD_anti_0 =  " (60 > Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  ||   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] > 150) "
	

else:
   plotselection_W_MSD =  " (65 < Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 < 105) "
   plotselection_W_MSD_i =  " (65 < Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] < 105) "
   plotselection_W_MSD_0 =  " (65 < Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] < 105) "
   

   
      
   if not MSDgap:
        plotselection_W_MSD_anti =  " (65 > Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  ||   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 > 105) "
        plotselection_W_MSD_anti_i =  " (65 > Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  ||   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] > 105) "
        plotselection_W_MSD_anti_0 =  " (65 > Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  ||   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] > 105) "
        

                
   else:
        plotselection_W_MSD_anti =  " (65 > Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  ||   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 > 150) "
        plotselection_W_MSD_anti_i =  " (65 > Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  ||   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] > 150) "
        plotselection_W_MSD_anti_0 =  " (65 > Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  ||   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] > 150) "
...
if not MSDgap:
	plotselection2=plotselection1 + " && (40 < Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300) "
	plotselection2_i=plotselection1_i + " && (40 < Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD[i] &&   Tops_ABCD"+radi+"_MSD[i]< 300) "
	plotselection2_0=plotselection1_0 + " && (40 < Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD[0] &&   Tops_ABCD"+radi+"_MSD[0]< 300) "

	
	
	
else:
	plotselection2=plotselection1 + " && (40 < Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3  &&   Ws_ABCD"+radi+"_MSD*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3 < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 500) "
        plotselection2_i=plotselection1_i + " && (40 < Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i]  &&   Ws_ABCD"+radi+"_MSD[i]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[i] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[i] &&   Tops_ABCD"+radi+"_MSD[i]< 500) "
        plotselection2_0=plotselection1_0 + " && (40 < Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0]  &&   Ws_ABCD"+radi+"_MSD[0]*"+MCSF_JetMassScale+"*Ws_ABCD"+radi+"_corrL2L3[0] < 500) " + " && (40 < Tops_ABCD"+radi+"_MSD[0] &&   Tops_ABCD"+radi+"_MSD[0]< 500) "
