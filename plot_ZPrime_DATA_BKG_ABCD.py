...
from plotconfig_DATA_BKG import *
...
name='Zprime_DATA_BKG_'+ABCDeventhandling+'_'+ABCDversion+radi+'_'+WPs
...
outputpath=plotParallel(name,2000000,plots,BackgroundSamples+DataSamples+systsamples,[""],["1"],allweightsystnames,allsystweights,additionalvariables,additionalfunctions,additionalobjectsfromaddtionalrootfile,OnlyFirstList,otherSystNames)
