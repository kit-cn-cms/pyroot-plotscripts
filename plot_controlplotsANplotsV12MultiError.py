...
plots=[
    ...
    #Plot(ROOT.TH1F("RECO__lab__cos_theta_lb","RECO__lab__cos_theta_lb",22,-.1,1),"RECO__lab__cos_theta_lb",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__cos_theta_lbarbbar","RECO__lab__cos_theta_lbarbbar",22,-.1,1),"RECO__lab__cos_theta_lbarbbar",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Eta_bb","RECO__lab__Delta_Eta_bb",22,-.1,5),"RECO__lab__Delta_Eta_bb",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Eta_lb","RECO__lab__Delta_Eta_lb",22,-.1,5),"RECO__lab__Delta_Eta_lb",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Eta_lbarbbar","RECO__lab__Delta_Eta_lbarbbar",22,-.1,5),"RECO__lab__Delta_Eta_lbarbbar",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Phi_bb","RECO__lab__Delta_Phi_bb",22,-.1,5),"RECO__lab__Delta_Phi_bb",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Phi_lb","RECO__lab__Delta_Phi_lb",22,-.1,1),"RECO__lab__Delta_Phi_lb",plotselection,plotlabel),
    #Plot(ROOT.TH1F("RECO__lab__Delta_Phi_lbarbbar","RECO__lab__Delta_Phi_lbarbbar",22,-.1,5),"RECO__lab__Delta_Phi_lbarbbar",plotselection,plotlabel),
    ...
    #Plot(ROOT.TH1F("BJN_N_PVtrackOvCollTrk","Number PV tracks over all tracks",25,0.2,0.6),"BJN_N_PVtrackOvCollTrk",plotselection,plotlabel),
    #Plot(ROOT.TH1F("BJN_N_AvgIp3D","Avg 3D IP",40,0,0.06),"BJN_N_AvgIp3D",plotselection,plotlabel),
...
lllJEC=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,JECSystnames)
lllQ2=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,Q2Systnames)
lllPU=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,PUSystnames)
lllPS=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,PSscaleSystnames)
lllLepton=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,leptonSystnames)
lllnone=createLLL_fromSuperHistoFileSyst(outputpath[:-4]+'_syst.root',samples[1:],plots,noneSystnames)
...
#listOfHistoListsData=createHistoLists_fromSuperHistoFile(outputpath,samples_data,plots,1)
#lolT=transposeLOL(listOfHistoLists)
plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_NoErrors",[[lllnone,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)

#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_AllErrors",[[lll,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_CSVErrors",[[lllCSV,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_JECErrors",[[lllJEC,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_PSErrors",[[lllPS,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_Q2Errors",[[lllQ2,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_PUErrors",[[lllPU,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
#plotDataMCanWsyst(listOfHistoListsData,transposeLOL(lolT[1:]),samples[1:],lolT[0],samples[0],-1,name+"_LeptonErrors",[[lllLepton,3354,ROOT.kBlack,False]],False,labels,True,plotBlinded)
