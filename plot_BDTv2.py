...
# samples
samples=[Sample('t#bar{t}H',ROOT.kBlue,'/nfs/dust/cms/user/hmildner/treesBDTtraining/tth.root','') , Sample('t#bar{t}',ROOT.kRed+1,'/nfs/dust/cms/user/hmildner/treesBDTtraining/ttbar.root',''), Sample('t#bar{t}H to b#bar{b} fastsim',ROOT.kGreen,'/nfs/dust/cms/user/hmildner/treesBDTtraining/tthbb_fast.root','')]
...
plots=[
    ...
    Plot(ROOT.TH1F("third_jet_pt_6j2t","third_jet_pt (6j2t)",30,0,300),"BDTOhio_v2_input_third_jet_pt",s6j2t),
    ...
    Plot(ROOT.TH1F("fifth_highest_CSV_4j3t","fifth_highest_CSV (4j3t)",50,0,1),"BDTOhio_v2_input_fifth_highest_CSV",s4j3t),
    ...
    Plot(ROOT.TH1F("lowest_btag_5j4t","lowest_btag (5j4t)",50,0.8,1),"BDTOhio_v2_input_lowest_btag",s5j4t),
    Plot(ROOT.TH1F("h3_5j4t","h3 (5j4t)",50,-1,1),"BDTOhio_v2_input_h3",s5j4t),
    Plot(ROOT.TH1F("second_highest_btag_5j4t","second_highest_btag (5j4t)",50,0.8,1),"BDTOhio_v2_input_second_highest_btag",s5j4t),
    ...
    Plot(ROOT.TH1F("min_dr_tagged_jets_5j4t","min_dr_tagged_jets (5j4t)",50,0,2.5),"BDTOhio_v2_input_min_dr_tagged_jets",s5j4t),
