...
#ABCD3
    #no topbtag
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatA_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag3_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,

    # withtopsubbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatA_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD3_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatA_withtopbtag) || ABCD3_CatID==ABCD3_CatA_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatB_withtopbtag) || ABCD3_CatID==ABCD3_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatC_withtopbtag) || ABCD3_CatID==ABCD3_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatD_withtopbtag) || ABCD3_CatID==ABCD3_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD3_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatE_withtopbtag) || ABCD3_CatID==ABCD3_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatF_withtopbtag) || ABCD3_CatID==ABCD3_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatG_withtopbtag) || ABCD3_CatID==ABCD3_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatH_withtopbtag) || ABCD3_CatID==ABCD3_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,
...
#ABCD3
    #with topbtag
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatA_Tprime_M_beta_first" ,"m(Z') in GeV, CatA " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatA_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD_notopbtag3_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD_notopbtag3_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,

    #no topbtag
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatA_Tprime_M_beta_first" ,"m(Z') in GeV, CatA " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatA_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),

    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD_withtopbtag3_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "ABCD3_CatID==ABCD3_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD3_inclusive_CatA_Tprime_M_beta_first" ,"m(Z') in GeV, CatA " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatA_withtopbtag) || ABCD3_CatID==ABCD3_CatA_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatB_Tprime_M_beta_first" ,"m(Z') in GeV, CatB " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatB_withtopbtag) || ABCD3_CatID==ABCD3_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatC_Tprime_M_beta_first" ,"m(Z') in GeV, CatC " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatC_withtopbtag) || ABCD3_CatID==ABCD3_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatD_Tprime_M_beta_first" ,"m(Z') in GeV, CatD " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatD_withtopbtag) || ABCD3_CatID==ABCD3_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD3_inclusive_CatE_Tprime_M_beta_first" ,"m(Z') in GeV, CatE " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatE_withtopbtag) || ABCD3_CatID==ABCD3_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatF_Tprime_M_beta_first" ,"m(Z') in GeV, CatF " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatF_withtopbtag) || ABCD3_CatID==ABCD3_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatG_Tprime_M_beta_first" ,"m(Z') in GeV, CatG " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatG_withtopbtag) || ABCD3_CatID==ABCD3_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD3_inclusive_CatH_Tprime_M_beta_first" ,"m(Z') in GeV, CatH " ,50,0,2500),"Tprimes_ABCD_M", "((ABCD3_CatID==ABCD3_CatH_withtopbtag) || ABCD3_CatID==ABCD3_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta3 + " && " + plotselection_W_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,
...
#MSD manual sepaTest
    ...
    Plot(ROOT.TH1F("Notopbtag_Bottom_CSV" ,"CSV_v2(b-notoptag) in GeV" ,50,0,1),"Bottoms_ABCD_CSV",    plotselection2 + "&& Zprimes_ABCD_M>0 && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_t_MSD + "&& " + plotselection_W_MSD + " &&" + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("Withtopbtag_Bottom_CSV" ,"CSV_v2(b-withtoptag) in GeV",50,0,1),"Bottoms_ABCD_CSV",    plotselection2 + "&& Zprimes_ABCD_M>0 && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_t_MSD + "&& " + plotselection_W_MSD + " &&" + plotselection_W_tau21, "1 btag"), 
...
writeListOfHistoLists(transposeLOL(transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('Zprime1500900'):SignalSampleNames.index('Zprime25001200')+1])[plotnames.index('Notopbtag_Top_MSD'):plotnames.index('Withtopbtag_W_t21')+1],SignalSamples[SignalSampleNames.index('Zprime1500900'):SignalSampleNames.index('Zprime25001200')+1], 'label','MSDs_QCD',True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_notopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_notopbtag3_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioABoverCD_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioABoverCD_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioEFoverGH_pol0", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatE_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioEFoverGH_pol1", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
...
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioABoverCD_pol0_corrE", rebin=1, fitoption='pol0', labels=None, autoXrange=True)
writeHistoListwithXYErrors([transposeLOL(transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1])[plotnames.index('ABCD_withtopbtag3_CatA_Zprime_M_beta_first')]], BackgroundSamples[BackgroundSampleNames.index('QCD_HT'):BackgroundSampleNames.index('QCD_PT')+1], name="checkforABCD_"+ABCDeventhandling+"_"+WPs+"_withtopbtag3_ratioABoverCD_pol1_corrE", rebin=1, fitoption='pol1', labels=None, autoXrange=True)
