...
#MSD manual sepaTest
    ...
    Plot(ROOT.TH1F("ZprimeminusEvtHT_wtb" ,"(m(Z')-HT_{Evt})/m(Z')" ,30,-0.5,1),"ZprimeminusEvtHT_wtb",   "ZprimeminusEvtHT_wtb>(-20000.0)", "2 btag"),
    Plot(ROOT.TH1F("ZprimeminusEvtHT_ntb" ,"(m(Z')-HT_{Evt})/m(Z')" ,30,-0.5,1),"ZprimeminusEvtHT_ntb",   "ZprimeminusEvtHT_ntb>(-20000.0)", "1 btag"),
