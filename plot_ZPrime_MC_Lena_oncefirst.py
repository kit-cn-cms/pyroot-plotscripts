...
#ABCD8 W tau21 bottomCSV  tmsd as third
    #no topbtag
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatA_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD8_notopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_notopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,

    # withtopsubbtag
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatA_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag"),

    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD8_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD8_CatID==ABCD8_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD8_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatA_withtopbtag) || ABCD8_CatID==ABCD8_CatA_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatB_withtopbtag) || ABCD8_CatID==ABCD8_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatC_withtopbtag) || ABCD8_CatID==ABCD8_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatD_withtopbtag) || ABCD8_CatID==ABCD8_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD8_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatE_withtopbtag) || ABCD8_CatID==ABCD8_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatF_withtopbtag) || ABCD8_CatID==ABCD8_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatG_withtopbtag) || ABCD8_CatID==ABCD8_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD8_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD8_CatID==ABCD8_CatH_withtopbtag) || ABCD8_CatID==ABCD8_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta8 + " && " + plotselection_t_MSD_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,



#ABCD9 W tau21 bottomCSV  tau32 as third
    #no topbtag
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatA_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD9_notopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_notopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,

    # withtopsubbtag
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatA_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag"),

    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD9_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD9_CatID==ABCD9_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD9_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatA_withtopbtag) || ABCD9_CatID==ABCD9_CatA_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatB_withtopbtag) || ABCD9_CatID==ABCD9_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatC_withtopbtag) || ABCD9_CatID==ABCD9_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatD_withtopbtag) || ABCD9_CatID==ABCD9_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32 + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD9_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatE_withtopbtag) || ABCD9_CatID==ABCD9_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatF_withtopbtag) || ABCD9_CatID==ABCD9_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatG_withtopbtag) || ABCD9_CatID==ABCD9_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD9_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD9_CatID==ABCD9_CatH_withtopbtag) || ABCD9_CatID==ABCD9_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta9 + " && " + plotselection_tau32_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,



#ABCD10 W tau21 bottomCSV  TprimeM as third
    #no topbtag
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatA_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatB_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatC_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatD_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD10_notopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatE_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatF_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatG_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_notopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatH_notopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,

    # withtopsubbtag
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatA_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatB_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatC_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatD_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag"),

    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatE_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatF_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatG_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"2 btag"),
    Plot(ROOT.TH1F("ABCD10_withtopbtag_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "ABCD10_CatID==ABCD10_CatH_withtopbtag" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"2 btag") ,

    #inclusive
    Plot(ROOT.TH1F("ABCD10_inclusive_CatA_Zprime_M_beta_first" ,"m(Z') in GeV, CatA " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatA_withtopbtag) || ABCD10_CatID==ABCD10_CatA_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21, "1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatB_Zprime_M_beta_first" ,"m(Z') in GeV, CatB " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatB_withtopbtag) || ABCD10_CatID==ABCD10_CatB_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatC_Zprime_M_beta_first" ,"m(Z') in GeV, CatC " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatC_withtopbtag) || ABCD10_CatID==ABCD10_CatC_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatD_Zprime_M_beta_first" ,"m(Z') in GeV, CatD " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatD_withtopbtag) || ABCD10_CatID==ABCD10_CatD_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag"),

    Plot(ROOT.TH1F("ABCD10_inclusive_CatE_Zprime_M_beta_first" ,"m(Z') in GeV, CatE " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatE_withtopbtag) || ABCD10_CatID==ABCD10_CatE_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatF_Zprime_M_beta_first" ,"m(Z') in GeV, CatF " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatF_withtopbtag) || ABCD10_CatID==ABCD10_CatF_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV + "&& " + plotselection_W_tau21_anti  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatG_Zprime_M_beta_first" ,"m(Z') in GeV, CatG " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatG_withtopbtag) || ABCD10_CatID==ABCD10_CatG_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass_anti  + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21  ,"1 btag"),
    Plot(ROOT.TH1F("ABCD10_inclusive_CatH_Zprime_M_beta_first" ,"m(Z') in GeV, CatH " ,100,0,5000),"Zprimes_ABCD"+radi+"_M", "((ABCD10_CatID==ABCD10_CatH_withtopbtag) || ABCD10_CatID==ABCD10_CatH_notopbtag)" + " && " + plotselection_ABCD_general_beta10 + " && " + plotselection_TprimeMass_anti + "&&" + plotselection_B_CSV_anti + "&& " + plotselection_W_tau21_anti  ,"1 btag") ,
...
#MSD manual sepaTest
    ...
    Plot(ROOT.TH1F("Notopbtag_EvtHT" ,"Evt_HT_Jets, 1 b-tag" ,100,0,5000),"Evt_HT_Jets",  plotselection2 + " && " + plotselection1+ " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    ...
    Plot(ROOT.TH1F("Withtopbtag_EvtHT" ,"Evt_HT_Jets, 2 b-tag" ,100,0,5000),"Evt_HT_Jets",  plotselection2 + " && " + plotselection1+ " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"2 btag"),
    ...
    TwoDimPlot(ROOT.TH2F("Notopbtag_Zprime_M_vs_EvtHT" ,"m(Z') VS Evt_HT_Jets",100,0,5000,100,0,5000),"Zprimes_ABCD"+radi+"_M", "Evt_HT_Jets", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Withtopbtag_Zprime_M_vs_EvtHT" ,"m(Z') VS Evt_HT_Jets",100,0,5000,100,0,5000),"Zprimes_ABCD"+radi+"_M", "Evt_HT_Jets", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Notopbtag_Zprime_M_vs_N_JetsAK8" ,"m(Z') VS N_JetsAK8",100,0,5000,10,0,10),"Zprimes_ABCD"+radi+"_M", "N_packedPatJetsAK8PFCHSSoftDrop", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Withtopbtag_Zprime_M_vs_N_JetsAK8" ,"m(Z') VS N_JetsAK8",100,0,5000,10,0,10),"Zprimes_ABCD"+radi+"_M", "N_packedPatJetsAK8PFCHSSoftDrop", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Notopbtag_Zprime_M_vs_N_JetsAK4" ,"m(Z') VS N_JetsAK4",100,0,5000,10,0,10),"Zprimes_ABCD"+radi+"_M", "N_Jets", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Withtopbtag_Zprime_M_vs_N_JetsAK4" ,"m(Z') VS N_JetsAK4",100,0,5000,10,0,10),"Zprimes_ABCD"+radi+"_M", "N_Jets", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000  && N_Jets<9 && N_packedPatJetsAK8PFCHSSoftDrop<9 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),

    TwoDimPlot(ROOT.TH2F("Notopbtag_Zprime_M_vs_sqrts" ,"m(Z') VS Evt_HT_Jets",100,0,5000,100,0,5000),"Zprimes_ABCD"+radi+"_M", "Evt_sqrts", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2_anti + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),
    TwoDimPlot(ROOT.TH2F("Withtopbtag_Zprime_M_vs_sqrts" ,"m(Z') VS Evt_HT_Jets",100,0,5000,100,0,5000),"Zprimes_ABCD"+radi+"_M", "Evt_sqrts", " (40 < Ws_ABCD"+radi+"_MSD  &&   Ws_ABCD"+radi+"_MSD < 130) " + " && (40 < Tops_ABCD"+radi+"_MSD  &&   Tops_ABCD"+radi+"_MSD < 300)" + " && " + "Evt_HT_Jets>1000 && Bottoms_ABCD" + radi + "_Pt>100 && Ws_ABCD" + radi + "_Pt>200 && Tops_ABCD" + radi + "_Pt>400"+ " && " + plotselection_topsubjetCSVv2 + " && " + plotselection_TprimeMass + " && " + plotselection_B_CSV + " && " + plotselection_W_MSD + " && " + plotselection_W_tau21,"1 btag"),


    Plot(ROOT.TH1F("ZprimeminusEvtHT_wtb" ,"(m(Z')-HT_{Evt})/m(Z'), CatA" ,40,-1,1),"ZprimeminusEvtHT_wtb",   "ZprimeminusEvtHT_wtb>(-20000.0)", "2 btag"),
    Plot(ROOT.TH1F("ZprimeminusEvtHT_ntb" ,"(m(Z')-HT_{Evt})/m(Z'), CatA" ,40,-1,1),"ZprimeminusEvtHT_ntb",   "ZprimeminusEvtHT_ntb>(-20000.0)", "1 btag"),
...
OnlyFirstList[plotnames.index("ABCD_notopbtag_CatA_Zprime_M_beta_first"):plotnames.index('Withtopbtag_Zprime_M_vs_sqrts') +1 ] = len(OnlyFirstList[plotnames.index("ABCD_notopbtag_CatA_Zprime_M_beta_first"):plotnames.index('Withtopbtag_Zprime_M_vs_sqrts') + 1 ] ) * [True]
...
print transposeLOL([transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT')]]+[transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('ttbar')]]+[transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('ZprimeAll')]])[plotnames.index('Notopbtag_EvtHT'):plotnames.index('ZprimeminusEvtHT_ntb')+1]
...
writeListOfHistoLists(transposeLOL([transposeLOL(listOfHistoListsSignal)[SignalSampleNames.index('ZprimeAll')]]+[transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('QCD_HT')]]+[transposeLOL(listOfHistoListsABCD)[BackgroundSampleNames.index('ttbar')]])[plotnames.index('Notopbtag_EvtHT'):plotnames.index('ZprimeminusEvtHT_ntb')+1],[SignalSamples[SignalSampleNames.index('ZprimeAll')]]+[BackgroundSamples[BackgroundSampleNames.index('QCD_HT')]]+[BackgroundSamples[BackgroundSampleNames.index('ttbar')]],"","additionalcuts"+name,True,False,False,"",False,False,True)
